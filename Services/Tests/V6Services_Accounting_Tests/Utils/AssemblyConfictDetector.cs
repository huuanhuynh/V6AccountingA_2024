...
namespace V6Soft.Services.Accounting.DataFarmers.Tests.Utils
{
    [TestClass]
    public class AssemblyConfictDetector
    {
        [TestMethod]
        public void FindConflictingReferences()
        {
            var assemblies = GetAllAssemblies(@"F:\Job\V6Soft\Repositories\Source\Web\V6Web_Accounting\V6Web_Accounting\bin");
            ...
            {
                Console.Out.WriteLine("\n[Possible conflicts for {0}]:", group.Key);
