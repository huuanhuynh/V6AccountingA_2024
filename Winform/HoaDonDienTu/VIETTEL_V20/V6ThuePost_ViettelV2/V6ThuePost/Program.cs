...
namespace V6ThuePost
{
    static class Program
    {
        ...
        #region ===== VAR =====
        public static ViettelV2WS _WS = null;
        /// <summary>
        /// Link host
        /// </summary>
        ...
        static void Main(string[] args)
        {
            ...
            if (args != null && args.Length > 0)
            {
                ...
                try
                {
                    ViettelV2PostObject jsonBodyObject = null;
                    ViettelV2Response responseObject = null;

                    ReadXmlInfo(arg1_xmlFile);
                    string dbfFile = arg2;

                    _WS = new ViettelV2WS(baseUrl, username, password, _ma_dvcs, _codetax);
                    ...
                    if (mode.ToUpper() == "MTEST")
                    {
                        ...
                        responseObject = _WS.POST_NEW(new ViettelV2PostObject(), out v6Return);
                    ...
                    if (v6Return != null)
                    {
                        ...
                        //ViettelV2Response responseObject = (ViettelV2Response) v6Return.RESULT_OBJECT;
        ...
        /// <returns></returns>
        public static ViettelV2PostObject ReadData_Minvoice(string dbfFile, string mode)
        {
            string result = "";
            //try
            {
                postObject = new ViettelV2PostObject();
        ...
        private static ViettelV2PostObject postObject;
