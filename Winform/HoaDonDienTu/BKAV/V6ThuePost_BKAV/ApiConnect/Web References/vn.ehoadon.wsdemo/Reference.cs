...
namespace V6ThuePostBkavApi.vn.ehoadon.wsdemo {
    using System;
    ...
    public partial class WSPublicEHoaDon : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public WSPublicEHoaDon() {
            this.Url = global::V6ThuePostBkavApi.Properties.Settings.Default.V6ThuePostApi_vn_ehoadon_wsdemo_WSPublicEHoaDon;
        ...
        public WSPublicEHoaDon(string url)
        {
            this.Url = url;
            if ((this.IsLocalFileSystemWebService(this.Url) == true))
            {
