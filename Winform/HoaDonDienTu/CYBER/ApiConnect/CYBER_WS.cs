...
using V6Tools;
using V6ThuePost.CYBER_Objects.Response;
...
namespace V6ThuePost_CYBER_Api
{
    public class CYBER_WS
    {
        /// <summary>
        /// https://demo.cyberbill.vn
        /// </summary>
        ...
        private const string create_uri = @"/api/services/hddtws/GuiHoadon/GuiHoadonGoc";
        private const string dieuchinh_uri = @"/api/services/hddtws/GuiHoadon/GuiHoaDonDieuChinh";
        private const string thaythehoadon_uri = "/api/services/hddtws/GuiHoadon/GuiHoadonThayThe";
        private const string huyhoadon_uri = "/api/services/hddtws/GuiHoadon/GuiHoaDonHuyBo";
        private const string taipdf_uri = "/api/services/hddtws/GuiHoaDon/TaiHoaDonPdf"; // cách gọi riêng ở chương trình này: uri là đường dẫn hàm ko bao gồm baseurl.
        private const string taipdf_chuaky_uri = "/api/services/hddtws/GuiHoadon/TaiHoaDonPdfChuaKy";

        private const string create_guivakyhoadonhsm_uri = @"/api/services/hddtws/GuiHoadon/GuiVaKyHoadonGocHSM";

        private const string sign_hsm_uri = @"/api/services/hddtws/XuLyHoaDon/KyHoaDonHSM";
        
        
        
        private const string chuyendoihoadon_uri = "/api/services/hddtws/GuiHoadon/ChuyenDoiHoaDon";
        
        
        
        
        
        public CYBER_WS(string baseurl, string username, string password, string codetax)
        {
            _baseurl = baseurl;
...
//}
            ...
            CYBER_LoginResponse loginResponse = JsonConvert.DeserializeObject<CYBER_LoginResponse>(result);
        ...
        public string POST_CREATE_INVOICE(string jsonBody, bool gui_va_ky, out V6Return v6Return)
        {
            ...
            try
            {
                ...
                if (responseObject.unAuthorizedRequest)// == "GENERAL" && result.Contains("\"error\":\"Internal Server Error\""))
                {
                    ...
                    result = POST_BEARERTOKEN(link, jsonBody);
                    v6Return.RESULT_STRING = result;
                    responseObject = JsonConvert.DeserializeObject<CYBER_CreateInvoiceResponse>(result);
                    v6Return.RESULT_OBJECT = responseObject;
                }
...
//}
        ...
        public CYBER_CreateInvoiceResponse POST_NEW_USBTOKEN(string json, string templateCode, string token_serial)
        {
            string result = null;
            CYBER_CreateInvoiceResponse responseObject = CreateInvoiceUsbTokenGetHash(json, out result);
            ...
            if (responseObject.result != null)
            {
                ...
                responseObject = JsonConvert.DeserializeObject<CYBER_CreateInvoiceResponse>(result2);
        ...
        public string CreateInvoiceUsbTokenGetHash_Sign(string json, string templateCode, string token_serial, out V6Return v6Return)
        {
            ...
            CYBER_CreateInvoiceResponse responseObject = JsonConvert.DeserializeObject<CYBER_CreateInvoiceResponse>(hash_result);
            v6Return.RESULT_OBJECT = responseObject;
            if (responseObject.unAuthorizedRequest)// == "GENERAL" && hash_result.Contains("\"error\":\"Internal Server Error\""))
            {
                ...
                hash_result = POST_BEARERTOKEN("/services/einvoiceapplication/api/InvoiceAPI/InvoiceWS/createInvoiceUsbTokenGetHash/" + _codetax, json);
                v6Return.RESULT_STRING = hash_result;
                responseObject = JsonConvert.DeserializeObject<CYBER_CreateInvoiceResponse>(hash_result);
                v6Return.RESULT_OBJECT = responseObject;
            }
            ...
            if (responseObject.result != null)
            {
                ...
                responseObject = JsonConvert.DeserializeObject<CYBER_CreateInvoiceResponse>(sign_result2);
                v6Return.RESULT_OBJECT = responseObject;
        ...
        public CYBER_CreateInvoiceResponse CreateInvoiceUsbTokenGetHash(string json, out string result)
        {
