...
using V6ThuePostXmlApi.AttachmentService0315511086;
using V6ThuePostXmlApi.BusinessService0315511086;
using V6ThuePostXmlApi.PortalService0315511086;
using V6ThuePostXmlApi.PostObjects;
using V6ThuePostXmlApi.PublishService0315511086;
using V6Tools;
    ...
    static class Program
    {
        ...
        public static string UploadInvAttachmentFkey(string fkey, string file)
        {
            ...
            try
            {
                ...
                result = "ERR";// new AttachmentService(link_Attachment).uploadInvAttachmentFkey(fkey, username, password, attachment64, ext, attachmentName);
