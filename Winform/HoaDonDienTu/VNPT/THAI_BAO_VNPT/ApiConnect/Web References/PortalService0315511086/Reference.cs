...
namespace V6ThuePostXmlApi.PortalService0315511086 {
    using System;
    ...
    public partial class PortalService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public PortalService() {
            this.Url = global::V6ThuePostXmlApi.Properties.Settings.Default.V6ThuePostXmlApi_PortalService0315511086_PortalService;
        ...
        public PortalService(string url) {
            this.Url = url;
            if ((this.IsLocalFileSystemWebService(this.Url) == true)) {
                this.UseDefaultCredentials = true;
                this.useDefaultCredentialsSetExplicitly = false;
