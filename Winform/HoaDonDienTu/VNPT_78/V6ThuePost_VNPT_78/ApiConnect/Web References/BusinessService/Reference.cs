...
namespace V6ThuePostXmlApi.BusinessService {
    ...
    public partial class BusinessService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public string AdjustWithoutInv(string account, string accPass, string invXml, string userName, string userPass, string oldPattern, string oldSerial, decimal oldNo, [System.Xml.Serialization.XmlElementAttribute(IsNullable=true)] System.Nullable<int> convert, string pattern, string serial) {
        ...
        /// <remarks/>
        public void AdjustWithoutInvAsync(string account, string accPass, string invXml, string userName, string userPass, string oldPattern, string oldSerial, decimal oldNo, System.Nullable<int> convert, string pattern, string serial) {
            this.AdjustWithoutInvAsync(account, accPass, invXml, userName, userPass, oldPattern, oldSerial, oldNo, convert, pattern, serial, null);
        }
        
        /// <remarks/>
        public void AdjustWithoutInvAsync(string account, string accPass, string invXml, string userName, string userPass, string oldPattern, string oldSerial, decimal oldNo, System.Nullable<int> convert, string pattern, string serial, object userState) {
            ...
            this.InvokeAsync("AdjustWithoutInv", new object[] {
                        ...
                        convert,
                        pattern,
                        serial}, this.AdjustWithoutInvOperationCompleted, userState);
        }
        ...
        public string ReplaceWithoutInv(string account, string accPass, string invXml, string userName, string userPass, string oldPattern, string oldSerial, decimal oldNo, [System.Xml.Serialization.XmlElementAttribute(IsNullable=true)] System.Nullable<int> convert, string pattern, string serial) {
        ...
        /// <remarks/>
        public void ReplaceWithoutInvAsync(string account, string accPass, string invXml, string userName, string userPass, string oldPattern, string oldSerial, decimal oldNo, System.Nullable<int> convert, string pattern, string serial) {
            this.ReplaceWithoutInvAsync(account, accPass, invXml, userName, userPass, oldPattern, oldSerial, oldNo, convert, pattern, serial, null);
        }
        
        /// <remarks/>
        public void ReplaceWithoutInvAsync(string account, string accPass, string invXml, string userName, string userPass, string oldPattern, string oldSerial, decimal oldNo, System.Nullable<int> convert, string pattern, string serial, object userState) {
            ...
            this.InvokeAsync("ReplaceWithoutInv", new object[] {
                        ...
                        convert,
                        pattern,
                        serial}, this.ReplaceWithoutInvOperationCompleted, userState);
        }
