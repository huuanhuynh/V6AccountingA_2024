...
{
    internal partial class BaseMessageForm : V6Form
    {
        ...
        public BaseMessageForm(string text, string caption = null, int showTime = 0,
        ...
        private void BaseMessageForm_FormClosing(object sender, FormClosingEventArgs e)
        {
