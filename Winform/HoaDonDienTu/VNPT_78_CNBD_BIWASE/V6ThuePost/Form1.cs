...
namespace V6ThuePost
{
    public partial class Form1 : Form
    {
        ...
        private void btnRead_Click(object sender, EventArgs e)
        {
            ...
            btnSend.Enabled = true; btnSendBIWASE.Enabled = true;
        ...
        private void btnSendBIWASE_Click(object sender, EventArgs e)
        {
            string result = null;
            try
            {
                ...
                {
                    //result = Program.ImportAndPublishInv(richTextBox1.Text);
                    result = Program._vnptWS.ImportAndPublishInv_BIWASE(richTextBox1.Text, Program.pattern, Program.seri, out v6Return);
                }
                else
                {
                    //Program.StartAutoInputTokenPassword();
