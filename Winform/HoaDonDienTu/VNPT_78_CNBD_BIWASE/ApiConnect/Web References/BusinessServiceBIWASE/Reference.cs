...
namespace V6ThuePostXmlApi.BusinessServiceBIWASE {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="BusinessServiceBIWASESoap", Namespace="http://tempuri.org/")]
    public partial class BusinessServiceBIWASE : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public BusinessServiceBIWASE() {
            this.Url = global::V6ThuePostXmlApi.Properties.Settings.Default.V6ThuePostVNPT_78Api_BIWASE_BusinessServiceBIWASE_BusinessServiceBIWASE;
        ...
        public BusinessServiceBIWASE(string url)
        {
            this.Url = url;
            if ((this.IsLocalFileSystemWebService(this.Url) == true))
            {
