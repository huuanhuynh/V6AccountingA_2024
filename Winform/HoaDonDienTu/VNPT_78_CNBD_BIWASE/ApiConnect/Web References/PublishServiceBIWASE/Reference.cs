...
namespace V6ThuePostXmlApi.PublishServiceBIWASE {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="PublishServiceBIWASESoap", Namespace="http://tempuri.org/")]
    public partial class PublishServiceBIWASE : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public PublishServiceBIWASE() {
            this.Url = global::V6ThuePostXmlApi.Properties.Settings.Default.V6ThuePostVNPT_78Api_PublishServiceBIWASE_PublishServiceBIWASE;
        ...
        public PublishServiceBIWASE(string url)
        {
            this.Url = url;
            if ((this.IsLocalFileSystemWebService(this.Url) == true))
            {
