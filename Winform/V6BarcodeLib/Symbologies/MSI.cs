...
namespace V6BarcodeLib.Symbologies
{
    class MSI : BarcodeCommon, IBarcode
    {
        ...
        public MSI(string input, BARCODE_TYPE encodedBarcodeType)
        {
            _encodedBarcodeType = encodedBarcodeType;
            Raw_Data = input;
        }//MSI
        ...
        private string Encode_MSI()
        {
            ...
            //get checksum
            if (_encodedBarcodeType == BARCODE_TYPE.MSI_Mod10 || _encodedBarcodeType == BARCODE_TYPE.MSI_2Mod10)
            {
                string odds = "";
                string evens = "";
            ...
            if (_encodedBarcodeType == BARCODE_TYPE.MSI_Mod11 || _encodedBarcodeType == BARCODE_TYPE.MSI_Mod11_Mod10)
            {
                int sum = 0;
                int weight = 2;
            ...
            if (_encodedBarcodeType == BARCODE_TYPE.MSI_2Mod10 || _encodedBarcodeType == BARCODE_TYPE.MSI_Mod11_Mod10)
            {
