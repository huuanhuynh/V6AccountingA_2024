...
namespace ControlManager
{
    public static class ControlMoverOrResizer
    {
        ...
        private static Color  _mousein_color = Color.Yellow;
        ...
        internal static void Init(Control control, Control container)
        {
            ...
            control.MouseEnter += (sender, e) => control_MouseEnter(control, e);
            control.MouseLeave += (sender, e) => control_MouseLeave(control, e);
           
        }

       
        static void control_MouseLeave(Control sender, EventArgs e)
        {
            if(sender.Tag is Color)
                sender.BackColor = (Color)sender.Tag;
        }

        static void control_MouseEnter(Control sender, EventArgs e)
        {
            sender.BackColor = _mousein_color;
        }
