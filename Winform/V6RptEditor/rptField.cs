...
{
    public class rptField:Label
    {
        protected FieldObject _obj;

        public rptField(FieldObject obj)
        {
            _obj = obj;
            Name = obj.Name;
            ...
            ApplyEvent();
            //test
            object o = obj.FieldFormat.CommonFormat;
            String text = obj.DataSource.Name;
            String formulaname = obj.DataSource.FormulaName;
        }
        ...
        #region ==== override Text (can not be change text) ====
        [Category("_crProperty")]
        [Description("Hiển thị tên trường biểu thức (formula), không thể chỉnh sửa")]
        public override string Text
        {
            get
            {
                try
                {
                    return _obj.DataSource.FormulaName;
                }
                catch
                {
                    return "Exception!";
        ...
        #region ==== override ForeColor (can not be change) cancel ====
        //Color _foreColor;
        //[Category("_crProperty")]
        //[Description("Hiển thị màu khi chỉnh sửa. (thay đổi theo TextColor và EnableSuppress)")]
        ...
        public void ApplyEvent()
        {
            ...
            //this.TextColorChanged += rptField_TextColorChanged;
            //this.BackGroundColorChanged += rptField_BackGroundColorChanged;
            //this.EnableSuppressChanged += rptField_EnableSuppressChanged;
        }

        //void rptField_TextColorChanged(object sender, EventArgs e)
        //{
        //    _obj.Color = textColor;
        //}

        //void rptField_EnableSuppressChanged(object sender, EventArgs e)
        //{
        //    _obj.ObjectFormat.EnableSuppress = this.enableSuppress;
        //}
