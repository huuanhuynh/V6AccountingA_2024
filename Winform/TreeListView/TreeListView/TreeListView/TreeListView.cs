...
//						case (APIsEnums.ListViewNotifications)APIsEnums.HeaderControlNotifications.TRACK:
        ...
        /// <summary>
        /// Su kien thay doi trang thai check cua 1 dong
        /// </summary>
        /// <param name="item"></param>
        /// <param name="e"></param>
        public delegate void ItemCheckedChangedDelegate(TreeListViewItem item, ItemCheckEventArgs e);
        ...
        public event ItemCheckedChangedDelegate ItemCheckedChanged;
			...
			protected override void OnColumnClick(System.Windows.Forms.ColumnClickEventArgs e)
			{
                ...
                return;//huuan add 20160113 to disable SortOrder
				Cursor = Cursors.WaitCursor;
				ListViewItem[] selItems = new ListViewItem[base.SelectedItems.Count];
				base.SelectedItems.CopyTo(selItems, 0);
