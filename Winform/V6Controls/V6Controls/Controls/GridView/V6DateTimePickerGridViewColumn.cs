...
namespace V6Controls.Controls.GridView
{
    ...
    #region V6DateTimePickerGridViewColumn
    public class V6DateTimePickerGridViewColumn : DataGridViewTextBoxColumn//DataGridViewColumn//
    {
        public V6DateTimePickerGridViewColumn()
        {
            V6DateTimePickerDataGridViewCell cell = new V6DateTimePickerDataGridViewCell();
        ...
        private V6DateTimePickerDataGridViewCell NumEditCellTemplate
        {
            get
            {
                V6DateTimePickerDataGridViewCell cell = this.CellTemplate as V6DateTimePickerDataGridViewCell;
                if (cell == null)
                {
                    throw new InvalidOperationException("V6DateTimePickerGridViewEditingControl does not have a CellTemplate.");
                }
                return cell;
            }
        }
        ...
        public override DataGridViewCell CellTemplate
        {
            ...
            set
            {
                V6DateTimePickerDataGridViewCell cell = value as V6DateTimePickerDataGridViewCell;
                if (value != null && cell == null)
                {
                    throw new InvalidCastException("Value provided for CellTemplate must be of type V6DateTimePickerDataGridViewCell or derive from it.");
                }
        ...
        public override string ToString()
        {
            ...
            sb.Append("V6DateTimePickerGridViewColumn { Name=");
            sb.Append(this.Name);
            sb.Append(", Index=");
    ...
    #region V6DateTimePickerGridViewEditingControl

    class V6DateTimePickerGridViewEditingControl : V6DateTimePicker, IDataGridViewEditingControl
    {
        ...
        public V6DateTimePickerGridViewEditingControl()
        {
            this.TabStop = false;  // control must not be part of the tabbing loop
            this.VisibleChanged += V6DateTimePickerGridViewEditingControl_VisibleChanged;
        }
        /// <summary>
        ...
        /// <param name="e"></param>
        void V6DateTimePickerGridViewEditingControl_VisibleChanged(object sender, EventArgs e)
        {
    ...
    #region V6DateTimePickerDataGridViewCell

    public class V6DateTimePickerDataGridViewCell : DataGridViewTextBoxCell
    {
        //private bool m_showNullWhenZero = false;
        //private bool m_allowNegative = true;
        //private int m_decimalLength = 0;

        private static Type defaultEditType = typeof(V6DateTimePickerGridViewEditingControl);
        private static Type defaultValueType = typeof(System.DateTime);

        public V6DateTimePickerDataGridViewCell(){}
        
        private V6DateTimePickerGridViewEditingControl EditingV6DateTimePickerTextBox
        {
            get
            {
                return this.DataGridView.EditingControl as V6DateTimePickerGridViewEditingControl;
            }
        }
        ...
        //{
        //    V6DateTimePickerDataGridViewCell dataGridViewCell = base.Clone() as V6DateTimePickerDataGridViewCell;
        ...
        public override void InitializeEditingControl(int rowIndex, object initialFormattedValue, DataGridViewCellStyle dataGridViewCellStyle)
        {
            ...
            OnCommonChange();
            V6DateTimePickerGridViewEditingControl editBox = this.DataGridView.EditingControl as V6DateTimePickerGridViewEditingControl;
            if (editBox != null)
            {
        ...
        private bool OwnsEditingControl(int rowIndex)
        {
            ...
            V6DateTimePickerGridViewEditingControl editingControl = this.DataGridView.EditingControl as V6DateTimePickerGridViewEditingControl;
            return editingControl != null && rowIndex == ((IDataGridViewEditingControl)editingControl).EditingControlRowIndex;
        }
        
        public override string ToString()
        {
            return "V6DateTimePickerDataGridViewCell { ColIndex=" + ColumnIndex.ToString(CultureInfo.CurrentCulture) + 
