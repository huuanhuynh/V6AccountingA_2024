...
{
    public partial class PhanNhomTaiSanAddEditForm : AddEditControlVirtual
    {
        public PhanNhomTaiSanAddEditForm()
        {
            InitializeComponent();
        }
        public override void DoBeforeEdit()
        {
            ...
            {
                V6Tools.Logger.WriteToLog("PhanNhomTaiSan DisableWhenEdit " + ex.Message);
            }
        }
