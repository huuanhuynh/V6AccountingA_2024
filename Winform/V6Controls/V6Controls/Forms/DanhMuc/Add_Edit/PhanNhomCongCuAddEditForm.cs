...
{
    public partial class PhanNhomCongCuAddEditForm : AddEditControlVirtual
    {
        public PhanNhomCongCuAddEditForm()
        {
            InitializeComponent();
        }
        public override void DoBeforeEdit()
        {
            ...
            {
                V6Tools.Logger.WriteToLog("PhanNhomCongCuAddEditForm DisableWhenEdit " + ex.Message);
            }
        }
