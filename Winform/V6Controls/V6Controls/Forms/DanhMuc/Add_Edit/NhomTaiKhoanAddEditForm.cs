...
{
    public partial class NhomTaiKhoanAddEditForm : AddEditControlVirtual
    {
        public NhomTaiKhoanAddEditForm()
        {
            InitializeComponent();
        }
        public override void DoBeforeEdit()
        {
            ...
            {
                V6Tools.Logger.WriteToLog("NhomTaiKhoanAddEditForm DisableWhenEdit " + ex.Message);
            }
        }
