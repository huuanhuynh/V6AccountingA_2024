    ...
    public partial class HinhThucVanChuyenAddEditForm : AddEditControlVirtual
    {
        ...
        public override void DoBeforeEdit()
        {
            try
            {
                ...
                var v = Categories.IsExistOneCode_List(aldm.F8_TABLE, "MA_HTVC", TXTma_htvc.Text);
        ...
        {
            var errors = "";
            if (TXTma_htvc.Text.Trim() == "" || TXTten_htvc.Text.Trim() == "")
                errors += V6Text.CheckInfor + " !\r\n";

            if (Mode == V6Mode.Edit)
            {
                bool b = V6BusinessHelper.IsValidOneCode_Full(_MA_DM, 0, "MA_HTVC",
            ...
            {
                bool b = V6BusinessHelper.IsValidOneCode_Full(_MA_DM, 1, "MA_HTVC",
