...
{
    public partial class NhomKhoanMucPhiAddEditForm : AddEditControlVirtual
    {
        public NhomKhoanMucPhiAddEditForm()
        {
            InitializeComponent();
        }
        public override void DoBeforeEdit()
        {
            ...
            {
                V6Tools.Logger.WriteToLog("NhomKhoanMucPhiAddEditForm DisableWhenEdit " + ex.Message);
            }
        }
