...
{
    public partial class KhachHangAddEditFrom_A1 : AddEditControlVirtual
    {
        public KhachHangAddEditFrom_A1()
        {
            InitializeComponent();
            if (Mode == V6Mode.Add)
            {
        ...
        public override void ValidateData()
        {
            ...
            if (txtMaSoThueVAT.Text.Trim().Length >= 10 && V6Options.M_QLY_MA_SO_THUE.Length > 1 && V6Options.M_QLY_MA_SO_THUE[1] == '1')
            {
                ...
                {
                    bool exist_new = V6BusinessHelper.CheckDataExistStruct(_MA_DM, keys_new, _aldmConfig.CHECK_LONG);
                    if (exist_new)
