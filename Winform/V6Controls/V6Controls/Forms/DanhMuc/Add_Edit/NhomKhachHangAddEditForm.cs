...
{
    public partial class NhomKhachHangAddEditForm : AddEditControlVirtual
    {
        public NhomKhachHangAddEditForm()
        {
            InitializeComponent();
        }
        public override void DoBeforeEdit()
        {
            ...
            {
                V6Tools.Logger.WriteToLog("NhomKhachHangAddEditForm DisableWhenEdit " + ex.Message);
            }
        }
