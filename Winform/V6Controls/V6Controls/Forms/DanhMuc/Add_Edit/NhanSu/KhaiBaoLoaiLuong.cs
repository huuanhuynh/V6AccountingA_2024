       ...
       //     txtMaNhCa.Enabled = false;
        ...
        public override void DoBeforeEdit()
        {
            try
            {
                ...
                var v = Categories.IsExistOneCode_List(aldm.F8_TABLE, "MA_LOAI_LG", txtMaLoaiLuong.Text);
        ...
        public override void ValidateData()
        {
            ...
            if (Mode == V6Mode.Edit)
            {
                ...
                bool b = V6BusinessHelper.IsValidOneCode_Full(_MA_DM, 0, "MA_LOAI_LG",
            ...
            {
                bool b = V6BusinessHelper.IsValidOneCode_Full(_MA_DM, 1, "MA_LOAI_LG",
