...
{
    public partial class Algia0AddEditForm : AddEditControlVirtual
    {
        public Algia0AddEditForm()
        {
            InitializeComponent();
        }

        private void Algia0AddEditForm_Load(object sender, EventArgs e)
        {
            txtDVT.Upper();
        ...
        {
            var errors = "";
            if (txtma_gia.Text.Trim() == "") errors += V6Text.Text("CHUANHAP") + lblMaGia.Text + "!\r\n";
            ...
            if (Mode == V6Mode.Edit)
            {
                bool b = V6BusinessHelper.IsValidThreeCode_OneDate("ALGIA0", 0,
            ...
            {
                bool b = V6BusinessHelper.IsValidThreeCode_OneDate("ALGIA0", 1,
