...
namespace V6Controls.Forms.DanhMuc.Add_Edit
{
    public partial class TuDienTuDinhNghia2AddEditForm : AddEditControlVirtual
    {
        ...
        public override void DoBeforeEdit()
        {
            ...
            {
                V6Tools.Logger.WriteToLog("TuDienTuDinhNghia2AddEditForm DisableWhenEdit " + ex.Message);
            }
        }
        public override void ValidateData()
        {
            ...
            {
                bool b = V6BusinessHelper.IsValidOneCode_Full(_MA_DM.ToString(), 0, "MA_TD2",
            ...
            {
                bool b = V6BusinessHelper.IsValidOneCode_Full(_MA_DM.ToString(), 1, "MA_TD2",
