...
namespace V6ThuePostApi
{
    ...
    {
        public string LastResponseString { protected set; get; }
        public HttpWebResponse LastResponseObject { private set; get; }
        ...
        public string GetResponseContent(HttpWebResponse response)
        {
            ...
            LastResponseString = responseFromServer;
