...
{
    /// <summary>
    /// SOH: Đơn đặt hàng bán
    /// </summary>
    public class V6Invoice91 : V6InvoiceBase
    {
        /// <summary>
        /// SOH: Đơn đặt hàng bán
        /// </summary>
        public V6Invoice91() : base("SOH") { }
        ...
        public override bool InsertInvoice(IDictionary<string, object> amData, List<IDictionary<string, object>> adList)
        {
            ...
            if (insert_success && j == adList.Count)
            {
                ...
                try
                {
                    ...
                    V6BusinessHelper.ExecuteProcedureNoneQuery("VPA_SOH_POST_MAIN", pList);
            ...
            else // insert không đủ dòng.
            {
                ...
                Logger.WriteToLog(string.Format("{0} Invoice91.InsertInvoice else.{1} {2}", V6Login.ClientName, stt_rec, V6Message));
            }
            return false;
        }
        ...
        public override bool InsertInvoice2_TH(IDictionary<string, object> amData, List<IDictionary<string, object>> adList)
        {
            ...
            if (insert_success && j == adList.Count)
            {
                ...
                try
                {
                    ...
                    var result = SqlHelper.ExecuteNonQuery(DatabaseConfig.ConnectionString2_TH, CommandType.StoredProcedure, "VPA_SOH_POST_MAIN", pList);
            ...
            IDictionary<string, object> keys)
        {
            ...
            if (insert_success && j == adList.Count)
            {
                ...
                try
                {
                    ...
                    SqlHelper.ExecuteNonQuery(DatabaseConfig.ConnectionString2_TH, CommandType.StoredProcedure, "VPA_SOH_POST_MAIN", pList);
        ...
        public DataTable SearchDonHang(DateTime ngayCt, string where0Ngay, string where1AM, string where2AD, string where3NhVt, string where4Dvcs, string where4Dvcs_2, string advance, out string loai_ct_chon)
        {
            ...
            var tbl = V6BusinessHelper.ExecuteProcedure("VPA_GET_STOCK_SOH", plist).Tables[0];
            return tbl;
        }

        public DataTable SearchDonHang_IXY(DateTime ngayCt, string where0Ngay, string where1AM, string where2AD, string where3NhVt, string where4Dvcs, string where4Dvcs_2, string advance, out string loai_ct_chon)
        {
            if (where0Ngay.Length > 0) where0Ngay = "And " + where0Ngay;
            if (where1AM.Length > 0) where1AM = "And " + where1AM;
            ...
            var tbl = V6BusinessHelper.ExecuteProcedure("VPA_GET_STOCK_SOH_IXY", plist).Tables[0];
            return tbl;
        }
        ...
        public DataTable SearchDonHangBanAll(DateTime ngayCt, string where0Ngay, string where1AM, string where2AD, string where3NhVt, string where4Dvcs, string where4Dvcs_2, string advance, out string loai_ct_chon)
        {
            if (where0Ngay.Length > 0) where0Ngay = "And " + where0Ngay;
            if (where1AM.Length > 0) where1AM = "And " + where1AM;
