    ...
    public class V6Invoice41 : V6InvoiceBase
    {
        ...
        public override bool InsertInvoice(IDictionary<string, object> amData, List<IDictionary<string, object>> adList, List<IDictionary<string, object>> adList3)
        {
            ...
            else // insert không đủ dòng.
            {
                ...
                Logger.WriteToLog(string.Format("{0} Invoice41.InsertInvoice else.{1} {2}", V6Login.ClientName, stt_rec, V6Message));
            }
            return false;
        }
        ...
        public override bool InsertInvoice2_TH(IDictionary<string, object> amData, List<IDictionary<string, object>> adList, List<IDictionary<string, object>> adList3)
        {
            ...
            if (insert_success && j == adList.Count && j3 == adList3.Count)
            {
                ...
                try
                {
                    ...
                    var result = SqlHelper.ExecuteNonQuery(DatabaseConfig.ConnectionString2_TH, CommandType.StoredProcedure, "VPA_TA1_POST_MAIN", pList);
            ...
            IDictionary<string, object> keys)
        {
            ...
            SqlHelper.ExecuteNonQuery(DatabaseConfig.ConnectionString2_TH, CommandType.StoredProcedure, "VPA_TA1_POST_MAIN_BEFORE", pList0);
            ...
            if (insert_success && j == adList.Count && j3 == adList3.Count)
            {
                ...
                try
                {
                    ...
                    SqlHelper.ExecuteNonQuery(DatabaseConfig.ConnectionString2_TH, CommandType.StoredProcedure, "VPA_TA1_POST_MAIN", pList);
                    return true;
                }
                catch (Exception ex)
                {
