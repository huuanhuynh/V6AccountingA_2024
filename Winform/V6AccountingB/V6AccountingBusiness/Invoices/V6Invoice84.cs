...
namespace V6AccountingBusiness.Invoices
{
    ...
    public class V6Invoice84 : V6InvoiceBase
    {
        ...
        public DataTable SearchPhieuXuatKho_PNKho(DateTime ngayCt, string where0Ngay, string where1AM, string where2AD, string where3NhVt, string where4Dvcs, string where4Dvcs_2, string advance, out string loai_ct_chon)
        {
            ...
            var tbl = V6BusinessHelper.ExecuteProcedure("VPA_GET_STOCK_IND_IXA", plist).Tables[0];
            return tbl;
        }

        public DataTable SearchPhieuNhapMua_PXK(DateTime ngayCt, string where0Ngay, string where1AM, string where2AD, string where3NhVt, string where4Dvcs, string where4Dvcs_2, string advance, out string loai_ct_chon)
        {
            if (where0Ngay.Length > 0) where0Ngay = "And " + where0Ngay;
            if (where1AM.Length > 0) where1AM = "And " + where1AM;
            ...
            SqlParameter[] plist =
            {
                new SqlParameter("@sType",  "I"),
	            new SqlParameter("@dFrom",  ngayCt.ToString("yyyyMMdd")),
	            new SqlParameter("@cTableAM", "AM71"), 
	            new SqlParameter("@cTableAD", "AD71"), 
	            new SqlParameter("@cKey1AM", where0Ngay),
	            new SqlParameter("@cKey2AM", where1AM),
	            new SqlParameter("@cKey1AD", whereAD_Nhvt_Dvcs),
	            new SqlParameter("@cKey2AD", ""),
            ...
            var tbl = V6BusinessHelper.ExecuteProcedure("VPA_GET_STOCK_POA_IXA", plist).Tables[0];
            return tbl;
        }

        public DataTable SearchPhieuNhapKhau_PXK(DateTime ngayCt, string where0Ngay, string where1AM, string where2AD, string where3NhVt, string where4Dvcs, string where4Dvcs_2, string advance, out string loai_ct_chon)
        {
            if (where0Ngay.Length > 0) where0Ngay = "And " + where0Ngay;
            if (where1AM.Length > 0) where1AM = "And " + where1AM;
            ...
            SqlParameter[] plist =
            {
                new SqlParameter("@sType",  "I"),
	            new SqlParameter("@dFrom",  ngayCt.ToString("yyyyMMdd")),
	            new SqlParameter("@cTableAM", "AM72"), 
	            new SqlParameter("@cTableAD", "AD72"), 
	            new SqlParameter("@cKey1AM", where0Ngay),
	            new SqlParameter("@cKey2AM", where1AM),
	            new SqlParameter("@cKey1AD", whereAD_Nhvt_Dvcs),
	            new SqlParameter("@cKey2AD", ""),
            ...
            var tbl = V6BusinessHelper.ExecuteProcedure("VPA_GET_STOCK_POB_IXA", plist).Tables[0];
            return tbl;
        }
    }
