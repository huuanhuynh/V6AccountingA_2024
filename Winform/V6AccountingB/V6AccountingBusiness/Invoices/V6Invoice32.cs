...
{
    /// <summary>
    /// AP2: Phiếu thanh toán tạm ứng
    /// </summary>
    public class V6Invoice32 : V6InvoiceBase
    {
        public V6Invoice32() : base("AP2") { }
            ...
            List<IDictionary<string, object>> adList, List<IDictionary<string, object>> adList2)
        {
            ...
            if (insert_success && j == adList.Count && j2 == adList2.Count)
            {
                ...
                try
                {
                    ...
                    V6BusinessHelper.ExecuteProcedureNoneQuery("VPA_AP2_POST_MAIN", pList);
                    return true;
                }
                catch (Exception ex)
                {
            ...
            else // insert không đủ dòng.
            {
                ...
                Logger.WriteToLog(string.Format("{0} Invoice32.InsertInvoice else.{1} {2}", V6Login.ClientName, stt_rec, V6Message));
            }
            return false;
        }
            ...
            List<IDictionary<string, object>> adList, List<IDictionary<string, object>> adList2)
        {
            ...
            if (insert_success && j == adList.Count && j2 == adList2.Count)
            {
                ...
                try
                {
                    ...
                    var result = SqlHelper.ExecuteNonQuery(DatabaseConfig.ConnectionString2_TH, CommandType.StoredProcedure, "VPA_AP2_POST_MAIN", pList);
            ...
            IDictionary<string, object> keys)
        {
            ...
            if (insert_success && j == adList.Count && j2 == adList2.Count)
            {
                ...
                try
                {
                    ...
                    SqlHelper.ExecuteNonQuery(DatabaseConfig.ConnectionString2_TH, CommandType.StoredProcedure, "VPA_AP2_POST_MAIN", pList);
                    return true;
                }
                catch (Exception ex)
                {
        ...
        public override bool DeleteInvoice(string sttrec)
        {
            try
            {
                ...
                V6BusinessHelper.ExecuteProcedureNoneQuery("VPA_AP2_DELETE_MAIN", plist);
                return true;
            }
            catch (Exception ex)
            {
