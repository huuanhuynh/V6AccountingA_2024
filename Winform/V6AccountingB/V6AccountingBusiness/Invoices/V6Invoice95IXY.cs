...
{
    /// <summary>
    /// IXY: Đề nghị xuất kho
    /// </summary>
    public class V6Invoice95IXY : V6InvoiceBase
    {
        public V6Invoice95IXY() : base("IXY") { }
        ...
        public override bool InsertInvoice(IDictionary<string, object> amData, List<IDictionary<string, object>> adList)
        {
            ...
            if (insert_success && j == adList.Count)
            {
                ...
                try
                {
                    ...
                    V6BusinessHelper.ExecuteProcedureNoneQuery("VPA_IXY_POST_MAIN", pList);
            ...
            else // insert không đủ dòng.
            {
                ...
                Logger.WriteToLog(string.Format("{0} Invoice95IXY.InsertInvoice else.{1} {2}", V6Login.ClientName, stt_rec, V6Message));
            }
            return false;
        }
        ...
        public override bool InsertInvoice2_TH(IDictionary<string, object> amData, List<IDictionary<string, object>> adList)
        {
            ...
            if (insert_success && j == adList.Count)
            {
                ...
                try
                {
                    ...
                    var result = SqlHelper.ExecuteNonQuery(DatabaseConfig.ConnectionString2_TH, CommandType.StoredProcedure, "VPA_IXY_POST_MAIN", pList);
            ...
            IDictionary<string, object> keys)
        {
            ...
            if (insert_success && j == adList.Count)
            {
                ...
                try
                {
                    ...
                    SqlHelper.ExecuteNonQuery(DatabaseConfig.ConnectionString2_TH, CommandType.StoredProcedure, "VPA_IXY_POST_MAIN", pList);
        ...
        public override bool DeleteInvoice(string sttrec)
        {
            try
            {
                ...
                V6BusinessHelper.ExecuteProcedureNoneQuery("VPA_IXY_DELETE_MAIN", plist);
                return true;
            }
            catch (Exception ex)
            {
        ...
        public DataTable SearchDeNghiXuat_HD(DateTime ngayCt, string where0Ngay, string where1AM, string where2AD, string where3NhVt, string where4Dvcs, string where4Dvcs_2, string advance, out string loai_ct_chon)
        {
            if (where0Ngay.Length > 0) where0Ngay = "And " + where0Ngay;
            if (where1AM.Length > 0) where1AM = "And " + where1AM;
            ...
            if (where2AD.Length > 0 || where3NhVt.Length > 0 || where4Dvcs.Length > 0)
            {
                ...
                whereAD_Nhvt_Dvcs = string.Format("\n Where d.Stt_rec in (SELECT Stt_rec FROM AD95 WHERE Ma_ct = 'IXY' {0} {2}"
                                     + (where3NhVt.Length == 0 ? "{3}" : "\n	And Ma_vt IN (SELECT Ma_vt FROM Alvt WHERE 1 = 1 {3})")
                                     + "\n		{4})"
            ...
            SqlParameter[] plist =
            {
	            ...
	            new SqlParameter("@cTableAM", "AM95"), 
	            new SqlParameter("@cTableAD", "AD95"), 
        ...
        public DataTable SearchDeNghiXuat_PXK(DateTime ngayCt, string where0Ngay, string where1AM, string where2AD, string where3NhVt, string where4Dvcs, string where4Dvcs_2, string advance, out string loai_ct_chon)
        {
            if (where0Ngay.Length > 0) where0Ngay = "And " + where0Ngay;
            if (where1AM.Length > 0) where1AM = "And " + where1AM;
        ...
        public DataTable SearchDeNghiXuat_PXDC(DateTime ngayCt, string where0Ngay, string where1AM, string where2AD, string where3NhVt, string where4Dvcs, string where4Dvcs_2, string advance, out string loai_ct_chon)
        {
            if (where0Ngay.Length > 0) where0Ngay = "And " + where0Ngay;
            if (where1AM.Length > 0) where1AM = "And " + where1AM;
            ...
            var tbl = V6BusinessHelper.ExecuteProcedure("VPA_GET_STOCK_IXB_IXY", plist).Tables[0];
            return tbl;
        }
            ...
            string mant, string mavt, string dvt1, string makh, string magia)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception("V6Invoice95IXY GetGiaBan " + ex.Message);
            }
            return null;
        }
        public DataTable SearchDonHangBanAll(DateTime ngayCt, string where0Ngay, string where1AM, string where2AD, string where3NhVt, string where4Dvcs, string advance, out string loai_ct_chon)
        {
            ...
            var tbl = V6BusinessHelper.ExecuteProcedure("VPA_GET_ALL_IXY", plist).Tables[0];
            return tbl;
        }
