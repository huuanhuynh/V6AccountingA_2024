...
namespace V6AccountingBusiness.Invoices
{
    ...
    public class V6Invoice31 : V6InvoiceBase
    {
        ...
        public override string Name { get { return "Hóa đơn mua hàng dịch vụ"; } }
        ...
        /// </summary>
        /// <param name="am">Thông tin chính</param>
            ...
            SortedDictionary<string,object> keys )
        {
            ...
            foreach (SortedDictionary<string, object> adRow in adList3)
            {
                var ad3Sql = SqlGenerator.GenInsertAMSql(V6Login.UserId, AD3Struct, adRow, false);
                j3 += SqlConnect.ExecuteNonQuery(TRANSACTION, CommandType.Text, ad3Sql) > 0 ? 1 : 0;
            }
        ...
        public DataTable LoadAd(string sttRec)
        {
            ...
            string sql = "SELECT c.*,d.Ten_tk AS Ten_tk FROM " + AD
