    ...
    public class Encoder : ICoder, ISetCoderProperties, IWriteCoderProperties
	{
		...
		class LiteralEncoder
		{
			public struct Encoder2
			{
				...
				public void Encode(RangerCoder.Encoder rangeEncoder, byte symbol)
				{
					uint context = 1;
					for (int i = 7; i >= 0; i--)
					{
				...
				public void EncodeMatched(RangerCoder.Encoder rangeEncoder, byte matchByte, byte symbol)
				{
					uint context = 1;
					bool same = true;
					for (int i = 7; i >= 0; i--)
		...
		class LenEncoder
		{
			...
			public void Encode(RangerCoder.Encoder rangeEncoder, UInt32 symbol, UInt32 posState)
			{
		...
		class LenPriceTableEncoder : LenEncoder
		{
			...
			public new void Encode(RangerCoder.Encoder rangeEncoder, UInt32 symbol, UInt32 posState)
			{
		...
		RangerCoder.Encoder _rangeEncoder = new RangerCoder.Encoder();
