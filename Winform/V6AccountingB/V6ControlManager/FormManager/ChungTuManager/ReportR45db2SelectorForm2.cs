...
{
    public partial class ReportR45db2SelectorForm2 : V6Form
    {
        public ReportR45db2SelectorForm2()
        {
            InitializeComponent();
        }

        public ReportR45db2SelectorForm2(V6InvoiceBase invoice)
        {
            InitializeComponent();
            _invoice = invoice;
        ...
        private void ReportR45db2SelectorForm2_SizeChanged(object sender, EventArgs e)
        {
            FixSize();
        }
    }
