...
namespace V6ControlManager.FormManager.ChungTuManager.Filter
{
    ...
    /// </summary>
    public partial class FilterView_ARS30 : Form
    {
        ...
        public FilterView_ARS30(V6InvoiceBase invoice, V6ColorTextBox sender, string sttRec, string maDvcs, string initStrFilter)
        {
            InitializeComponent();
        ...
        private void Init()
        {
            ...
            {
                this.ShowErrorMessage(GetType() + ".Init : " + ex.Message, "ChungTuManager FilterView_ARS30");
            }
        }
