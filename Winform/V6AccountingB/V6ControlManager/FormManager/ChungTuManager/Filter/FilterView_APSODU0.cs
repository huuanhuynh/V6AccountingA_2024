...
namespace V6ControlManager.FormManager.ChungTuManager.Filter
{
    ...
    /// </summary>
    public partial class FilterView_APSODU0 : Form
    {
        ...
        public FilterView_APSODU0(V6InvoiceBase invoice, V6ColorTextBox sender, string sttRec, string maDvcs, string initStrFilter)
        {
            InitializeComponent();
        ...
        private void Init()
        {
            try
            {
                var aldm_data = V6BusinessHelper.Select("aldm", "GRDS_V1,GRDF_V1,GRDHV_V1,GRDHE_V1,Title,Title2", "ma_dm='" + "ARS30" + "'").Data;
            ...
            {
                this.ShowErrorMessage(GetType() + ".Init : " + ex.Message, "ChungTuManager FilterView_APSODU0");
            }
        }
