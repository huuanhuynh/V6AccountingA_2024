...
namespace V6ControlManager.FormManager.ChungTuManager.Filter
{
    ...
    /// </summary>
    public partial class FilterView_APSODU0PT : Form
    {
        ...
        public FilterView_APSODU0PT(V6InvoiceBase invoice, V6ColorTextBox sender, string sttRec, string maDvcs, string initStrFilter)
        {
            InitializeComponent();
        ...
        private void Init()
        {
            try
            {
                var aldm_data = V6BusinessHelper.Select("aldm", "GRDS_V1,GRDF_V1,GRDHV_V1,GRDHE_V1,Title,Title2", "ma_dm='" + "APSODU0PT" + "'").Data;
                ...
                taiKhoan.VvarTextBox.Text = "33881";
            }
            catch (Exception ex)
            {
                this.ShowErrorMessage(GetType() + ".Init : " + ex.Message, "ChungTuManager FilterView_APSODU0PT");
            }
        }
        ...
        private void SearchData()
        {
            ...
            try
            {
                ...
                var alct0 = Invoice.GetSoDu0PT_All_Cust(_sttRec, txtMaDVCS.Text.Trim(), ngay_ct, _filterString);
