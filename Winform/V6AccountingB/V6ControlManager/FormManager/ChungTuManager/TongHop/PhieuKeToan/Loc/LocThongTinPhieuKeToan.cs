...
{
    public partial class LocThongTinPhieuKeToan : UserControl
    {
        public LocThongTinPhieuKeToan()
        {
            InitializeComponent();
            MyInit();
        }
        ...
        private void LocThongTinPhieuKeToan_VisibleChanged(object sender, EventArgs e)
        {
            txtMaDVCS.Text = V6Login.Madvcs;
        }
    }
