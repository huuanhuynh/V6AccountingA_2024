...
{
    public partial class TimPhieuKeToanForm : V6Form
    {
        private readonly PhieuKeToanControl _formChungTu;
        private readonly V6Invoice11 _invoice;
        private LocKetQuaPhieuKeToan _locKetQua;
        ...
        public TimPhieuKeToanForm()
        {
            InitializeComponent();
        }

        public TimPhieuKeToanForm(PhieuKeToanControl formChungTu, List<string> orderList2)
        {
            InitializeComponent();
        ...
        private void InitLocKetQua()
        {
            try
            {
                _locKetQua = new LocKetQuaPhieuKeToan(_invoice, _formChungTu.AM, _formChungTu.AD)
                {
                    Dock = DockStyle.Fill,
                    Visible = false
                };
        ...
        void locKetQua_OnSelectAMRow(int index, string mact, string sttrec, decimal ttt_nt, decimal ttt, string mant)
        {
            try
            {
                ...
                _locKetQua.SetAD(_formChungTu.AD, _formChungTu.AD2, _orderList2);
            }
            catch (Exception ex)
            {
        ...
        private void ShowLocKetQua()
        {
            ...
            _locKetQua.Dock = DockStyle.Fill;
        ...
        private void PrepareThread_TopCuoiKy()
        {
            ...
            var AD_Struct = _invoice.ADStruct;
        ...
        private void DoSearch()
        {
            try
            {
                ...
                {
                    tempAM = _invoice.SearchAM_TopCuoiKy(_where0Time, _where1AM, _where2AD, _w3NhomVt, "");
                }
                else
                {
                    tempAM = _invoice.SearchAM(_where0Time, _where1AM, _where2AD, _w3NhomVt, "");
                }
        ...
        private void InitTuyChon()
        {
            ...
            chkNSD.Checked = new V6Invoice71().M_LOC_NSD;
        ...
        private void TimPhieuKeToanForm_Activated(object sender, EventArgs e)
        {
            locThoiGian1.Focus();
        }

        private void TimPhieuKeToanForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            e.Cancel = true;
            Hide();
        }
