...
namespace V6ControlManager.FormManager.ChungTuManager.TongHop.PhieuKeToan.Loc
{
    public partial class TimPhieuKeToanForm : V6Form
    {
        ...
        public LocKetQuaPhieuKeToan _locKetQua;
        ...
        public TimPhieuKeToanForm(V6Invoice11 invoice, V6Mode mode, List<string> orderList2)
        {
            InitializeComponent();
            _mode = mode;
            _invoice = invoice;
        ...
        private void InitLocKetQua()
        {
            try
            {
                _locKetQua = new LocKetQuaPhieuKeToan(_invoice, _formChungTu_AM, _formChungTu_AD)
                {
                    Dock = DockStyle.Fill,
                    Visible = false
                };
        ...
        void locKetQua_OnSelectAMRow(int index, string mact, string sttrec, decimal ttt_nt, decimal ttt, string mant)
        {
            try
            {
                ...
                _locKetQua.SetAD(_formChungTu_AD, _formChungTu_AD2, _orderList2);
            }
            catch (Exception ex)
            {
