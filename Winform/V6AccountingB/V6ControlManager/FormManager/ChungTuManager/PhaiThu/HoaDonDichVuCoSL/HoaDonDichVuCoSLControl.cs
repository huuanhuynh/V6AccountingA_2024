...
namespace V6ControlManager.FormManager.ChungTuManager.PhaiThu.HoaDonDichVuCoSL
{
    ...
    public partial class HoaDonDichVuCoSLControl : V6InvoiceControl
    {
        ...
        /// </summary>
        public HoaDonDichVuCoSLControl(string itemId, string sttRec)
        {
            m_itemId = itemId;
            InitializeComponent();
            MyInit();
            ...
            try
            {
                if (IsViewingAnInvoice)
                {
                    if (V6Login.UserRight.AllowPrint("", Invoice.CodeMact))
                    {
                        ...
                        {
                            if (HoaDonDichVuCoSL_nd51 == 1) Invoice.IncreaseSl_inAM(stt_rec);
        ...
        private void HoaDonDichVuCoSLDetail1_ClickAdd(object sender)
        {
            XuLyDetailClickAdd();
        }
        private void HoaDonDichVuCoSLDetail1_AddHandle(SortedDictionary<string,object> data)
        {
        ...
        private void HoaDonDichVuCoSLDetail1_EditHandle(SortedDictionary<string,object> data)
        {
        ...
        private void HoaDonDichVuCoSLDetail1_ClickDelete(object sender)
        {
            XuLyXoaDetail();
        }
        private void HoaDonDichVuCoSLDetail1_ClickCancelEdit(object sender)
        {
        ...
        private void HoaDonDichVuCoSLDetail1_ClickEdit(object sender)
        {
            try
            {
            ...
            {
                this.ShowErrorMessage(GetType() + ".HoaDonDichVuCoSLDetail1_ClickEdit: " + ex.Message);
            }
        }
        ...
        private void ChucNang_ChonDonHang()
        {
            try
            {
                ...
                if (ma_kh != "" && ma_dvcs != "")
                {
                    CDH_HoaDonDichVuCoSLForm chon = new CDH_HoaDonDichVuCoSLForm(dateNgayCT.Value, txtMadvcs.Text, txtMaKh.Text);
        ...
        void chon_AcceptSelectEvent(List<SortedDictionary<string, object>> selectedDataList)
        {
            ...
            {
                this.ShowErrorException(GetType() + ".chon_AcceptSelectEvent " + _sttRec, ex);
            }
        }
        ...
        private void ChonPhieuXuat_A()
        {
            try
            {
                try
                {
                    ...
                    if (ma_kh != "" && ma_dvcs != "")
                    {
                        CPX_HoaDonDichVuCoSLForm chon = new CPX_HoaDonDichVuCoSLForm(dateNgayCT.Value, txtMadvcs.Text, txtMaKh.Text);
                        chon.AcceptSelectEvent += chon_AcceptSelectEvent;
                        chon.ShowDialog(this);
                    }
                    else
                ...
                {
                    this.ShowErrorMessage(GetType() + ".XuLyChonPhieuXuat: " + ex.Message, "HoaDonDichVuCoSLControl");
                }
            }
            catch (Exception ex)
            {
        ...
        private void XuLyChonPhieuNhap()
        {
            try
            {
                ...
                if (ma_kh != "" && ma_dvcs != "")
                {
                    CPN_HoaDonDichVuCoSLForm chon = new CPN_HoaDonDichVuCoSLForm(dateNgayCT.Value.Date, txtMadvcs.Text, txtMaKh.Text);
