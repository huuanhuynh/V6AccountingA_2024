...
{
    public partial class LocThongTinHoaDonDichVuCoSL : UserControl
    {
        public LocThongTinHoaDonDichVuCoSL()
        {
            InitializeComponent();
            MyInit();
        }
        ...
        public string GetFilterSql(V6InvoiceBase invoice, V6TableStruct tableStruct, string tableLable = null,
