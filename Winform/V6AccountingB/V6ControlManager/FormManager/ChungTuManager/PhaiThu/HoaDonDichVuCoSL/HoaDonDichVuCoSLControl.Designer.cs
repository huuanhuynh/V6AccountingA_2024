...
namespace V6ControlManager.FormManager.ChungTuManager.PhaiThu.HoaDonDichVuCoSL
{
    partial class HoaDonDichVuCoSLControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.detail1.ClickAdd += new V6ControlManager.FormManager.ChungTuManager.HD_Detail.ClickHandle(this.HoaDonDichVuCoSLDetail1_ClickAdd);
            ...
            this.detail1.DeleteHandle += new V6ControlManager.FormManager.ChungTuManager.HD_Detail.ClickHandle(this.HoaDonDichVuCoSLDetail1_ClickDelete);
