...
{
    public partial class CPN_HoaDonDichVuCoSLForm : V6Form
    {
        //private readonly PhieuXuatTraLaiNCCControl _PhieuXuatTraLaiNCCForm;
        private CPN_KetQua_HoaDonDichVuCoSL _locKetQua;
        ...
        public CPN_HoaDonDichVuCoSLForm()
        {
            InitializeComponent();
        }

        public CPN_HoaDonDichVuCoSLForm(DateTime ngayCt, string ma_dvcs, string ma_kh)
        {
            InitializeComponent();
        ...
        private void InitLocKetQua()
        {
            try
            {
                _locKetQua = new CPN_KetQua_HoaDonDichVuCoSL(Invoice)
        ...
        private void DoSearch()
        {
            try
            {
                tAM = Invoice.SearchPhieuNhap_HoaDon(_ngayCt, _where0Time, _where1AM, _where2AD, _w3NhomVt, _w4Dvcs);
        ...
        private void CPN_HoaDonDichVuCoSLForm_VisibleChanged(object sender, EventArgs e)
        {
            txtMaDVCS.Text = V6Login.Madvcs;
        }
    }
