...
{
    public partial class CDH_HoaDonDichVuCoSLKetQua : LocKetQuaBase
    {
        public CDH_HoaDonDichVuCoSLKetQua()
        {
            InitializeComponent();
        }

        public CDH_HoaDonDichVuCoSLKetQua(V6InvoiceBase invoice)
        {
            InitializeComponent();
            _invoice = invoice;
            MyInit();
        ...
        private void MyInit()
        {
            try
            {
                _aldmConfig = ConfigManager.GetAldmConfig("AMAD91E");
