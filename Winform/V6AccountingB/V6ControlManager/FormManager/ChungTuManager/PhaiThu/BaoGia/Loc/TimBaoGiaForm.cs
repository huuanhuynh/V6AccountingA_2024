...
namespace V6ControlManager.FormManager.ChungTuManager.PhaiThu.BaoGia.Loc
{
    public partial class TimBaoGiaForm : V6Form
    {
        ...
        public LocKetQuaBaoGia _locKetQua;
        ...
        public TimBaoGiaForm()
        {
            InitializeComponent();
        }

        public TimBaoGiaForm(V6Invoice93 invoice, V6Mode mode)
        {
            InitializeComponent();
            _mode = mode;
            _invoice = invoice;
        ...
        private void MyInit()
        {
            try
            {
                ...
                LoadDefaultData(4, "SOR", "SEARCH_SOR", ItemID);
        ...
        private void InitLocKetQua()
        {
            try
            {
                _locKetQua = new LocKetQuaBaoGia(_invoice, _formChungTu_AM, _formChungTu_AD)
                {
                    Dock = DockStyle.Fill,
                    Visible = false
                };
        ...
        private void Nhan()
        {
            try
            {
                if (tempAM != null && tempAM.Rows.Count>0 && _locKetQua != null && _locKetQua.Visible)
                {
        ...
        private void PrepareThread_TopCuoiKy()
        {
            ...
            _where0Time = _where0Time = string.Format("ngay_ct <= '{0:yyyyMMdd}' and ngay_ct >= '{1:yyyyMMdd}'", V6Setting.M_Ngay_ck, V6Setting.M_Ngay_dk);
        ...
        private void MyInit_ThoiGian()
        {
            ...
            {
                this.WriteExLog(GetType() + ".MyInit_ThoiGian", ex);
            }
        }
        ...
        private void MyInit_TT()
        {
            ...
            {
                this.WriteExLog(GetType() + ".MyInit_TT", ex);
            }
        }
            ...
            string oper = "=", bool and = true)
        {
            ...
            var keys_Adv = panelFilter1.GetQueryKeys();//Test get key Dic
        ...
        private void TimBaoGiaForm_Load(object sender, EventArgs e)
        {
        ...
        private void TimBaoGiaForm_Activated(object sender, EventArgs e)
        {
            Focus1();
        }
        ...
        private void TimBaoGiaForm_VisibleChanged(object sender, EventArgs e)
        {
            txtMaDVCS.Text = V6Login.Madvcs;
        }
    }
