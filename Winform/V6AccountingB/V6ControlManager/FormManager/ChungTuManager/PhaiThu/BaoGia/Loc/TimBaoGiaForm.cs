...
namespace V6ControlManager.FormManager.ChungTuManager.PhaiThu.BaoGia.Loc
{
    public partial class TimBaoGiaForm : V6Form
    {
        ...
        public TimBaoGiaForm(BaoGiaControl formChungTu)
        {
            InitializeComponent();
        ...
        private void InitLocKetQua()
        {
            try
            {
                _locKetQua = new LocKetQuaBaoGia(_invoice, _formChungTu.AM, _formChungTu.AD)
                {
                    Dock = DockStyle.Fill,
                    Visible = false
                };
        ...
        private void PrepareThread_TopCuoiKy()
        {
            ...
            _where0Time = _where0Time = string.Format("ngay_ct <= '{0:yyyyMMdd}'", V6Setting.M_Ngay_ck);
        ...
        private void TimBaoGiaForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            e.Cancel = true;
            Hide();
        }
