...
namespace V6ControlManager.FormManager.ChungTuManager.PhaiThu.BaoGia
{
    ...
    public partial class BaoGiaControl : V6InvoiceControl
    {
        ...
        public V6VvarTextBox _maVt, _Ma_lnx_i, _dvt1, _maKho, _maKhoI, _tkDt, _tkGv, _tkCkI, _tkVt, _maLo, _mavvi, _ma_thue_i, _tk_thue_i, txtPMA_KHC;
        public V6NumberTextBox _soLuong1, _soLuong, _he_so1T, _he_so1M, _giaNt2, _giaNt21, _tien2, _tienNt2, _ck, _ckNt, _gia2, _gia21, _thue_nt, _thue, _sl_td1;
        public V6NumberTextBox _ton13, _ton13s, _ton13Qd, _gia, _gia_nt, _tien, _tien_nt, _pt_cki, _thue_suat_i, _ggNt, _gg;
        public V6NumberTextBox _sl_qd, _sl_qd2, _hs_qd1, _hs_qd2, _hs_qd3, _hs_qd4, _tien_vcNt, _tien_vc;
        ...
        public void CheckSoLuong1_row(DataGridViewRow row, decimal HE_SO1T, decimal HE_SO1M, string actionField)
        {
            try
            {
                ...
                TinhTienNt2_row(row, HE_SO1T, HE_SO1M, actionField);
                //TinhTienVon_();
            }
            catch (Exception ex)
            {
        ...
        private TimBaoGiaForm SearchForm
        {
            get
            {
                if (_timForm == null || _timForm.IsDisposed)
                    _timForm = new TimBaoGiaForm(Invoice, V6Mode.View);
                return _timForm;
            }
        }
        ...
        private void ChucNang_ChonTuExcel(bool add)
        {
            try
            {
                ...
                chonExcel.CheckFields = "MA_VT,MA_KHO_I,SO_LUONG1,GIA_NT21,TIEN_NT2";
