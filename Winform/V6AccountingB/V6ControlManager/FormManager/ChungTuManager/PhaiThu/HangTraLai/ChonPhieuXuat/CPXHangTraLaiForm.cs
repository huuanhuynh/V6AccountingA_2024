...
namespace V6ControlManager.FormManager.ChungTuManager.PhaiThu.HangTraLai.ChonPhieuXuat
{
    public partial class CPXHangTraLaiForm : V6Form
    {
        ...
        public CPXHangTraLaiForm()
        {
            InitializeComponent();
        }

        public CPXHangTraLaiForm(HangTraLaiControl HangTraLaiForm, string ma_dvcs, string ma_kh)
        {
            InitializeComponent();
        ...
        private void CPXHangTraLaiForm_Load(object sender, EventArgs e)
        {
            if (_HangTraLaiForm.AM != null && _viewMode)
            {
                ShowLocKetQua();
            }
            else
        ...
        private void CPXHangTraLaiForm_Activated(object sender, EventArgs e)
        {
            locThoiGian1.Focus();
        }
