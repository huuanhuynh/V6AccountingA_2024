...
{
    public partial class CPXThongTinChiTietHangTraLai : UserControl
    {
        public CPXThongTinChiTietHangTraLai()
        {
            InitializeComponent();
        }
        public string locThongTinCT_GetFilterSql(V6TableStruct tableStruct, string tableLable,
