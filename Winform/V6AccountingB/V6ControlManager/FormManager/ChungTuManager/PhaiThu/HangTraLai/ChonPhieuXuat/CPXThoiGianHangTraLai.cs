...
{
    public partial class CPXThoiGianHangTraLai : UserControl
    {
        public CPXThoiGianHangTraLai()
        {
            InitializeComponent();
        ...
        public string locThoiGian_GetFilterSql(V6TableStruct tableStruct, string tableLable,
