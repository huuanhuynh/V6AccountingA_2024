...
{
    public partial class TimHangTraLaiForm : V6Form
    {
        private readonly HangTraLaiControl _formChungTu;
        private V6Invoice76 _invoice;
        private LocKetQuaHangTraLai _locKetQua;
        ...
        public TimHangTraLaiForm()
        {
            InitializeComponent();
        }

        public TimHangTraLaiForm(HangTraLaiControl formChungTu)
        {
            InitializeComponent();
        ...
        private void MyInit()
        {
            try
            {
                ...
                LoadDefaultData(4, _invoice.Mact, "SEARCH_SOF", ItemID);
        ...
        private void InitLocKetQua()
        {
            try
            {
                _locKetQua = new LocKetQuaHangTraLai(_invoice, _formChungTu.AM, _formChungTu.AD)
        ...
        private void TimHangTraLaiForm_Load(object sender, EventArgs e)
        {
        ...
        private void TimHangTraLaiForm_Activated(object sender, EventArgs e)
        {
            locThoiGian1.Focus();
        }

        private void TimHangTraLaiForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            e.Cancel = true;
            Hide();
        }
        ...
        private void TimHangTraLaiForm_VisibleChanged(object sender, EventArgs e)
        {
            txtMaDVCS.Text = V6Login.Madvcs;
        }
    }
