...
namespace V6ControlManager.FormManager.ChungTuManager.PhaiThu.HangTraLai.Loc
{
    public partial class TimHangTraLaiForm : V6Form
    {
        ...
        public LocKetQuaHangTraLai _locKetQua;
        ...
        public TimHangTraLaiForm(V6Invoice76 invoice, V6Mode mode)
        {
            InitializeComponent();
            _mode = mode;
            _invoice = invoice;
        ...
        private void InitLocKetQua()
        {
            try
            {
                _locKetQua = new LocKetQuaHangTraLai(_invoice, _formChungTu_AM, _formChungTu_AD)
