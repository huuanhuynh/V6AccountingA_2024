...
{
    public partial class HangTraLaiContainer : V6Control
    {
        private Timer _timerHideMessage;
        private int _timeCount, currentTabIndex = -1;
        public HangTraLaiContainer()
        {
            V6Invoice76 invoice81 = new V6Invoice76();
        ...
        public HangTraLaiContainer(string itemId)
        {
            m_itemId = itemId;
            V6Invoice76 invoice81 = new V6Invoice76();
            if (invoice81.Alct == null || invoice81.Alct.Rows.Count == 0)
        ...
        private void AddTab()
        {
            try
            {
                var HangTraLai = new HangTraLaiControl(m_itemId){ Dock = DockStyle.Fill };
                
                var tab = new TabPage(V6Text.Invoice);
                tab.Controls.Add(HangTraLai);
                HangTraLai.Disposed += delegate {
                    tab.Dispose();
                };
            ...
            {
                this.ShowErrorMessage(GetType() + ".AddTab: " +ex.Message, "HangTraLai");
            }
        }
        ...
        private void btnThemHangTraLai_Click(object sender, EventArgs e)
        {
            AddTab();
        }
        ...
        private void btnClose_Click(object sender, EventArgs e)
        {
            ...
            {
                this.ShowErrorMessage(GetType() + ".Close " + ex.Message, ex.Source);
            }
        }
