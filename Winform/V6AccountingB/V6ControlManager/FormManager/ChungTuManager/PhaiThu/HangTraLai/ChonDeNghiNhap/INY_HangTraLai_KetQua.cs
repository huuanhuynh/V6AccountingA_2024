...
{
    public partial class INY_HangTraLai_KetQua : LocKetQuaBase
    {
        public INY_HangTraLai_KetQua()
        {
            InitializeComponent();
        }

        public INY_HangTraLai_KetQua(V6InvoiceBase invoice)
        {
            InitializeComponent();
            _invoice = invoice;
            MyInit();
        ...
        private void MyInit()
        {
            try
            {
                _aldmConfig = ConfigManager.GetAldmConfig("AMAD94B");
