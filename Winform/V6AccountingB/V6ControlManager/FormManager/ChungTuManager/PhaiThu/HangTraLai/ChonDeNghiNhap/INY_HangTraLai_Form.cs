...
{
    public partial class INY_HangTraLai_Form : V6Form
    {
        V6Invoice94INY Invoice = new V6Invoice94INY();
        //private readonly HoaDonControl _PhieuNhapMuaForm;
        private INY_HangTraLai_KetQua _locKetQua;
        ...
        public INY_HangTraLai_Form()
        {
            InitializeComponent();
        }

        public INY_HangTraLai_Form(DateTime ngayCt, string ma_dvcs, string ma_kh)
        {
            InitializeComponent();
        ...
        private void MyInit()
        {
            try
            {
                ...
                LoadDefaultData(4, "IND", "SEARCH_IND_INY", ItemID);
        ...
        private void InitLocKetQua()
        {
            try
            {
                _locKetQua = new INY_HangTraLai_KetQua(Invoice)
        ...
        private void DoSearch()
        {
            try
            {
                tAM = Invoice.SearchDeNghiNhap_PNKho(_ngayCt, _where0Time, _where1AM, _where2AD, _w3NhomVt, _w4Dvcs, _w4Dvcs_2, _advance, out _loai_ct_chon);
