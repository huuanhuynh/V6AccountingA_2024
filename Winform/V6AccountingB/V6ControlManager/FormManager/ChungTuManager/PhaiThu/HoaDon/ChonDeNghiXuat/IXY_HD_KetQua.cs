...
{
    public partial class IXY_HD_KetQua : LocKetQuaBase
    {
        public IXY_HD_KetQua()
        {
            InitializeComponent();
        }

        public IXY_HD_KetQua(V6InvoiceBase invoice)
        {
            InitializeComponent();
            _invoice = invoice;
            MyInit();
        ...
        private void MyInit()
        {
            try
            {
                _aldmConfig = ConfigManager.GetAldmConfig("AMAD95B");
