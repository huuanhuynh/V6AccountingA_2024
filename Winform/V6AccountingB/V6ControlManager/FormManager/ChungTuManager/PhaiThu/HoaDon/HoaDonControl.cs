...
namespace V6ControlManager.FormManager.ChungTuManager.PhaiThu.HoaDon
{
    ...
    public partial class HoaDonControl : V6InvoiceControl
    {
        ...
        public V6VvarTextBox _maVt, _Ma_lnx_i, _dvt1, _maKhoI, _tkDt, _tkGv, _tkCkI, _tkVt, _maLo, _maViTri, _maTdi, _ma_thue_i, _tk_thue_i;
        public V6ColorTextBox _soKhung, _soMay;
        public V6NumberTextBox _soLuong1, _soLuong, _he_so1T, _he_so1M, _giaNt2, _giaNt21, _gia_ban_nt, _gia_ban,_tien2, _tienNt2, _ck, _ckNt,_gia2,_gia21;
        public V6NumberTextBox _ton13, _ton13Qd, _gia, _gia_nt, _tien, _tien_nt, _pt_cki, _thue_suat_i, _thue_nt, _thue;
        public V6NumberTextBox _sl_qd, _sl_qd2, _hs_qd1, _hs_qd2, _hs_qd3, _hs_qd4, _ggNt, _gg, _tien_vcNt, _tien_vc;
        public V6NumberTextBox _sl_td1;
            ...
            foreach (KeyValuePair<string, AlctControls> item in detailControlList1)
            {
                ...
                switch (NAME)
                {
                    case "MA_VT":
                        ...
                        {
                            var data = _maVt.Data;
                            if (data != null && M_SOA_MULTI_VAT == "1")
                            {
                                var new_ma_thue = (data["MA_THUE"] ?? "").ToString().Trim();
                                if (new_ma_thue != "")
                                {
                                    _ma_thue_i.Text = new_ma_thue;
        ...
        public void FixAlLoTon(DataTable alLoTon)
        {
            try
            {
        ...
        public void FixAlLoTon_NoKho(DataTable alLoTon)
        {
            try
            {
                string sttRec0 = _sttRec0;
        ...
        public void XuLyKhiNhanMaLo(IDictionary<string, object> row, bool isChanged)
        {
            try
            {
                //_maLo.Text = row["MA_LO"].ToString().Trim();
        ...
        public void XuLyKhiNhanMaVitri(IDictionary<string, object> row)//, DataRow row0)
        {
            try
            {
                _maLo.Text = row["MA_LO"].ToString().Trim();
        ...
        public override void EnableVisibleControls()
        {
            try
            {
                ...
                foreach (ToolStripMenuItem item in menuChucNang2.Items)
                {
                    V6ControlFormHelper.SetFormMenuItemReadOnly(item, readOnly);
                }
        ...
        {
            //LoadDefaultData(1, Invoice.Mact, Invoice.Mact, m_itemId, "");
        ...
        public bool ValidateData_Detail(IDictionary<string, object> data)
        {
            try
            {
        ...
        private void chonDonHangBanTheoKhoMenu_Click(object sender, EventArgs e)
        {
            if (NotAddEdit) return;
            bool shift = (ModifierKeys & Keys.Shift) == Keys.Shift;
            ChucNang_ChonDonHangBanTheoKho(shift);
        }
        ...
        private void ChucNang_ChonDonHangBan(bool add = false)
        {
            try
            {
                ...
                if (ma_dvcs != "")
                {
                    ...
                    chon.Form_program = Form_program;
                    _chon_px = "SOH";
        ...
        private void ChucNang_ChonDonHangBanTheoKho(bool shift)
        {
            try
            {
                if (NotAddEdit) return;                
                ...
                {
                    CDH_SOH_HoaDonForm chon = new CDH_SOH_HoaDonForm(dateNgayCT.Date, txtMaDVCS.Text, txtMaKh.Text);
                    chon.AcceptSelectEvent += chonTheoKho_AcceptSelectEvent;
                    chon.ShowDialog(this);
                }
                else
                {
        ...
        void chon_AcceptSelectEvent(List<IDictionary<string, object>> selectedDataList, ChonEventArgs e)
        {
            try
            {
                ...
                foreach (IDictionary<string, object> data in selectedDataList)
                {
                    ...
                    {
                        // IF VI_TRI (.????.) PXK CHON DE NGHI XUAT?
                        if (temp_vt.VITRI_YN)
                        {
        ...
        void chonTheoKho_AcceptSelectEvent(List<IDictionary<string, object>> selectedDataList, ChonEventArgs e)
        {
            try
            {
                txtLoaiCt.Text = e.Loai_ct;
