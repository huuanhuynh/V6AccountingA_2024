...
{
    public partial class ChangeTableForm : V6Form
    {
        public ChangeTableForm()
        {
            InitializeComponent();
        }
        public ChangeTableForm(object list)
        {
            InitializeComponent();
        }
        ...
        private void ChangeTableForm_Load(object sender, System.EventArgs e)
        {
            try
            {
        ...
        private void listBox1_SelectedIndexChanged(object sender, System.EventArgs e)
        {
            if (listBox1.DataSource != null)
            {
                ...
                {
                    SelectedID = row[ID_FIELD].ToString();
                    SelectedName = row[NAME_FIELD].ToString();
                }
                else
                {
                    SelectedID = null;
