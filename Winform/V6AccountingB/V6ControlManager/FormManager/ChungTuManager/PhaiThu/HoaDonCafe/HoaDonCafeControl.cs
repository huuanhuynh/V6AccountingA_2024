    ...
    public partial class HoaDonCafeControl : V6InvoiceControl
    {
        ...
        public string Status
        {
            ...
            set
            {
                ...
                {
                    case "0":
                        Mode = IsViewingAnInvoice ? V6Mode.View : V6Mode.Init;
                        break;
                    case "1":
                        Mode = V6Mode.Edit;
                        break;
        ...
        private void ViewInvoice()
        {
            try
            {
                ...
                SetGridViewData();
                XuLyThayDoiMaNt();
                //Mode = V6Mode.View; // Cafe hoi khac!
                FormatNumberControl();
                FormatNumberGridView();
                FixValues();
        ...
        private void DoAdd()
        {
            try
            {
                ...
                if (Invoice.InsertInvoice(readyDataAM, readyDataAD, readyDataAD3, _post))
                {
                    _AED_Success = true;
        ...
        private void DoAdd2_TH()
        {
            try
            {
                Invoice.InsertInvoice2_TH(readyDataAM, readyDataAD, readyDataAD3, _post);
            }
        ...
        private void DoEdit()
        {
            try
            {
                ...
                if (Invoice.UpdateInvoice(readyDataAM, readyDataAD, readyDataAD3, keys, _post))
                {
                    _AED_Success = true;
        ...
        private void DoEdit2_TH()
        {
            ...
            try
            {
                if (Invoice.Have_KEY_AM2TH)
                {
                    ...
                    {
                        if (Invoice.IS_AM2TH(readyDataAM))
                            Invoice.UpdateInvoice2_TH(readyDataAM, readyDataAD, readyDataAD3, _keys_TH, _post);
        ...
        internal bool Luu(string ma_khoPH, string ma_vitriPH, bool post)
        {
            ...
            try
            {
                ...
                readyDataAM["TIME2"] = time2;
                readyDataAM["MA_KHOPH"] = ma_khoPH;
                readyDataAM["MA_VITRIPH"] = ma_vitriPH;
                
                //readyDataAM["STATUS"] = _post ? "3" : Status;
                string save_status = _post ? "3" : Status;
                if(AM_current != null) AM_current["STATUS"] = save_status;
                readyDataAM["STATUS"] = save_status;
                //Update to AM
                V6BusinessHelper.UpdateRowToDataTable(AM, "Stt_rec", _sttRec, readyDataAM);

                V6ControlFormHelper.UpdateDKlistAll(readyDataAM, new[] {"SO_CT", "NGAY_CT", "MA_CT"}, AD);
                V6ControlFormHelper.UpdateDKlist(AD, "MA_KHO_I", readyDataAM["MA_KHOPH"]);
                if (!string.IsNullOrEmpty(ma_vitriPH))
                    V6ControlFormHelper.UpdateDKlist(AD, "MA_VITRI", readyDataAM["MA_VITRIPH"]);
        ...
        private TimHoaDonFormCafe SearchForm
        {
            get
            {
                if (_timForm == null || _timForm.IsDisposed)
                    _timForm = new TimHoaDonFormCafe(Invoice, V6Mode.View);
                return _timForm;
            }
        }
        ...
        private int SearchFirstMaVitriIndex(int currentIndex)
        {
            ...
            {
                this.WriteExLog(GetType() + ".SearchNextMaVitriIndex " + _sttRec, ex);
            }
            return -1;
        }
        ...
        private void txtSoCt_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                this.WriteExLog(GetType() + ".txtSoCt_TextChanged " + _sttRec, ex);
            }
        }
        ...
        private void chonHoaDonMauMenu_Click(object sender, EventArgs e)
        {
            ChonHoaDonMau();
        }
        ...
        void ChonHoaDonMau()
        {
            ...
            {
                this.ShowWarningMessage(V6Text.Text("INVALIDDATA") + checkFields);
                return;
            }
