...
namespace V6ControlManager.FormManager.ChungTuManager.PhaiThu.HoaDonDichVu.Loc
{
    public partial class TimHoaDonDichVuForm : V6Form
    {
        ...
        public LocKetQuaHoaDonDichVu _locKetQua;
        ...
        public TimHoaDonDichVuForm(V6Invoice21 invoice, V6Mode mode)
        {
            InitializeComponent();
            _mode = mode;
            _invoice = invoice;
        ...
        private void InitLocKetQua()
        {
            try
            {
                _locKetQua =  new LocKetQuaHoaDonDichVu(_invoice, _formChungTu_AM, _formChungTu_AD)
