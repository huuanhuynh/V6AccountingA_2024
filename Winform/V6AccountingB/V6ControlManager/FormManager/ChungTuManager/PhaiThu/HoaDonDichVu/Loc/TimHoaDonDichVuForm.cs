...
{
    public partial class TimHoaDonDichVuForm : V6Form
    {
        private readonly HoaDonDichVuControl _formChungTu;
        private V6Invoice21 _invoice;
        private LocKetQuaHoaDonDichVu _locKetQua;
        ...
        public TimHoaDonDichVuForm()
        {
            InitializeComponent();
        }

        public TimHoaDonDichVuForm(HoaDonDichVuControl formChungTu)
        {
            InitializeComponent();
        ...
        private void MyInit()
        {
            try
            {
                ...
                LoadDefaultData(4, "AR1", "SEARCH_AR1", ItemID);
            }
            catch (Exception ex)
            {
        ...
        private void InitLocKetQua()
        {
            try
            {
                _locKetQua =  new LocKetQuaHoaDonDichVu(_invoice, _formChungTu.AM, _formChungTu.AD)
        ...
        private void PrepareThread()
        {
            ...
            _where1AM = locThongTin1.GetFilterSql_ThongTin(_formChungTu.Invoice, stru, "", chkTTstart.Checked ? "start" : "like");
        ...
        private void TimHoaDonDichVuForm_Load(object sender, EventArgs e)
        {
        ...
        private void TimHoaDonDichVuForm_Activated(object sender, EventArgs e)
        {
            locThoiGian1.Focus();
        }

        private void TimHoaDonDichVuForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            e.Cancel = true;
            Hide();
        }
