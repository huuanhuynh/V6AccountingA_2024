...
{
    public partial class HoaDonDichVuContainer : V6Control
    {
        private Timer _timerHideMessage;
        private int _timeCount;
        private int currentTabIndex = -1;
        public HoaDonDichVuContainer()
        {
            V6Invoice21 invoice81 = new V6Invoice21();
        ...
        public HoaDonDichVuContainer(string itemId)
        {
            m_itemId = itemId;
            V6Invoice21 invoice81 = new V6Invoice21();
            if (invoice81.Alct == null || invoice81.Alct.Rows.Count == 0)
        ...
        private void AddTab()
        {
            try
            {
                var HoaDonDichVu = new HoaDonDichVuControl(m_itemId) { Dock = DockStyle.Fill };
                
                var tab = new TabPage(V6Text.Invoice);
                tab.Controls.Add(HoaDonDichVu);
                HoaDonDichVu.Disposed += delegate {
                    tab.Dispose();
                };
            ...
            {
                this.ShowErrorMessage(GetType() + ".AddTab: " +ex.Message, "HoaDonDichVu");
            }
        }
        ...
        private void btnThemHoaDonDichVu_Click(object sender, EventArgs e)
        {
            AddTab();
        }
