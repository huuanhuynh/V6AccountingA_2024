...
namespace V6ControlManager.FormManager.ChungTuManager.PhaiThu.DonDatHangBan
{
    ...
    public partial class DonDatHangBanControl : V6InvoiceControl
    {
        ...
        /// </summary>
        public DonDatHangBanControl(string itemId, string sttRec)
        {
            m_itemId = itemId;
            InitializeComponent();
            MyInit();
        ...
        private void TinhGiamGia()
        {
            try
            {
                if (!"123".Contains(V6Options.V6OptionValues["M_GIAVC_GIAGIAM_CT"]))
                {
                    var tTienNt2 = TinhTong("TIEN_NT2");
                    var tyGia = txtTyGia.Value;
                    var t_tien_nt2 = txtTongTienNt2.Value;
        ...
        public override void TinhTongThanhToan(string debug)
        {
            ...
            {
                this.ShowErrorMessage(string.Format("{0} {1} {2} {3} {4}", V6Login.ClientName, GetType(), MethodBase.GetCurrentMethod().Name, _sttRec, ex.Message), "Lỗi-TTT("+debug+")");
            }
        }

        private void TinhTongThue_ct()
        {
            var t_thue_nt = TinhTong("THUE_NT");
            var t_thue = TinhTong("THUE");
        ...
        private void LoadAlMaGia()
        {
            ...
            {
                this.ShowErrorMessage(string.Format("{0} {1} {2} {3} {4}", V6Login.ClientName, GetType(), MethodBase.GetCurrentMethod().Name, _sttRec, ex.Message), "Load AlMaGia");
            }
        }
        ...
        private void LoadAlnt()
        {
            ...
            {
                this.ShowErrorMessage(string.Format("{0} {1} {2} {3} {4}", V6Login.ClientName, GetType(), MethodBase.GetCurrentMethod().Name, _sttRec, ex.Message), "Load Alnt");
            }
        }
        ...
        private void DonDatHangBanDetail1_ClickEdit(object sender)
        {
            ...
            {
                this.ShowErrorMessage(GetType() + ".DonDatHangBanDetail1_ClickEdit: " + ex.Message);
            }
        }
        ...
        private void dataGridView1_DataError(object sender, DataGridViewDataErrorEventArgs e)
        {
            ...
            //this.ShowErrorMessage(GetType() + ".Datagridview DataError: " + e.Context + "\n" + e.Exception.Message);
        }
