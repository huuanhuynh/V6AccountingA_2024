...
namespace V6ControlManager.FormManager.ChungTuManager.PhaiThu.DonDatHangBan.Loc
{
    public partial class TimDonDatHangBanForm : V6Form
    {
        ...
        private void MyInit()
        {
            ...
            CreateDynamicFilter_TT(_formChungTu.Invoice.AMStruct, _formChungTu.Invoice.ADV_AM);
            CreateDynamicFilter2_TTCT(_formChungTu.Invoice.ADStruct, _formChungTu.Invoice.ADV_AD);
        ...
        private void InitLocKetQua()
        {
            try
            {
                _locKetQua = new LocKetQuaDonDatHangBan(_formChungTu.Invoice, _formChungTu.AM, _formChungTu.AD)
