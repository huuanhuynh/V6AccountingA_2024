...
{
    public partial class DonDatHangBanContainer : V6Control
    {
        private Timer _timerHideMessage;
        private int _timeCount;
        private int currentTabIndex = -1;
        public DonDatHangBanContainer()
        {
            V6Invoice91 invoice81 = new V6Invoice91();
        ...
        public DonDatHangBanContainer(string itemId)
        {
            m_itemId = itemId;
            V6Invoice91 invoice81 = new V6Invoice91();
            if (invoice81.Alct == null || invoice81.Alct.Rows.Count == 0)
        ...
        private void AddTab()
        {
            try
            {
                var DonDatHangBan = new DonDatHangBanControl(m_itemId) { Dock = DockStyle.Fill };
                
                var tab = new TabPage(V6Text.Invoice);
                tab.Controls.Add(DonDatHangBan);
                DonDatHangBan.Disposed += delegate {
                    tab.Dispose();
                };
            ...
            {
                this.ShowErrorMessage(GetType() + ".SOA AddTab: " +ex.Message, "DonDatHangBan");
            }
        }
        ...
        private void btnThemDonDatHangBan_Click(object sender, EventArgs e)
        {
            AddTab();
        }
