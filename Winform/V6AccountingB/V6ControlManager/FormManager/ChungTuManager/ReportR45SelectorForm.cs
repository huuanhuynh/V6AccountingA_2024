...
{
    public partial class ReportR45SelectorForm : V6Form
    {
        public ReportR45SelectorForm()
        {
            InitializeComponent();
        }

        public ReportR45SelectorForm(V6InvoiceBase invoice)
        {
            InitializeComponent();
            _invoice = invoice;
        ...
        private void ReportR45SelectorForm_SizeChanged(object sender, EventArgs e)
        {
            FixSize();
        }
    }
