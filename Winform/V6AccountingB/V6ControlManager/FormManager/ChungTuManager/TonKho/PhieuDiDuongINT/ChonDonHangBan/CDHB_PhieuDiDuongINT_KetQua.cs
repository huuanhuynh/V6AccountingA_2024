...
{
    public partial class CDHB_PhieuDiDuongINT_KetQua : LocKetQuaBase
    {
        public CDHB_PhieuDiDuongINT_KetQua()
        {
            InitializeComponent();
        }

        public CDHB_PhieuDiDuongINT_KetQua(V6InvoiceBase invoice)
        {
            InitializeComponent();
            _invoice = invoice;
            MyInit();
        ...
        private void MyInit()
        {
            try
            {
                _aldmConfig = ConfigManager.GetAldmConfig("AMAD91F");
