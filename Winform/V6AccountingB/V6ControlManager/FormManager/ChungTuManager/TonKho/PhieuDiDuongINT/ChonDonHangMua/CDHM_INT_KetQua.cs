...
{
    public partial class CDHM_INT_KetQua : LocKetQuaBase
    {
        public CDHM_INT_KetQua()
        {
            InitializeComponent();
        }
        public CDHM_INT_KetQua(V6InvoiceBase invoice)
        {
            InitializeComponent();
            _invoice = invoice;
        ...
        private void MyInit()
        {
            try
            {
                _aldmConfig = ConfigManager.GetAldmConfig("AMAD92F");
