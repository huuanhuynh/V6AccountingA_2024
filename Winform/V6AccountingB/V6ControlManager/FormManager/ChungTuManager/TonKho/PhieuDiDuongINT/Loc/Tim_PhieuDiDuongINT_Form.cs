...
{
    public partial class Tim_PhieuDiDuongINT_Form : V6Form
    {
        public DataTable _formChungTu_AM;
        public DataTable _formChungTu_AD;
        public DataTable _formChungTu_AD2;
        private V6Mode _mode;
        V6Invoice97INT _invoice;
        public LocKetQua_PhieuDiDuongINT _locKetQua;
        ...
        public Tim_PhieuDiDuongINT_Form()
        {
            InitializeComponent();
        }

        public Tim_PhieuDiDuongINT_Form(V6Invoice97INT invoice, V6Mode mode)
        {
            InitializeComponent();
            _mode = mode;
            _invoice = invoice;
        ...
        private void MyInit()
        {
            try
            {
                ...
                LoadDefaultData(4, "INT", "SEARCH_INT", ItemID);
        ...
        private void InitLocKetQua()
        {
            try
            {
                _locKetQua = new LocKetQua_PhieuDiDuongINT(_invoice, _formChungTu_AM, _formChungTu_AD)
                {
                    Dock = DockStyle.Fill,
                    Visible = false
                };
        ...
        private void Tim_PhieuDiDuongINT_Form_Activated(object sender, EventArgs e)
        {
            locThoiGian1.Focus();
        }
        ...
        private void Tim_PhieuDiDuongINT_Form_VisibleChanged(object sender, EventArgs e)
        {
            txtMaDVCS.Text = V6Login.Madvcs;
        }
    }
