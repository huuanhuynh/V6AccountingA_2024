...
{
    public partial class LocKetQua_PhieuDiDuongINT : LocKetQuaBase
    {
        public LocKetQua_PhieuDiDuongINT()
        {
            InitializeComponent();
        }
        
        public LocKetQua_PhieuDiDuongINT(V6InvoiceBase invoice, DataTable AM, DataTable AD)
        {
            InitializeComponent();
            _invoice = invoice;
