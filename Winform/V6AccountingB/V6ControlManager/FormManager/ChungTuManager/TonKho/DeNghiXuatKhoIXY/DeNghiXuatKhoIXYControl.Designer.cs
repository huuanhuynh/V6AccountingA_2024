...
namespace V6ControlManager.FormManager.ChungTuManager.TonKho.DeNghiXuatKhoIXY
{
    partial class DeNghiXuatKhoIXYControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.detail1.ClickAdd += new V6ControlManager.FormManager.ChungTuManager.HD_Detail.ClickHandle(this.DeNghiXuatKhoIXYDetail1_ClickAdd);
            ...
            this.detail1.DeleteHandle += new V6ControlManager.FormManager.ChungTuManager.HD_Detail.ClickHandle(this.DeNghiXuatKhoIXYDetail1_ClickDelete);
