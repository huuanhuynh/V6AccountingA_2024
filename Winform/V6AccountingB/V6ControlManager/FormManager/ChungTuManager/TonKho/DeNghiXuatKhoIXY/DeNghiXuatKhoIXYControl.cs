    ...
    public partial class DeNghiXuatKhoIXYControl : V6InvoiceControl
    {
            ...
            try
            {
                if (IsViewingAnInvoice)
                {
                    if (V6Login.UserRight.AllowPrint("", Invoice.CodeMact))
                    {
                        ...
                        c.PrintSuccess += (sender, stt_rec, DeNghiXuatKhoIXY_nd51) =>
                        {
                            if (DeNghiXuatKhoIXY_nd51 == 1)
                            {
        ...
        private void Xem()
        {
            try
            {
                if (IsHaveInvoice)
                {
                    if (_timForm == null) _timForm = new TimDeNghiXuatKhoIXYForm(this);
        ...
        private void Tim()
        {
            try
            {
                if (V6Login.UserRight.AllowView("", Invoice.CodeMact))
                {
                    ...
                    if (_timForm == null)
                        _timForm = new TimDeNghiXuatKhoIXYForm(this);
        ...
        private void DeNghiXuatKhoIXYDetail1_ClickAdd(object sender)
        {
            XuLyDetailClickAdd();
        }
        ...
        private void DeNghiXuatKhoIXYDetail1_ClickDelete(object sender)
        {
            XuLyXoaDetail();
        }
        private void DeNghiXuatKhoIXYDetail1_ClickCancelEdit(object sender)
        {
            dataGridView1.UnLock();
        ...
        private void DeNghiXuatKhoIXYDetail1_ClickEdit(object sender)
        {
            try
            {
