...
namespace V6ControlManager.FormManager.ChungTuManager.TonKho.DeNghiXuatKhoIXY
{
    ...
    /// </summary>
    public partial class DeNghiXuatKhoIXYControl : V6InvoiceControl
    {
        #region ==== Properties and Fields
        // ReSharper disable once InconsistentNaming
        public V6Invoice95IXY Invoice = new V6Invoice95IXY();
        ...
        public DeNghiXuatKhoIXYControl()
        {
            InitializeComponent();
            MyInit();
        }
        public DeNghiXuatKhoIXYControl(string itemId)
        {
            m_itemId = itemId;
            InitializeComponent();
            MyInit();
        ...
        public DeNghiXuatKhoIXYControl(string maCt, string itemId, string sttRec)
            : base(new V6Invoice95IXY(), itemId)
        {
            m_itemId = itemId;
            InitializeComponent();
            MyInit();
        ...
        private V6NumberTextBox _ton13, _ton13s, _ton13Qd, _gia, _gia_nt, _tien, _tien_nt, _pt_cki, _thue_suat_i, _thue_nt, _thue;
                    ...
                    case "MA_LO":
                        ...
                        _maLo.GotFocus += (s, e) =>
                        {
                            ...
                            if (V6Options.GetValue("M_IXY_CHECK_TON") == "1")
                            {
                                ...
                                var _dataViTri = Invoice.GetLoDate_IXY(_maVt.Text, _maKhoI.Text, _sttRec,
                                    dateNgayCT.Date);
        ...
        private void CheckMaLoTon(bool isChanged)
        {
            ...
            try
            {
                Invoice.GetAlLoTon_IXY(dateNgayCT.Date, _sttRec, _maVt.Text, _maKhoI.Text);
        ...
        private TimDeNghiXuatKhoIXYForm SearchForm
        {
            get
            {
                if (_timForm == null || _timForm.IsDisposed)
                    _timForm = new TimDeNghiXuatKhoIXYForm(Invoice, V6Mode.View);
                return _timForm;
            }
        }
        private TimDeNghiXuatKhoIXYForm _timForm;
        private void Xem()
        {
            try
            {
        ...
        #region ==== DeNghiXuatKhoIXYDetail Event ====
        ...
        private void DeNghiXuatKhoIXYDetail1_EditHandle(IDictionary<string, object> data)
        {
            if (ValidateData_Detail(data))
            {
        ...
        private void DeNghiXuatKhoIXYDetail1_ClickDelete(object sender, HD_Detail_Eventargs e)
        {
            XuLyXoaDetail();
        }
        ...
        private void DeNghiXuatKhoIXYBanHangKiemPhieuXuat_VisibleChanged(object sender, EventArgs e)
        {
            if (Visible)
            {
                SetStatus2Text();
        ...
        private void DeNghiXuatKhoIXYDetail1_Load(object sender, EventArgs e)
        {

        }

        private void DeNghiXuatKhoIXYDetail1_ClickEdit(object sender, HD_Detail_Eventargs e)
        {
            try
            {
        ...
        {
            FixMenuChucNangItemShiftText(chonDonHangBanMenu, chonBaoGiaMenu, chonTuExcelMenu, chonDonHangMuaMenu, importXmlMenu);
        }
