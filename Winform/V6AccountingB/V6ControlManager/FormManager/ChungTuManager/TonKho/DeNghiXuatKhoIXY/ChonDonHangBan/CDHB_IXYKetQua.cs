...
{
    public partial class CDHB_IXYKetQua : LocKetQuaBase
    {
        public CDHB_IXYKetQua()
        {
            InitializeComponent();
        }

        public CDHB_IXYKetQua(V6InvoiceBase invoice)
        {
            InitializeComponent();
            _invoice = invoice;
            MyInit();
        ...
        private void MyInit()
        {
            try
            {
                _aldmConfig = ConfigManager.GetAldmConfig("AMAD91C");
