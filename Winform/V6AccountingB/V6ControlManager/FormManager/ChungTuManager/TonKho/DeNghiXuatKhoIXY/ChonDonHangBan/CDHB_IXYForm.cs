...
{
    public partial class CDHB_IXYForm : V6Form
    {
        ...
        public CDHB_IXYForm(DateTime ngayCt, string ma_dvcs, string ma_kh)
        {
            InitializeComponent();
        ...
        private void MyInit()
        {
            try
            {
                ...
                LoadDefaultData(4, "IXY", "SEARCH_IXY_SOH", ItemID);
        ...
        private void InitLocKetQua()
        {
            try
            {
                _locKetQua = new CDHB_IXYKetQua(Invoice)
