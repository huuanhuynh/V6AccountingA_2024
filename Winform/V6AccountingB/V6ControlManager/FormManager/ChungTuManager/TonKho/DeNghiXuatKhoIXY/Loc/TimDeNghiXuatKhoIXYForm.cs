...
namespace V6ControlManager.FormManager.ChungTuManager.TonKho.DeNghiXuatKhoIXY.Loc
{
    public partial class TimDeNghiXuatKhoIXYForm : V6Form
    {
        ...
        public LocKetQuaDeNghiXuatKhoIXY _locKetQua;
        ...
        public TimDeNghiXuatKhoIXYForm(V6Invoice95IXY invoice, V6Mode mode)
        {
            InitializeComponent();
            _mode = mode;
            _invoice = invoice;
        ...
        private void InitLocKetQua()
        {
            try
            {
                _locKetQua = new LocKetQuaDeNghiXuatKhoIXY(_invoice, _formChungTu_AM, _formChungTu_AD)
