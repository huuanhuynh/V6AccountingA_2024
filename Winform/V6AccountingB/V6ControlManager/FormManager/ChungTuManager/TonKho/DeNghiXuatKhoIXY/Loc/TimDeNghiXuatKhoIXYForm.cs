...
{
    public partial class TimDeNghiXuatKhoIXYForm : V6Form
    {
        private readonly DeNghiXuatKhoIXYControl _formChungTu;
        private V6Invoice95IXY _invoice;
        private LocKetQuaDeNghiXuatKhoIXY _locKetQua;
        ...
        public TimDeNghiXuatKhoIXYForm()
        {
            InitializeComponent();
        }

        public TimDeNghiXuatKhoIXYForm(DeNghiXuatKhoIXYControl formChungTu)
        {
            InitializeComponent();
        ...
        private void InitLocKetQua()
        {
            try
            {
                _locKetQua = new LocKetQuaDeNghiXuatKhoIXY(_formChungTu.Invoice, _formChungTu.AM, _formChungTu.AD)
        ...
        private void TimDeNghiXuatKhoIXYForm_Load(object sender, EventArgs e)
        {
        ...
        private void TimDeNghiXuatKhoIXYForm_Activated(object sender, EventArgs e)
        {
            locThoiGian1.Focus();
        }

        private void TimDeNghiXuatKhoIXYForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            e.Cancel = true;
            Hide();
        }
        ...
        private void TimDeNghiXuatKhoIXYForm_VisibleChanged(object sender, EventArgs e)
        {
            txtMaDVCS.Text = V6Login.Madvcs;
        }
    }
