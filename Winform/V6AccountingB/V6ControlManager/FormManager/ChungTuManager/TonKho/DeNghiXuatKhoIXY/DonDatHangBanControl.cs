...
namespace V6ControlManager.FormManager.ChungTuManager.TonKho.DeNghiXuatKhoIXY
{
    ...
    public partial class DeNghiXuatKhoIXYControl : V6InvoiceControl
    {
        ...
        private void DeNghiXuatKhoIXYDetail1_AddHandle(SortedDictionary<string,object> data)
        {
        ...
        private void DeNghiXuatKhoIXYDetail1_EditHandle(SortedDictionary<string,object> data)
        {
            dataGridView1.UnLock();
            if (ValidateData_Detail(data))
            {
