...
{
    public partial class IXA_PNKho_KetQua : LocKetQuaBase
    {
        public IXA_PNKho_KetQua()
        {
            InitializeComponent();
        }

        public IXA_PNKho_KetQua(V6InvoiceBase invoice)
        {
            InitializeComponent();
            _invoice = invoice;
            MyInit();
        ...
        private void MyInit()
        {
            try
            {
                _aldmConfig = ConfigManager.GetAldmConfig("AMAD84B");
