...
namespace V6ControlManager.FormManager.ChungTuManager.TonKho.PhieuNhapKho.ChonDeNghiNhap
{
    public partial class INY_PNKho_Form : V6Form
    {
        ...
        public INY_PNKho_Form()
        {
            InitializeComponent();
        }

        public INY_PNKho_Form(DateTime ngayCt, string ma_dvcs, string ma_kh)
        {
            InitializeComponent();
        ...
        private void InitLocKetQua()
        {
            try
            {
                _locKetQua = new INY_PNKho_KetQua(Invoice)
