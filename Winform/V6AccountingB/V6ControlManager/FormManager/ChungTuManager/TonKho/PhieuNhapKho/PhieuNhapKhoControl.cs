...
namespace V6ControlManager.FormManager.ChungTuManager.TonKho.PhieuNhapKho
{
    public partial class PhieuNhapKhoControl : V6InvoiceControl
    {
        ...
        public void TinhTienVon1(Control actionControl = null)
        {
            ...
            {
                this.ShowErrorException(GetType() + ".TinhTienVon1 " + _sttRec, ex);
            }
        }
        ...
        public override void EnableVisibleControls()
        {
            try
            {
                ...
                else //Cac truong hop khac
                {
                    ...
                    _tien_nt0.Enabled = chkSuaTien.Checked && _nhap_tb.Text!="";
        ...
        private void FormatNumberControl()
        {
            try
            {
                ...
                _tien_nt0.DecimalPlaces = decimalPlaces;
            }
            catch (Exception ex)
            {
        ...
        private TimPhieuNhapKhoForm SearchForm
        {
            get
            {
                if (_timForm == null || _timForm.IsDisposed)
                    _timForm = new TimPhieuNhapKhoForm(Invoice, V6Mode.View);
                return _timForm;
            }
        }
            ...
            try
            {
                ...
                if (error == "")
                {
                    ...
                    {   
                        ...
                        //Tạo dòng dữ liệu mới. // 20231204 hoặc cộng dồng số lượng (quét QR).
        ...
        private void ChucNang_ChonTuExcel(bool add)
        {
            try
            {
                ...
                chonExcel.CheckFields = "MA_VT,MA_KHO_I,SO_LUONG1,GIA_NT0,TIEN_NT0";
        ...
        {
            XemVitriHangHu(_maKhoI.Text, dateNgayCT.Value, _maVt.Text);
        }
        ...
        {
            FixMenuChucNangItemShiftText(chonTuExcelMenu, chonDeNghiNhapMenu, chonDonHangMuaMenu, importXmlMenu, chonALVTMenu);
        }
        ...
        private void chonPXnhapLaiMenu_Click(object sender, EventArgs e)
        {
            if (txtLoaiPhieu.Text == "A")
            {
                bool shift = (ModifierKeys & Keys.Shift) == Keys.Shift;
        ...
        private void chonDeNghiNhapKhoTheoKhoMenu_Click(object sender, EventArgs e)
        {
            try
            {
                if (NotAddEdit) return;
                ...
                {
                    INY_PNKho_Form chon = new INY_PNKho_Form(dateNgayCT.Date.Date, txtMaDVCS.Text, txtMaKh.Text);
                    chon.AcceptSelectEvent += chonNhapTheoKho_AcceptSelectEvent;
                    chon.ShowDialog(this);
                }
                else
                {
        ...
        void chonNhapTheoKho_AcceptSelectEvent(List<IDictionary<string, object>> selectedDataList, ChonEventArgs e)
        {
            try
            {
                txtLoaiCt.Text = e.Loai_ct;
                ...
                foreach (IDictionary<string, object> data in selectedDataList)
                {
                    ...
                    DataTable lodate_data = V6BusinessHelper.GetStockinVitriDatePriority_PNK(ma_vt, ma_kho, _sttRec, dateNgayCT.Date);
