...
namespace V6ControlManager.FormManager.ChungTuManager.TonKho.PhieuNhapKho
{
    public partial class PhieuNhapKhoControl : V6InvoiceControl
    {
        ...
        /// </summary>
        public PhieuNhapKhoControl(string itemId, string sttRec)
        {
            m_itemId = itemId;
            InitializeComponent();
            MyInit();
        ...
        /// </summary>
        /// <returns></returns>
        public SortedDictionary<int, Control> GetDynamicControlsAlct(string mact4)
        {
        ...
        void SoLuong1_V6LostFocus(object sender)
        {
            ...
            {
                this.ShowErrorMessage(GetType() + ".SoLuong1_V6LostFocus" + ex.Message);
            }
        }
        ...
        private void XuLyLayThongTinKhiChonMaVt()
        {
            try
            {
                ...
                if (_Ma_nx_i.Text == "")
                {
                    _Ma_nx_i.Text = Invoice.Alct.Rows[0]["TK_CO"].ToString().Trim();
                }
        ...
        private void TinhTienVon()
        {
            ...
            {
                this.ShowErrorException(GetType() + ".TinhTienVon", ex);
            }
        }
        ...
        private void TinhTongValues()
        {
            ...
            var tTienNt = TinhTong("TIEN_NT0");
            txtTongTienNt.Value = tTienNt;
            var tTien = TinhTong("TIEN0");
        ...
        protected override void ShowParentMessage(string message)
        {
            try
            {
                ...
                for (int i = 0; i < 5; i++)
                {
                    ...
                    if (parent is PhieuNhapKhoContainer)
                    {
                        ((PhieuNhapKhoContainer)parent)
                            .ShowMessage(message);
                        return;
                    }
                    else
