...
{
    public partial class LocThongTinPhieuNhapKho : UserControl
    {
        public LocThongTinPhieuNhapKho()
        {
            InitializeComponent();
            MyInit();
        }
        ...
        private void LocThongTinPhieuNhapKho_VisibleChanged(object sender, EventArgs e)
        {
            txtMaDVCS.Text = V6Login.Madvcs;
        }
    }
