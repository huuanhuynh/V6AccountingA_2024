...
namespace V6ControlManager.FormManager.ChungTuManager.TonKho.PhieuXuatKho.ChonPhieuNhapKhau
{
    public partial class POB_PXK_Form : V6Form
    {
        ...
        public POB_PXK_Form(DateTime ngayCt, string ma_dvcs, string ma_kh)
        {
            InitializeComponent();
        ...
        private void MyInit()
        {
            try
            {
                ...
                LoadDefaultData(4, "IXA", "SEARCH_IXA_POB", ItemID);
        ...
        private void InitLocKetQua()
        {
            try
            {
                _locKetQua = new POB_PXK_KetQua(Invoice)
        ...
        private void DoSearch()
        {
            try
            {
                tAM = Invoice.SearchPhieuNhapKhau_PXK(_ngayCt, _where0Time, _where1AM, _where2AD, _w3NhomVt, _w4Dvcs, _w4Dvcs_2, _advance, out _loai_ct_chon);
