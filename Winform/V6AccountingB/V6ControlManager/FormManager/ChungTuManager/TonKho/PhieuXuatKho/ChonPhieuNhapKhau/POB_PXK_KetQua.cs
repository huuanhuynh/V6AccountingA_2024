...
{
    public partial class POB_PXK_KetQua : LocKetQuaBase
    {
        public POB_PXK_KetQua()
        {
            InitializeComponent();
        }

        public POB_PXK_KetQua(V6InvoiceBase invoice)
        {
            _invoice = invoice;
            InitializeComponent();
            MyInit();
        ...
        private void MyInit()
        {
            try
            {
                _aldmConfig = ConfigManager.GetAldmConfig("AMAD84M");
