...
{
    public partial class LocKetQuaPhieuXuatKho : LocKetQuaBase
    {
        public LocKetQuaPhieuXuatKho()
        {
            InitializeComponent();
        }
        
        public LocKetQuaPhieuXuatKho(V6InvoiceBase invoice, DataTable AM, DataTable AD)
        {
            InitializeComponent();
            _invoice = invoice;
