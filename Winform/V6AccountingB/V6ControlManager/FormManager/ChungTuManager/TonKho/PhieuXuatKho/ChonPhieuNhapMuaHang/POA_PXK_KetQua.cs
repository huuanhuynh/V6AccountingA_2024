...
{
    public partial class POA_PXK_KetQua : LocKetQuaBase
    {
        public POA_PXK_KetQua()
        {
            InitializeComponent();
        }

        public POA_PXK_KetQua(V6InvoiceBase invoice)
        {
            _invoice = invoice;
            InitializeComponent();
            MyInit();
        ...
        private void MyInit()
        {
            try
            {
                _aldmConfig = ConfigManager.GetAldmConfig("AMAD84L");
