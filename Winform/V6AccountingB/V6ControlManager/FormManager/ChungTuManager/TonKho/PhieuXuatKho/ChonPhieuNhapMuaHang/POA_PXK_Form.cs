...
namespace V6ControlManager.FormManager.ChungTuManager.TonKho.PhieuXuatKho.ChonPhieuNhapMuaHang
{
    public partial class POA_PXK_Form : V6Form
    {
        ...
        public POA_PXK_Form(DateTime ngayCt, string ma_dvcs, string ma_kh)
        {
            InitializeComponent();
        ...
        private void MyInit()
        {
            try
            {
                ...
                date1.SetValue(V6Setting.M_ngay_ct1);
                date2.SetValue(V6Setting.M_ngay_ct2);

                LoadDefaultData(4, "IXA", "SEARCH_IXA_POA", ItemID);
        ...
        private void InitLocKetQua()
        {
            try
            {
                _locKetQua = new POA_PXK_KetQua(Invoice)
        ...
        private void DoSearch()
        {
            try
            {
                tAM = Invoice.SearchPhieuNhapMua_PXK(_ngayCt, _where0Time, _where1AM, _where2AD, _w3NhomVt, _w4Dvcs, _w4Dvcs_2, _advance, out _loai_ct_chon);
        ...
        {
            V6Setting.M_ngay_ct1 = date1.Date;
            V6Setting.M_ngay_ct2 = date2.Date;
        ...
        private void Form_Load(object sender, EventArgs e)
        {
            try
            {
                lbtMaKH.R_DataType2 = "POA_IXA";
                //lbtMaKH.R_Value2 = ObjectAndString.ObjectToString(date1.Date, "yyyyMMdd") + ";" + ObjectAndString.ObjectToString(date2.Date, "yyyyMMdd");
        ...
        private void date1_ValueChanged(object sender, EventArgs e)
        {
            ...
            {
                this.WriteExLog(GetType() + ".date1_ValueChanged", ex);
            }
        }
        ...
        private void date2_ValueChanged(object sender, EventArgs e)
        {
            ...
            {
                this.WriteExLog(GetType() + ".date2_ValueChanged", ex);
            }
        }
    }
}
