...
{
    public partial class LocKetQua_DeNghiNhapKhoINY : LocKetQuaBase
    {
        public LocKetQua_DeNghiNhapKhoINY()
        {
            InitializeComponent();
        }
        
        public LocKetQua_DeNghiNhapKhoINY(V6InvoiceBase invoice, DataTable AM, DataTable AD)
        {
            InitializeComponent();
            _invoice = invoice;
