...
{
    public partial class INT_to_INY_KetQua : LocKetQuaBase
    {
        public INT_to_INY_KetQua()
        {
            InitializeComponent();
        }
        public INT_to_INY_KetQua(V6InvoiceBase invoice)
        {
            InitializeComponent();
            _invoice = invoice;
        ...
        private void MyInit()
        {
            try
            {
                _aldmConfig = ConfigManager.GetAldmConfig("AMAD92A");
