...
{
    public partial class INT_to_INY_Form : V6Form
    {
        //private readonly PhieuNhapMuaControl _PhieuNhapMuaForm;
        private INT_to_INY_KetQua _locKetQua;
        V6Invoice97INT Invoice = new V6Invoice97INT();
        ...
        public INT_to_INY_Form()
        {
            InitializeComponent();
        }

        public INT_to_INY_Form(DateTime ngayCt, string ma_dvcs, string ma_kh)
        {
            InitializeComponent();
            _ngayCt = ngayCt;
        ...
        private void InitLocKetQua()
        {
            try
            {
                _locKetQua = new INT_to_INY_KetQua(Invoice)
        ...
        private void DoSearch()
        {
            try
            {
                tAM = Invoice.SearchDonHangDD_INY(_ngayCt, _where0Time, _where1AM, _where2AD, _w3NhomVt, _w4Dvcs, _w4Dvcs_2, _advance, out _loai_ct_chon);
        ...
        private void INT_to_INY_Form_Load(object sender, EventArgs e)
        {
            HideLocKetQua();
            InvokeFormEvent(FormDynamicEvent.INIT2);
        }

        private void INT_to_INY_Form_VisibleChanged(object sender, EventArgs e)
        {
            txtMaDVCS.Text = V6Login.Madvcs;
