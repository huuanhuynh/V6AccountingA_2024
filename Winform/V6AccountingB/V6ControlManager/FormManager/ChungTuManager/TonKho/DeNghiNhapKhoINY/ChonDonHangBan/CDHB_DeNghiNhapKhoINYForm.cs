...
{
    public partial class CDHB_DeNghiNhapKhoINYForm : V6Form
    {
        V6Invoice91 Invoice = new V6Invoice91();
        //private readonly HoaDonControl _PhieuNhapMuaForm;
        private CDHB_DeNghiNhapKhoINYKetQua _locKetQua;
        ...
        public CDHB_DeNghiNhapKhoINYForm()
        {
            InitializeComponent();
        }

        public CDHB_DeNghiNhapKhoINYForm(DateTime ngayCt, string ma_dvcs, string ma_kh)
        {
            InitializeComponent();
        ...
        private void InitLocKetQua()
        {
            try
            {
                _locKetQua = new CDHB_DeNghiNhapKhoINYKetQua(Invoice)
        ...
        private void DoSearch()
        {
            try
            {
                tAM = Invoice.SearchDonHangBanAll(_ngayCt, _where0Time, _where1AM, _where2AD, _w3NhomVt, _w4Dvcs, _advance, out _loai_ct_chon);
