...
namespace V6ControlManager.FormManager.ChungTuManager.TonKho.PhieuXuatDieuChuyen.Loc
{
    public partial class TimPhieuXuatDieuChuyenForm : V6Form
    {
        ...
        public LocKetQuaPhieuXuatDieuChuyen _locKetQua;
        ...
        public TimPhieuXuatDieuChuyenForm(V6Invoice85 invoice, V6Mode mode)
        {
            InitializeComponent();
            _mode = mode;
            _invoice = invoice;
        ...
        private void InitLocKetQua()
        {
            try
            {
                _locKetQua = new LocKetQuaPhieuXuatDieuChuyen(_invoice, _formChungTu_AM, _formChungTu_AD)
