...
namespace V6ControlManager.FormManager.ChungTuManager.TonKho.PhieuXuatDieuChuyen.Loc
{
    public partial class TimPhieuXuatDieuChuyenForm : V6Form
    {
        ...
        public TimPhieuXuatDieuChuyenForm()
        {
            InitializeComponent();
        }

        public TimPhieuXuatDieuChuyenForm(PhieuXuatDieuChuyenControl formChungTu)
        {
            InitializeComponent();
        ...
        private void MyInit()
        {
            ...
            LoadDefaultData(4, "IXB", "SEARCH_IXB", ItemID);
            Ready();
        }
        ...
        private void InitLocKetQua()
        {
            try
            {
                _locKetQua = new LocKetQuaPhieuXuatDieuChuyen(_formChungTu.Invoice, _formChungTu.AM, _formChungTu.AD)
        ...
        private void InitTuyChon()
        {
            ...
            chkNSD.Checked = new V6Invoice85().M_LOC_NSD;
        ...
        private void TimPhieuXuatDieuChuyenForm_Load(object sender, EventArgs e)
        {
        ...
        private void TimPhieuXuatDieuChuyenForm_Activated(object sender, EventArgs e)
        {
            locThoiGian1.Focus();
        }

        private void TimPhieuXuatDieuChuyenForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            e.Cancel = true;
            Hide();
        }
