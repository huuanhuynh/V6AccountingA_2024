...
namespace V6ControlManager.FormManager.ChungTuManager.TonKho.PhieuXuatDieuChuyen.ChonDeNghiXuat
{
    public partial class IXY_PXDC_Form : V6Form
    {
        ...
        public IXY_PXDC_Form()
        {
            InitializeComponent();
        }

        public IXY_PXDC_Form(DateTime ngayCt, string ma_dvcs, string ma_kh)
        {
            InitializeComponent();
        ...
        private void InitLocKetQua()
        {
            try
            {
                _locKetQua = new IXY_PXDC_KetQua(Invoice)
        ...
        private void DoSearch()
        {
            try
            {
                tAM = Invoice.SearchDeNghiXuat_PXDC(_ngayCt, _where0Time, _where1AM, _where2AD, _w3NhomVt, _w4Dvcs, _w4Dvcs_2, _advance, out _loai_ct_chon);
