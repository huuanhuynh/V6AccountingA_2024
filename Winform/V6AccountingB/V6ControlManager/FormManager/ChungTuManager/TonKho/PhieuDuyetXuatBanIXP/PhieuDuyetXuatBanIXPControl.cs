    ...
    public partial class PhieuDuyetXuatBanIXPControl : V6InvoiceControl
    {
            ...
            try
            {
                if (IsViewingAnInvoice)
                {
                    if (V6Login.UserRight.AllowPrint("", Invoice.CodeMact))
                    {
                        ...
                        c.PrintSuccess += (sender, stt_rec, PhieuDuyetXuatBanIXP_nd51) =>
                        {
                            if (PhieuDuyetXuatBanIXP_nd51 == 1)
                            {
        ...
        private void Xem()
        {
            try
            {
                if (IsHaveInvoice)
                {
                    if (_timForm == null) _timForm = new TimPhieuDuyetXuatBanIXPForm(this);
        ...
        private void Tim()
        {
            try
            {
                if (V6Login.UserRight.AllowView("", Invoice.CodeMact))
                {
                    ...
                    if (_timForm == null)
                        _timForm = new TimPhieuDuyetXuatBanIXPForm(this);
        ...
        private void PhieuDuyetXuatBanIXPDetail1_ClickAdd(object sender)
        {
            XuLyDetailClickAdd();
        }
        ...
        private void PhieuDuyetXuatBanIXPDetail1_ClickDelete(object sender)
        {
            XuLyXoaDetail();
        }
        private void PhieuDuyetXuatBanIXPDetail1_ClickCancelEdit(object sender)
        {
            dataGridView1.UnLock();
        ...
        private void PhieuDuyetXuatBanIXPDetail1_ClickEdit(object sender)
        {
            try
            {
        ...
        {
            FixMenuChucNangItemShiftText(chonDonHangBanMenu, chonBaoGiaMenu, chonTuExcelMenu, chonDonHangMuaMenu, ChonViTriDuyetMenu);
        }
