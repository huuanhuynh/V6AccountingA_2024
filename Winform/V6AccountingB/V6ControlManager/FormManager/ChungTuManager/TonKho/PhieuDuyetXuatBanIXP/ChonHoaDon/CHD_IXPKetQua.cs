...
{
    public partial class CHD_IXPKetQua : LocKetQuaBase
    {
        public CHD_IXPKetQua()
        {
            InitializeComponent();
        }

        public CHD_IXPKetQua(V6InvoiceBase invoice)
        {
            InitializeComponent();
            _invoice = invoice;
            MyInit();
        ...
        private void MyInit()
        {
            try
            {
                _aldmConfig = ConfigManager.GetAldmConfig("AMAD81L");
