...
namespace V6ControlManager.FormManager.ChungTuManager.TonKho.PhieuDuyetXuatBanIXP.ChonHoaDon
{
    public partial class CHD_IXPForm : V6Form
    {
        ...
        public CHD_IXPForm(DateTime ngayCt, string ma_dvcs, string ma_kh)
        {
            InitializeComponent();
        ...
        private void InitLocKetQua()
        {
            try
            {
                _locKetQua = new CHD_IXPKetQua(Invoice)
        ...
        private void DoSearch()
        {
            try
            {
                tAM = Invoice.SearchHoaDon_IXP(_ngayCt, _where0Time, _where1AM, _where2AD, _w3NhomVt, _w4Dvcs, _w4Dvcs_2, _advance, out _loai_ct_chon);
