...
{
    public partial class CDHB_IXPKetQua : LocKetQuaBase
    {
        public CDHB_IXPKetQua()
        {
            InitializeComponent();
        }

        public CDHB_IXPKetQua(V6InvoiceBase invoice)
        {
            InitializeComponent();
            _invoice = invoice;
            MyInit();
        ...
        private void MyInit()
        {
            try
            {
                _aldmConfig = ConfigManager.GetAldmConfig("AMAD91D");
