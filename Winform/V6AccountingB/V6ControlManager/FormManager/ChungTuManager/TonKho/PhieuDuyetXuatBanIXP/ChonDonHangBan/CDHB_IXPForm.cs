...
namespace V6ControlManager.FormManager.ChungTuManager.TonKho.PhieuDuyetXuatBanIXP.ChonDonHangBan
{
    public partial class CDHB_IXPForm : V6Form
    {
        ...
        public CDHB_IXPForm(DateTime ngayCt, string ma_dvcs, string ma_kh)
        {
            InitializeComponent();
        ...
        private void MyInit()
        {
            try
            {
                ...
                LoadDefaultData(4, "IXP", "SEARCH_IXP_SOH", ItemID);
        ...
        private void InitLocKetQua()
        {
            try
            {
                _locKetQua = new CDHB_IXPKetQua(Invoice)
        ...
        private void DoSearch()
        {
            try
            {
                tAM = Invoice.SearchDonHang_IXY(_ngayCt, _where0Time, _where1AM, _where2AD, _w3NhomVt, _w4Dvcs, _w4Dvcs_2, _advance, out _loai_ct_chon);
