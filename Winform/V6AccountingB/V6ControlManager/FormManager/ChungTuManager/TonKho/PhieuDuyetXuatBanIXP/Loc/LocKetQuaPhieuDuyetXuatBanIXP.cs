...
{
    public partial class LocKetQuaPhieuDuyetXuatBanIXP : LocKetQuaBase
    {
        public LocKetQuaPhieuDuyetXuatBanIXP()
        {
            InitializeComponent();
        }
        
        public LocKetQuaPhieuDuyetXuatBanIXP(V6InvoiceBase invoice, DataTable AM, DataTable AD)
        {
            InitializeComponent();
            _invoice = invoice;
