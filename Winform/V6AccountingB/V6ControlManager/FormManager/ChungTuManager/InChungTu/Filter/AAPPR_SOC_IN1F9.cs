...
{
    public partial class AAPPR_SOC_IN1F9 : InChungTuFilterBase
    {
        public AAPPR_SOC_IN1F9()
        {
            InitializeComponent();
            ...
            SetFieldValueEvent += ASOCTSOC_SetFieldValueEvent;

            SetHideFields("V");
        }

        void ASOCTSOC_SetFieldValueEvent(string sttrec)
        {
