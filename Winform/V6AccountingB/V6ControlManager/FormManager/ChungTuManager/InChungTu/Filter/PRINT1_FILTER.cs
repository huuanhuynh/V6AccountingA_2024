...
{
    public partial class PRINT1_FILTER : InChungTuFilterBase
    {
        public PRINT1_FILTER()
        {
            InitializeComponent();
            ...
            SetFieldValueEvent += PRINT1_FILTER_SetFieldValueEvent;

            SetHideFields("V");
        }

        void PRINT1_FILTER_SetFieldValueEvent(string sttrec)
        {
