...
{
    public partial class PRINT_FILTER : InChungTuFilterBase
    {
        public PRINT_FILTER()
        {
            InitializeComponent();
            ...
            SetFieldValueEvent += PRINT_FILTER_SetFieldValueEvent;

            SetHideFields("V");
        }

        void PRINT_FILTER_SetFieldValueEvent(string sttrec)
        {
