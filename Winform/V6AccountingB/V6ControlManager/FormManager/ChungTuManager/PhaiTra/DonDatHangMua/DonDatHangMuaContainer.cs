...
{
    public partial class DonDatHangMuaContainer : V6Control
    {
        private Timer _timerHideMessage;
        private int _timeCount;
        private int currentTabIndex = -1;
        public DonDatHangMuaContainer()
        {
        ...
        public DonDatHangMuaContainer(string itemId)
        {
            m_itemId = itemId;
            V6Invoice92 invoice = new V6Invoice92();
            if (invoice.Alct == null || invoice.Alct.Rows.Count == 0)
        ...
        private void AddTab()
        {
            try
            {
                var hoadon = new DonDatHangMuaControl(m_itemId){ Dock = DockStyle.Fill };
            ...
            {
                this.ShowErrorMessage(GetType() + ".AddTab: " +ex.Message, "DonDatHangMua");
            }
        }
