...
{
    public partial class CDHB_DonDatHangMuaKetQua : LocKetQuaBase
    {
        public CDHB_DonDatHangMuaKetQua()
        {
            InitializeComponent();
        }

        public CDHB_DonDatHangMuaKetQua(V6InvoiceBase invoice)
        {
            InitializeComponent();
            _invoice = invoice;
            MyInit();
        ...
        private void MyInit()
        {
            try
            {
                _aldmConfig = ConfigManager.GetAldmConfig("AMAD91B");
