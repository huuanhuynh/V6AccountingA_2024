...
{
    public partial class DonDatHangMuaControl : V6InvoiceControl
    {
        #region ==== Properties and Fields
        // ReSharper disable once InconsistentNaming
        public V6Invoice92 Invoice = new V6Invoice92();
        
        #endregion properties and fields

        #region ==== Contructor và Khởi tạo ====
        public DonDatHangMuaControl()
        {
            InitializeComponent();
            MyInit();
        }
        public DonDatHangMuaControl(string itemId)
        {
            m_itemId = itemId;
            InitializeComponent();
            MyInit();
        ...
        public DonDatHangMuaControl(string maCt, string itemId, string sttRec)
            : base(new V6Invoice92(), itemId)
        {
            m_itemId = itemId;
            InitializeComponent();
            MyInit();
        ...
        private V6VvarTextBox _maVt, _Ma_lnx_i, _dvt1, _maKho, _maKhoI, _tkVt, _maLo, _ma_thue_i, txtPMA_KHC;
        private V6NumberTextBox _gia_nt, _gia_nt01, _tien0, _tien_nt0, _gia0, _gia01, _gia, _gia_Nt0,
            _ck, _ckNt, _pt_cki, _thue, _thue_nt, _thue_suat_i;
        private V6NumberTextBox _soLuong1, _soLuong, _he_so1T, _he_so1M, _ton13, _ton13s, _ton13Qd, _tienNt, _tien, _mau_bc22, _sl_td1;
        ...
        private TimDonDatHangMuaForm SearchForm
        {
            get
            {
                if (_timForm == null || _timForm.IsDisposed)
                    _timForm = new TimDonDatHangMuaForm(Invoice, V6Mode.View);
                return _timForm;
            }
        }
        private TimDonDatHangMuaForm _timForm;
        private void Xem()
        {
            try
            {
        ...
        private void ChucNang_ChonDonHangBan(bool add = false)
        {
            try
            {
                ...
                if ( ma_dvcs != "")
                {
                    CDHB_DonDatHangMuaForm chon = new CDHB_DonDatHangMuaForm(dateNgayCT.Date, txtMaDVCS.Text, "");
                    _chon_px = "SOH";
        ...
        {
            FixMenuChucNangItemShiftText(chonDonHangMuaMenu, chonTuExcelMenu, importXmlMenu);
        }
