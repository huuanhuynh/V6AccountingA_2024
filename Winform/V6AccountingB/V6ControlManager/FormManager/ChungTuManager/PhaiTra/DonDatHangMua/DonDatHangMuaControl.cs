...
namespace V6ControlManager.FormManager.ChungTuManager.PhaiTra.DonDatHangMua
{
    public partial class DonDatHangMuaControl : V6InvoiceControl
    {
        ...
        private void TinhGiaNt()
        {
            ...
            {
                this.ShowErrorMessage(GetType() + ".TTinhGiaNt: " + ex.Message);
            }
        }
               #endregion methods
        ...
        private void Xem()
        {
            try
            {
                if (IsHaveInvoice)
                {
                    if (_timForm == null) _timForm = new TimDonDatHangMuaForm(this);
        ...
        private void Tim()
        {
            try
            {
                if (V6Login.UserRight.AllowView("", Invoice.CodeMact))
                {
                    ...
                    if (_timForm == null)
                        _timForm = new TimDonDatHangMuaForm(this);
        ...
        private void XuLyDetailClickAdd(object sender)
        {
            ...
            {
                this.ShowErrorMessage(GetType() + ".XuLyDetailClickMoi: " + ex.Message);
            }
        }
        ...
        private void chkSuaTienThue_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                this.ShowErrorMessage(GetType() + ".chkSuaTienThue_CheckedChanged: " + ex.Message);
            }
        }
        ...
        private void cboLoai_pb_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if(cboLoai_pb.Tag == null) TinhPhanBoChiPhi(loai_pb);
        ...
        private void TinhPhanBoChiPhi(string loai_pb)
        {
            ...
            {
                this.ShowErrorMessage(GetType() + ".TinhPhanBoChiPhi: " + ex.Message);
            }
        }
        ...
        private void TinhT_CpNt()
        {
            ...
            {
                this.ShowErrorMessage(GetType() + ".TinhT_CpNt: " + ex.Message);
            }
        }
