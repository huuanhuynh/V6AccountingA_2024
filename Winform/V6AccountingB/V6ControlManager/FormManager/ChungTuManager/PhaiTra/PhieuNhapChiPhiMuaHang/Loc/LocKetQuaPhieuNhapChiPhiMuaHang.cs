...
{
    public partial class LocKetQuaPhieuNhapChiPhiMuaHang : LocKetQuaBase
    {
        public LocKetQuaPhieuNhapChiPhiMuaHang()
        {
            InitializeComponent();
            dataGridView1.DataSourceChanged += dataGridView1_DataSourceChanged;
        }
        
        public LocKetQuaPhieuNhapChiPhiMuaHang(V6InvoiceBase invoice, DataTable AM, DataTable AD)
        {
            InitializeComponent();
            _invoice = invoice;
            dataGridView1.DataSourceChanged += dataGridView1_DataSourceChanged;
