...
{
    public partial class PhieuNhapChiPhiMuaHangContainer : V6Control
    {
        private Timer _timerHideMessage;
        private int _timeCount;
        private int currentTabIndex = -1;
        public PhieuNhapChiPhiMuaHangContainer()
        {
            V6Invoice73 invoice = new V6Invoice73();
        ...
        public PhieuNhapChiPhiMuaHangContainer(string itemId)
        {
            m_itemId = itemId;
            V6Invoice73 invoice = new V6Invoice73();
            if (invoice.Alct == null || invoice.Alct.Rows.Count == 0)
        ...
        private void AddTab()
        {
            try
            {
                var hoadon = new PhieuNhapChiPhiMuaHangControl(m_itemId){ Dock = DockStyle.Fill };
            ...
            {
                this.ShowErrorMessage(GetType() + ".POC AddTab: " +ex.Message, "PhieuNhapChiPhi");
            }
        }
