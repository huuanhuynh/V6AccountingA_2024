...
namespace V6ControlManager.FormManager.ChungTuManager.PhaiTra.PhieuNhapChiPhiMuaHang
{
    public partial class PhieuNhapChiPhiMuaHangControl : V6InvoiceControl
    {
        ...
        private void XuLyThayDoiMaNt()
        {
            try
            {
                ...
                if (_maNt.ToUpper() != _mMaNt0.ToUpper())
                {
                    ...
                    if (!V6Login.IsAdmin && alctct_GRD_HIDE.Contains("TIEN0"))
                    {
        ...
        protected override void ShowParentMessage(string message)
        {
            try
            {
                ...
                for (int i = 0; i < 5; i++)
                {
                    ...
                    if (parent is PhieuNhapChiPhiMuaHangContainer)
                    {
                        ((PhieuNhapChiPhiMuaHangContainer)parent)
                            .ShowMessage(message);
                        return;
                    }
                    else
        ...
        private void chkSua_Tien_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                dataGridView3ChiPhi.SetEditColumn(chkSua_Tien.Checked ? "CP,CP_NT".Split(',') : "CP_NT".Split(','));
            }
        }
        ...
        private void dataGridView3_CellBeginEdit(object sender, DataGridViewCellCancelEventArgs e)
        {
            ...
            {
                this.WriteExLog(GetType() + ".dataGridView3_CellBeginEdit", ex);
            }
        }
        ...
        private void dataGridView3_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                this.WriteExLog(GetType() + ".dataGridView3_CellEndEdit", ex);
            }
        }
