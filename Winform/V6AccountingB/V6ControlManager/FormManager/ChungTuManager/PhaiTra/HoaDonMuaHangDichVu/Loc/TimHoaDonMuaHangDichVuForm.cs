...
namespace V6ControlManager.FormManager.ChungTuManager.PhaiTra.HoaDonMuaHangDichVu.Loc
{
    public partial class TimHoaDonMuaHangDichVuForm : V6Form
    {
        ...
        private readonly V6Invoice31 _invoice;

        public LocKetQuaHoaDonMuaHangDichVu _locKetQua;
        ...
        public TimHoaDonMuaHangDichVuForm(V6Invoice31 invoice, V6Mode mode)
        {
            InitializeComponent();
            _mode = mode;
            _invoice = invoice;
        ...
        private void InitLocKetQua()
        {
            try
            {
                _locKetQua = new LocKetQuaHoaDonMuaHangDichVu(_invoice, _formChungTu_AM, _formChungTu_AD)
                {
                    Dock = DockStyle.Fill,
                    Visible = false
                };
