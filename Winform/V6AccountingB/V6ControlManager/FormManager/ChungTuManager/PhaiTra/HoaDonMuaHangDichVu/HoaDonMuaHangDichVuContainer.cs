...
{
    public partial class HoaDonMuaHangDichVuContainer : V6Control
    {
        private Timer _timerHideMessage;
        private int _timeCount;
        private int currentTabIndex = -1;
        public HoaDonMuaHangDichVuContainer()
        {
        ...
        public HoaDonMuaHangDichVuContainer(string itemId)
        {
            m_itemId = itemId;
            V6Invoice31 invoice = new V6Invoice31();
            if (invoice.Alct == null || invoice.Alct.Rows.Count == 0)
        ...
        private void AddTab()
        {
            try
            {
                var hoadon = new HoaDonMuaHangDichVuControl(m_itemId){ Dock = DockStyle.Fill };
            ...
            {
                this.ShowErrorMessage(GetType() + ".AddTab: " +ex.Message, "HoaDonMuaHangDichVu");
            }
        }
