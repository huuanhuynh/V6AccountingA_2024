...
namespace V6ControlManager.FormManager.ChungTuManager.PhaiTra.PhieuThanhToanTamUng.Loc
{
    public partial class TimPhieuThanhToanTamUngForm : V6Form
    {
        ...
        public LocKetQuaPhieuThanhToanTamUng _locKetQua;
        ...
        public TimPhieuThanhToanTamUngForm(V6Invoice32 invoice, V6Mode mode)
        {
            InitializeComponent();
            _mode = mode;
            _invoice = invoice;
        ...
        private void InitLocKetQua()
        {
            try
            {
                _locKetQua = new LocKetQuaPhieuThanhToanTamUng(_invoice, _formChungTu_AM, _formChungTu_AD)
                {
                    Dock = DockStyle.Fill,
                    Visible = false
                };
