...
{
    public partial class TimPhieuThanhToanTamUngForm : V6Form
    {
        private readonly PhieuThanhToanTamUngControl _formChungTu;
        private readonly V6Invoice32 _invoice;
        private LocKetQuaPhieuThanhToanTamUng _locKetQua;
        ...
        public TimPhieuThanhToanTamUngForm()
        {
            InitializeComponent();
        }

        public TimPhieuThanhToanTamUngForm(PhieuThanhToanTamUngControl formChungTu)
        {
            InitializeComponent();
        ...
        private void InitLocKetQua()
        {
            try
            {
                _locKetQua = new LocKetQuaPhieuThanhToanTamUng(_invoice, _formChungTu.AM, _formChungTu.AD)
                {
                    Dock = DockStyle.Fill,
                    Visible = false
                };
        ...
        private void TimPhieuThanhToanTamUngForm_Activated(object sender, EventArgs e)
        {
            locThoiGian1.Focus();
        }

        private void TimPhieuThanhToanTamUngForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            e.Cancel = true;
            Hide();
        }
