    ...
    public partial class PhieuThanhToanTamUngControl : V6InvoiceControl
    {
        ...
        public override void EnableVisibleControls()
        {
            try
            {
                ...
                //Cac truong hop khac
                if (IsViewingAnInvoice && Mode == V6Mode.View) chonPCMenu.Enabled = true;
                else chonPCMenu.Enabled = false;
                if (!readOnly)
                {
        ...
        private void ChucNang_ChonTuExcel(bool add)
        {
            try
            {
                ...
                chonExcel.CheckFields = "TK_VT,TIEN_NT";
        ...
        void chonExcel_LoadDataComplete(object sender)
        {
            try
            {
                ...
                {
                    string cMaVt = ("" + row.Cells["TK_VT"].Value).Trim();
