...
namespace V6ControlManager.FormManager.ChungTuManager.PhaiTra.PhieuNhapKhau.ChonDeNghiNhap
{
    public partial class INY_PNKhau_Form : V6Form
    {
        ...
        public INY_PNKhau_Form()
        {
            InitializeComponent();
        }

        public INY_PNKhau_Form(DateTime ngayCt, string ma_dvcs, string ma_kh)
        {
            InitializeComponent();
        ...
        private void InitLocKetQua()
        {
            try
            {
                _locKetQua = new INY_PNKhau_KetQua(Invoice)
        ...
        private void DoSearch()
        {
            try
            {
                tAM = Invoice.SearchDeNghiNhap_PNKhau(_ngayCt, _where0Time, _where1AM, _where2AD, _w3NhomVt, _w4Dvcs, _w4Dvcs_2, _advance, out _loai_ct_chon);
