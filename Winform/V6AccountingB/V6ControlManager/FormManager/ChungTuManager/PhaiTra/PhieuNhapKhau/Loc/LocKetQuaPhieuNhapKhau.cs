...
{
    public partial class LocKetQuaPhieuNhapKhau : LocKetQuaBase
    {
        public LocKetQuaPhieuNhapKhau()
        {
            InitializeComponent();
        }
        
        public LocKetQuaPhieuNhapKhau(V6InvoiceBase invoice, DataTable AM, DataTable AD)
        {
            InitializeComponent();
            _invoice = invoice;
