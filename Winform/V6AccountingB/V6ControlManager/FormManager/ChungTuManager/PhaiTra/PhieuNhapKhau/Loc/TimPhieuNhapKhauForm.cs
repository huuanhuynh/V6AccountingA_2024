...
namespace V6ControlManager.FormManager.ChungTuManager.PhaiTra.PhieuNhapKhau.Loc
{
    ...
    {
        private readonly PhieuNhapKhauControl _formChungTu;
        private LocKetQuaPhieuNhapKhau _locKetQua;
        ...
        public TimPhieuNhapKhauForm(PhieuNhapKhauControl formChungTu)
        {
            InitializeComponent();
        ...
        private void InitLocKetQua()
        {
            try
            {
                _locKetQua = new LocKetQuaPhieuNhapKhau(_formChungTu.Invoice, _formChungTu.AM, _formChungTu.AD)
        ...
        {
            if (ViewMode && _formChungTu.AM != null)
            {
                ShowLocKetQua();
            }
            else
