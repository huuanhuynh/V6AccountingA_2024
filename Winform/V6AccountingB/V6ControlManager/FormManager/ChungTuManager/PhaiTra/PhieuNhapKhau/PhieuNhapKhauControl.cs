...
namespace V6ControlManager.FormManager.ChungTuManager.PhaiTra.PhieuNhapKhau
{
    public partial class PhieuNhapKhauControl : V6InvoiceControl
    {
        ...
        /// </summary>
        public PhieuNhapKhauControl(string itemId, string sttRec)
        {
            m_itemId = itemId;
            InitializeComponent();
            MyInit();
        ...
        //    catch (Exception ex)
        //    {
        //        this.ShowErrorMessage(GetType() + ".TinhTien22: " + ex.Message);
        //    }
        //}
        ...
        private void TinhGiaNt()
        {
            ...
            {
                this.ShowErrorMessage(GetType() + ".Tinh GiaNt0: "+ex.Message);
            }
        }
               #endregion methods
        ...
        private void TinhThueNhapKhau()
        {
            ...
            {
                this.ShowErrorMessage(GetType() + ".TinhThueNhapKhau: " + ex.Message, ex.Source);
            }
        }
        ...
        protected override void ShowParentMessage(string message)
        {
            try
            {
                ...
                for (int i = 0; i < 5; i++)
                {
                    ...
                    if (parent is PhieuNhapKhauContainer)
                    {
                        ((PhieuNhapKhauContainer)parent)
                            .ShowMessage(message);
                        return;
                    }
                    else
        ...
        void checkEdit_Tick(object sender, EventArgs e)
        {
            if (flagEditFinish)
            {
                ...
                //V6ControlFormHelper.ShowInfoMessage(wm);//!!test
            }
        }
        ...
        private void XoaPhanBoChiPhi()
        {
            ...
            {
                this.ShowErrorMessage(GetType() + ".XoaPhanBoChiPhi: " + ex.Message, ex.Source);
            }
        }
        ...
        private void ChucNang_ChonDonHang()
        {
            ...
            {
                this.ShowErrorMessage(GetType() + ".ChucNang ChonDonHang: " + ex.Message, "PhieuNhapMua Error");
            }
        }
