...
namespace V6ControlManager.FormManager.ChungTuManager.PhaiTra.PhieuNhapKhau.ChonDonHang
{
    public partial class CDH_PNKForm : V6Form
    {
        ...
        private void InitLocKetQua()
        {
            try
            {
                _locKetQua = new CDH_PNKKetQua(Invoice)
        ...
        private void DoSearch()
        {
            try
            {
                tAM = Invoice.SearchDonHang(_ngayCt, _where0Time, _where1AM, _where2AD, _w3NhomVt, _w4Dvcs, _w4Dvcs_2, _advance, out _loai_ct_chon);
