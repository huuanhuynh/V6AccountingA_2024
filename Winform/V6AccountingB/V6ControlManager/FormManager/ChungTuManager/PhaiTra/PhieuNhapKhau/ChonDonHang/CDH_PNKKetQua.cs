...
{
    public partial class CDH_PNKKetQua : LocKetQuaBase
    {
        public CDH_PNKKetQua()
        {
            InitializeComponent();
        }
        public CDH_PNKKetQua(V6InvoiceBase invoice)
        {
            InitializeComponent();
            _invoice = invoice;
            MyInit();
        ...
        private void MyInit()
        {
            try
            {
                _aldmConfig = ConfigManager.GetAldmConfig("AMAD92B");
