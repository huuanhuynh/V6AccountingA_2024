...
namespace V6ControlManager.FormManager.ChungTuManager.PhaiTra.PhieuXuatTraLaiNCC
{
    ...
    public partial class PhieuXuatTraLaiNCCControl : V6InvoiceControl
    {
        ...
        /// </summary>
        public PhieuXuatTraLaiNCCControl(string itemId, string sttRec)
        {
            m_itemId = itemId;
            InitializeComponent();
            MyInit();
        ...
        private void XuLyThayDoiMaNt()
        {
            try
            {
                ...
                if (_maNt.ToUpper() != _mMaNt0.ToUpper())
                {
                    ...
                    var c = V6ControlFormHelper.GetControlByAccesibleName(detail1, "GIA1");
        ...
        protected override void ShowParentMessage(string message)
        {
            try
            {
                ...
                for (int i = 0; i < 5; i++)
                {
                    ...
                    if (parent is PhieuXuatTraLaiNCCContainer)
                    {
                        ((PhieuXuatTraLaiNCCContainer)parent)
                            .ShowMessage(message);
                        return;
                    }
                    else
