...
namespace V6ControlManager.FormManager.ChungTuManager.PhaiTra.PhieuXuatTraLaiNCC
{
    ...
    public partial class PhieuXuatTraLaiNCCControl : V6InvoiceControl
    {
        ...
        public V6VvarTextBox _maVt, _Ma_lnx_i, _dvt1, _maKho, _maKhoI, _tkDt, _tkGv, _tkCkI, _tkVt, _maLo, _maViTri;
        public V6ColorTextBox _soKhung, _soMay;
        public V6NumberTextBox _soLuong1, _soLuong, _he_so1T, _he_so1M, _ck, _ckNt, _sl_qd, _sl_qd2, _hs_qd1, _hs_qd2, _sl_td1;
        public V6NumberTextBox _ton13, _ton13Qd, _gia, _gia_nt, _gia_nt1, _gia1, _tien, _tien_nt;
        ...
        private TimPhieuXuatTraLaiNCCForm SearchForm
        {
            get
            {
                if (_timForm == null || _timForm.IsDisposed)
                    _timForm = new TimPhieuXuatTraLaiNCCForm(Invoice, V6Mode.View);
                return _timForm;
            }
        }
        ...
        private void ChucNang_ChonTuExcel(bool add)
        {
            try
            {
                ...
                chonExcel.CheckFields = "MA_VT,MA_KHO_I,SO_LUONG1,GIA_NT1,TIEN_NT";
        ...
        {
            FixMenuChucNangItemShiftText(chonDeNghiXuatMenu, chonTuExcelMenu, importXmlMenu);
        }
