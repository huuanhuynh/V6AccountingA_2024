...
{
    public partial class IXY_IXC86_KetQua : LocKetQuaBase
    {
        public IXY_IXC86_KetQua()
        {
            InitializeComponent();
        }

        public IXY_IXC86_KetQua(V6InvoiceBase invoice)
        {
            _invoice = invoice;
            InitializeComponent();
            MyInit();
        ...
        private void MyInit()
        {
            try
            {
                _aldmConfig = ConfigManager.GetAldmConfig("AMAD95C");
