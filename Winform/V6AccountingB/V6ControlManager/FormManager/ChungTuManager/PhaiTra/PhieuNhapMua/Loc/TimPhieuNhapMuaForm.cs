...
namespace V6ControlManager.FormManager.ChungTuManager.PhaiTra.PhieuNhapMua.Loc
{
    public partial class TimPhieuNhapMuaForm : V6Form
    {
        ...
        private LocKetQuaPhieuNhapMua _locKetQua;
        ...
        public TimPhieuNhapMuaForm()
        {
            InitializeComponent();
        }

        public TimPhieuNhapMuaForm(PhieuNhapMuaControl formChungTu)
        {
            InitializeComponent();
        ...
        private void InitLocKetQua()
        {
            try
            {
                _locKetQua = new LocKetQuaPhieuNhapMua(_formChungTu.Invoice, _formChungTu.AM, _formChungTu.AD)
                {
                    Dock = DockStyle.Fill,
                    Visible = false
                };
        ...
        private void PrepareThread()
        {
            ...
            _where1AM = locThongTin1.GetFilterSql_ThongTin(stru, "", "like");
        ...
        private void TimPhieuNhapMuaForm_VisibleChanged(object sender, EventArgs e)
        {
            txtMaDVCS.Text = V6Login.Madvcs;
        }
    }
