...
namespace V6ControlManager.FormManager.ChungTuManager.PhaiTra.PhieuNhapMua.ChonDeNghiNhap
{
    public partial class INY_PNMua_Form : V6Form
    {
        ...
        public INY_PNMua_Form()
        {
            InitializeComponent();
        }

        public INY_PNMua_Form(DateTime ngayCt, string ma_dvcs, string ma_kh)
        {
            InitializeComponent();
        ...
        private void MyInit()
        {
            ...
            LoadDefaultData(4, "POA", "SEARCH_POA_INY", ItemID);
        }
        ...
        private void InitLocKetQua()
        {
            try
            {
                _locKetQua = new INY_PNMua_KetQua(Invoice)
        ...
        private void DoSearch()
        {
            try
            {
                tAM = Invoice.SearchDeNghiNhap_PNMua(_ngayCt, _where0Time, _where1AM, _where2AD, _w3NhomVt, _w4Dvcs, _w4Dvcs_2, _advance, out _loai_ct_chon);
