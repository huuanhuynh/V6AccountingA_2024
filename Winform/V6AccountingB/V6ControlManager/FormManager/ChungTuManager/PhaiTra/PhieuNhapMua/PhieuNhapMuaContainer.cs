...
{
    public partial class PhieuNhapMuaContainer : V6Control
    {
        private Timer _timerHideMessage;
        private int _timeCount;
        private int currentTabIndex = -1;
        public PhieuNhapMuaContainer()
        {
        ...
        public PhieuNhapMuaContainer(string itemId)
        {
            m_itemId = itemId;
            V6Invoice71 invoice = new V6Invoice71();
            if (invoice.Alct == null || invoice.Alct.Rows.Count == 0)
        ...
        private void AddTab()
        {
            try
            {
                var hoadon = new PhieuNhapMuaControl(m_itemId){ Dock = DockStyle.Fill };
            ...
            {
                this.ShowErrorMessage(GetType() + ".AddTab: " +ex.Message, "PhieuNhapMua");
            }
        }
