...
{
    public partial class CPX_PhieuNhapMuaForm : V6Form
    {
        V6Invoice81 Invoice = new V6Invoice81();
        //private readonly HoaDonControl _PhieuNhapMuaForm;
        private CPX_PhieuNhapMuaKetQua _locKetQua;
        ...
        public CPX_PhieuNhapMuaForm()
        {
            InitializeComponent();
        }

        public CPX_PhieuNhapMuaForm(DateTime ngayCt, string ma_dvcs, string ma_kh)
        {
            InitializeComponent();
        ...
        private void InitLocKetQua()
        {
            try
            {
                _locKetQua = new CPX_PhieuNhapMuaKetQua(Invoice)
        ...
        private void DoSearch()
        {
            try
            {
                tAM = Invoice.SearchHoaDon_PhieuNhapMua(_ngayCt, _where0Time, _where1AM, _where2AD, _w3NhomVt, _w4Dvcs, _w4Dvcs_2, _advance, out _loai_ct_chon);
