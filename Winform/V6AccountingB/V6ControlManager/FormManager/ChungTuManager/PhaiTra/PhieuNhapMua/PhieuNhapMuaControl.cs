...
namespace V6ControlManager.FormManager.ChungTuManager.PhaiTra.PhieuNhapMua
{
    public partial class PhieuNhapMuaControl : V6InvoiceControl
    {
        ...
        private V6NumberTextBox _ton13, _ton13Qd, _tienNt, _tien, _mau_bc22, _thue, _thue_nt, _thue_suat_i;
        ...
        {
            FixMenuChucNangItemShiftText(chonDonHangMuaMenu, chonTuExcelMenu, chonDeNghiNhapMenu);
        }
