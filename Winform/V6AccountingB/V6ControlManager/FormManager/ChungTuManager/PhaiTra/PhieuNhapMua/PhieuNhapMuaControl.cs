...
namespace V6ControlManager.FormManager.ChungTuManager.PhaiTra.PhieuNhapMua
{
    public partial class PhieuNhapMuaControl : V6InvoiceControl
    {
        ...
        /// </summary>
        public PhieuNhapMuaControl(string itemId, string sttRec)
        {
            m_itemId = itemId;
            InitializeComponent();
            MyInit();
        ...
        private V6VvarTextBox _maVt, _dvt1, _maKho, _maKhoI, _tkVt, _maLo, _maVt_excel;
        ...
        private void LoadDetailControls()
        {
            ...
            foreach (KeyValuePair<int, Control> item in dynamicControlList)
            {
                ...
                switch (NAME)
                {
                    ...
                    //    break;
                    case "TIEN_VC_NT":
                        _tien_vcNt = control as V6NumberTextBox;
                        if (_tien_vcNt != null)
                        {
                            _tien_vcNt.V6LostFocus += delegate
                            {
                                TinhTienNt();
                            };
                        }
        ...
        ///// </summary>
        ///// <returns></returns>
        //public SortedDictionary<int, Control> GetDynamicControlsAlct0
        ...
        //                if (fcolumn == "TANG")
        //                {
        //                    result.Add(fOrder, V6ControlFormHelper.CreateLimitTextBox(fcolumn, "x", fcaption, width, fstatus));
        //                }
        ...
        protected override void EnableFormControls()
        {
            try
            {
                ...
                if (!readOnly)
                {
                    ...
                    if (V6Options.V6OptionValues["M_POA_GIAVC_GIAGIAM_CT"] == "2" ||
                        V6Options.V6OptionValues["M_POA_GIAVC_GIAGIAM_CT"] == "3")
                    {
                    ...
                    if (V6Options.V6OptionValues["M_POA_GIAVC_GIAGIAM_CT"] == "1" ||
                       V6Options.V6OptionValues["M_POA_GIAVC_GIAGIAM_CT"] == "3")
                    {
                ...
                if (!V6Login.IsAdmin && alctct_GRD_HIDE.Contains("TIEN"))
                {
        ...
        private bool NhapThueTuDong()
        {
            ...
            {
                if ((Mode == V6Mode.Add || Mode == V6Mode.Edit)
                    && !chkSuaTienThue.Checked)
                {
                    AD2.Rows.Clear();
                    
                    var newRow = AD2.NewRow();
                    newRow["so_ct"] = txtSoPhieu.Text;
                    newRow["ngay_ct"] = dateNgayCT.Value;
                    newRow["ngay_lct"] = dateNgayLCT.Value;
        ...
        private void Tim()
        {
            try
            {
                if (V6Login.UserRight.AllowView("", Invoice.CodeMact))
                {
                    ...
                    if (_timForm == null)
                        _timForm = new TimPhieuNhapMuaForm(this);
        ...
        void chonExcel_AcceptData(DataTable table)
        {
                ...
                && table.Columns.Contains("GIA_NT01"))
            {
                ...
                ShowParentMessage(view_message);
                this.ShowMessage(view_message);
            }
            else
            {
