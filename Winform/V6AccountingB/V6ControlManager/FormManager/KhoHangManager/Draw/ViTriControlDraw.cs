...
{
    public partial class ViTriControlDraw
    {
        /// <summary>
        /// Dữ liệu tạo control
        /// </summary>
        ...
        private string label2_Text;
        private bool label2_Visible;
        private Color label1_ForeColor;
        private Color label2_ForeColor;
        private Color label3_BackColor;

        public KhoParams KhoParams { get; set; }


        public ViTriControlDraw()
        {
            //InitializeComponent();
        }

        public ViTriControlDraw(KhoParams kparas, DataRow row)
        {
            //InitializeComponent();
        ...
        private void MyInit()
        {
            ...
            {
                V6ControlFormHelper.WriteExLog(GetType() + ".Init", ex);
            }
        }
        ...
        void ViTriButton_Click(object sender, EventArgs e)
        {
            try
            {
                KhoHangContainerDraw container = null;
        ...
        public void ClearDataVitriVaTu()
        {
            ...
            if (KhoParams.ViewLable2)
            {
                label2_ForeColor = Color.Black;
            }
            else
            {
                label1_ForeColor = Color.Black;
            }
        ...
        public void SetDataVitriVatTu(DataRow row, string cVitri, string cMavt)
        {
            ...
            if (rgb.Length >= 3)
            {
                ...
                if (KhoParams.ViewLable2)
                {
                    label2_ForeColor = Color.FromArgb(r, g, b);
                }
                else
                {
                    label1_ForeColor = Color.FromArgb(r, g, b);
                }
            }
        ...
        public void SetColorMavt(string maVt, Color color)
        {
            if (MA_VT != null && MA_VT == maVt)
            {
                ...
                //label2.Visible = true;
                label3_BackColor = color;
            }
            else
            {
                //label1.ForeColor = Color.Black;
                label3_BackColor = Color.Transparent;
            }
        }
