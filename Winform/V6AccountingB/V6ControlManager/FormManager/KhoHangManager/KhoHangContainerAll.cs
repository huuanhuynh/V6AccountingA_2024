...
{
    public partial class KhoHangContainerAll : V6FormControl
    {
        ...
        public KhoHangContainerAll()
        {
            InitializeComponent();
        }

        public KhoHangContainerAll(KhoParams kparas)
        {
            InitializeComponent();
            KhoParams = kparas;
        ...
        public void GetAndSetData()
        {
            try
            {
                ...
                //{
                //    row["CODE"] = row["MA_KHO"].ToString().Trim() + row["CODE"].ToString().Trim();
                //}
