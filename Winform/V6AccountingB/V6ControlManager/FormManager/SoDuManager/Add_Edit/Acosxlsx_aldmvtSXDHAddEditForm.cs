...
{
    public partial class Acosxlsx_aldmvtSXDHAddEditForm : SoDuAddEditControlVirtual
    {
        ...
        private void MyInit()
        {
            ...
            dataGridView1.SetDataSource(null);
            LoadDetailControls();
        ...
        private void LoadDetailControls()
        {
            ...
            dynamicControlList1.Add(3, _dinhMucKeHoach);
            dynamicControlList1.Add(4, _dinhMucDonHang);
            dynamicControlList1.Add(5, _soLuongThucTe);
            dynamicControlList1.Add(6, _ngayBatDau);
            dynamicControlList1.Add(7, _ngayKetThuc);
        ...
        public override bool InsertNew()
        {
            try
            {
                ...
                SqlTransaction TRANSACTION = SqlConnect.CreateSqlTransaction("Acosxlsx_aldmvtInsert");
        ...
        public override int UpdateData()
        {
            try
            {
                ...
                SqlTransaction TRANSACTION = SqlConnect.CreateSqlTransaction("Acosxlsx_aldmvt Update");
