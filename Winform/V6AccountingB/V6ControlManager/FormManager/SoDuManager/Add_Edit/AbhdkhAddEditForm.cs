...
{
    public partial class AbhdkhAddEditForm : SoDuAddEditControlVirtual
    {
        public AbhdkhAddEditForm()
        {
            InitializeComponent();
            ...
            else
            {
                ...
                if (Mode == V6Mode.Edit)
                {
                    ...
                    if (DataDic.ContainsKey("MA_DVCS") && DataOld.ContainsKey("MA_DVCS")
                        ...
                        && DataDic.ContainsKey("MA_HD") && DataOld.ContainsKey("MA_HD")
