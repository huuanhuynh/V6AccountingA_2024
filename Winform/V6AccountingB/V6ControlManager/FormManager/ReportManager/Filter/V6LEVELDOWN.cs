...
{
    public partial class V6LEVELDOWN: FilterBase
    {
        public V6LEVELDOWN()
        {
            InitializeComponent();
        ...
        private void TxtXtag_TextChanged(object sender, System.EventArgs e)
        {
            Kieu_post = TxtXtag.Text;
        }
