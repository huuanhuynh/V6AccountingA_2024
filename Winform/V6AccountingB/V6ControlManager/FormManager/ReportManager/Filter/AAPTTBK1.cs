...
{
    public partial class AAPTTBK1 : FilterBase
    {
        public AAPTTBK1()
        {
            InitializeComponent();
        ...
        public override List<SqlParameter> GetFilterParameters()
        {
            ...
            {
                cKey = cKey + string.Format(" and stt_rec in (select DISTINCT stt_rec from ARI70 where ma_ct IN ('POA','POB') AND ma_vt in (select ma_vt from alvt where {0} ))", key2);
            }
