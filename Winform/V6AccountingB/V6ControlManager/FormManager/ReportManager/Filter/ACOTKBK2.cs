...
{
    public partial class ACOTKBK2 : FilterBase
    {
        public ACOTKBK2()
        {
            InitializeComponent();
        ...
        public override List<SqlParameter> GetFilterParameters()
        {
            ...
            if (TxtTk.Text.Trim() == "")
            {
                throw new Exception(V6Text.SelectAccount);
            }
          ...
          var result = new List<SqlParameter>();
            ...
            V6Setting.M_TK=TxtTk.Text.Trim();
            ...
            {
                "MA_BPHT","MA_DVCS","MA_BP", "MA_KH", "MA_VV","TK_DU", "MA_SP","MA_PHI","MA_KU","MA_CT","MA_SONB"
            }, and);
