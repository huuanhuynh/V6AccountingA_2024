...
{
    public partial class AFABTPBTSN_F7: FilterBase
    {
        public AFABTPBTSN_F7()
        {
            InitializeComponent();
        ...
        void AFABTPBTSN_F7_SetParentRowEvent(IDictionary<string, object> dictionary)
        {
            var currentRowData = dictionary;
        ...
        private void Change_DienGiai()
        {
            try
            {
                ...
                if (txtKy1.Value == txtKy2.Value)
                    ...
                    txtDien_giai.Text = string.Format("{0} {1} {2} {3} {4} {5}", V6Text.Text("BTPBKHTSCDTK"), txtKy1.Value.ToString("#"), V6Text.Text("DENKY"), txtKy2.Value.ToString("#"), V6Text.Text("_year_"), txtNam.Value.ToString("#"));
