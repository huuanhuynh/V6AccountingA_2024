...
namespace V6ControlManager.FormManager.ReportManager.Filter
{
    public static class Filter
    {
        public static FilterBase GetFilterControl(string program)
        {
            ...
            {
                #region ==== Nhân sự ====
                case "HPRCONGCT": result = new HPRCONGCT_Filter();
                break; case "ERLISTNV": result = new ERLISTNV_Filter();
                #endregion nhân sự

                #region ==== Phải thu ====
                #region === Báo cáo bán hàng ===
                break; case "ASOTH1"://Báo cáo bán hàng chi tiết theo mặt hàng
                              // result = new BaoCaoBanHangTheoChiTietMatHangFilter();
                    result = new ASOTH1();
                break; case "ASOTH1F5"://Báo cáo bán hàng chi tiết theo mặt hàng
                    result = new ASOTH1F5();
                break; case "ASOBK1"://Bản kê hóa đơn bán hàng
                    result = new ASOBK1();
                break; case "ASOBK2"://Bản kê hóa đơn 1 mặt hàng
                    result = new ASOBK2();
                break; case "VVP007"://Báo cáo bán hàng chi tiết (trừ trả lại)
                    result = new FilterBase();
                break; case "VVP008"://Báo cáo đăng ký
                    result = new FilterBase();
                break; case "AHINTH3"://Báo cáo hàng xuất tặng 2 chỉ tiêu
                    result = new AHINTH3();
                break; case "AKSOTH1"://Báo cáo tổng hợp theo tháng, nhớm theo v
                    result = new AKSOTH1();
                break; case "ASOBK14":
                    result = new ASOBK14();
                break; case "AINBK11"://Báo cáo hàng nhập
                    result = new AINBK11();
                break; case "ASOBK11"://So sánh giá bán, giá nhập
                    result = new FilterBase();
                break; case "ASOBK12"://Báo cáo hàng chi tiết
                    result = new ASOBK12();
                break; case "ASOBK13"://So sánh giá bán, bảng giá bán
                    result = new FilterBase();
                break; case "AKSOTH3"://Báo cáo tổng hợp theo bộ phận
                    result = new FilterBase();
                break; case "AHINTH3F5"://Báo cáo hàng xuất tặng 2 chỉ tiêu
                ...
                break; case "AKSOTH2":
                    result = new AKSOTH2();
                break; case "AKSOTH2F5":
                    result = new AKSOTH2F5();
                break; case "AFABCTSTH1":
                    result = new AFABCTSTH1();
                break; case "AFABCTSTH2":
                    result = new AFABCTSTH2();

                #endregion báo cáo bán hàng
                #region ==== Cập nhật số dư ====
                break; case "ARSD0_AR0":
                    result = new ARSD0_AR0();
                break; case "AARBPKH2N":
                    result = new AARBPKH2N();
                break; case "ACOVVKH2N":
                    result = new ACOVVKH2N();
                #endregion Cập nhật số dư
                #region === Báo cáo quản trị bán hàng ===
                break; case "ASOBK3VV"://Bản kê hóa đơn nhóm theo vụ việc
                    result = new FilterBase();
                break; case "ASOTH2"://Báo cáo ds bán hàng theo kh vv nv...
                    result = new ASOTH2();
                break; case "ASOTH3"://Báo cáo 
                    result = new ASOTH3();
                break; case "ASOTH3F5":
                    result = new ASOTH3F5();
                break; case "ASOTH4":
                ...
                break; case "AVSO001"://Bản kê hóa đơn bán hàng th
                    result = new AVSO001();
                break; case "AVSO002"://Bản kê hóa đơn bán hàng tra lai
                    result = new AVSO002();
                break; case "AVSO002F5"://Bản kê hóa đơn bán hàng tra lai
                    result = new AVSO002F5();
                break; case "AVSO004":
                    result = new AVSO004();
                break; case "AVSO006":
                    result = new AVSO006();
                break; case "AVBCNH70A":
                ...
                break; case "AARSO1"://Sổ chi tiết công nợ của một khách hàng                                              
                    result = new AARSO1();
                break; case "AARCD1"://Cân đối 1 tài khoản
                    result = new AARCD1();
                break; case "AARCD1F5"://Cân đối 1 tài khoản
                    result = new AARCD1F5();
                break; case "AARCD2"://Cân đối nhiều tài khoản
                    result = new AARCD2();
                break; case "AARCD2F5":
                    result = new AARCD2F5();

                break; case "AGLSO1"://Sổ chi tiết 1 tài khoản
                    result = new AGLSO1();
                break; case "AARSD1DK":
                    result = new AARSD1DK();
                break; case "AARSD1CK":
                ...
                break; case "AARSO1T":
                    result = new AARSO1T();
                break; case "AARSO1TF5":
                    result = new AARSO1TF5();
                break; case "AARSO1TF10":
                ...
                break; case "AARTTBK4":
                    result = new FilterBase();
                break; case "AARTTBK1A":
                    result = new AARTTBK1A();
                break; case "AARTTBK1B":
                    result = new AARTTBK1B();
                break; case "AARTTV001":
                ...
                break; case "AAPSO1T":
                    result = new AAPSO1T();
                break; case "AAPSO1TF5":
                    result = new AAPSO1TF5();
                break; case "AAPSO1TF10":
                ...
                break; case "AGLSO1T":
                    result = new AGLSO1T();
                break; case "AGLSO1TF5":
                    result = new AGLSO1TF5();
                break; case "AGLSO1TF10":
                ...
                break; case "AINSO1":
                    result = new AINSO1();
                break; case "AINSD2SLCK":
                    result = new AINSD2SLCK();
                break; case "AINSD2SLDK":
                    result = new AINSD2SLDK();
                break; case "AKBKVT":
                    result = new AKBKVT();
                break; case "AINCD1SL":
                    result = new AINCD1SL();
                break; case "AINCD1SLF5":
                    result = new AINCD1SLF5();
                break; case "AKBKVTSL":
                    result = new AKBKVTSL();
                break; case "AINSO1T":
                    result = new AINSO1T();
                break; case "AINSO1TF5":
                    result = new AINSO1TF5();
                break; case "AINSO1TF10":
                    result = new AINSO1TF10();
                break; case "AINSO3T":
                    result = new AINSO3T();
                break; case "AINSO3TF5":
                    result = new AINSO3TF5();
                break; case "AINSO3TF10":
                    result = new AINSO3TF10();
                break; case "AINGIATB1":
                ...
                break; case "AINCDHSDC":
                    result = new AINCDHSDC();
                break; case "AINCDHSDD":
                ...
                break; case "AINLOSO1":
                    result = new AINLOSO1();
                break; case "AINCDHSDE":
                    result = new AINCDHSDE();
                break; case "AINCDHSDF":
                    result = new AINCDHSDF();
                break; case "AINCDHSDG":
                    result = new AINCDHSDG();
                break; case "AINCDHSDGF5":
                    result = new AINCDHSDGF5();
                break; case "AINCDVITRIA":
                    result = new AINCDVITRIA();
                break; case "AINCDVITRIAF5":
                    result = new AINCDVITRIAF5();
                break; case "AINCDHSDB":
                    result = new AINCDHSDB();
                break; case "AINCDHSDA":
                    result = new AINCDHSDA();
                break; case "AINCDHSDAF5":
                    result = new AINCDHSDAF5();
                break; case "AINCDHSDEF5":
                    result = new AINCDHSDEF5();
                break; case "AINSO3":
                    result = new AINSO3();
                break; case "AINCDHSDG_NHOM":
                    result = new AINCDHSDG_NHOM();
                break; case "AINCDHSDG_NHOMF5":
                ...
                break; case "AINBK1B":
                    result = new AINBK1B();
                break; case "AINTH1XF5":
                    result = new AINTH1XF5();
                break; case "AINTH1X_LO":
                    result = new AINTH1X_LO();
                break; case "AINTH1X_LOF5":
                    result = new AINTH1X_LOF5();
                break; case "AINBK3XKH":
                    result = new AINBK3XKH();
                break; case "AINBK3XVV":
                    result = new AINBK3XVV();
                break; case "AINBK3XNX":
                    result = new AINBK3XNX();
                break; case "AINBK3XVT":
                ...
                break; case "AINBK1A":
                    result = new AINBK1A();
                break; case "AINTH1_LO":
                    result = new AINTH1_LO();
                break; case "AINTH1_LOF5":
                ...
                break; case "AFATINHKH":
                    result = new AFATINHKH();
                break; case "AFABCKH":
                    result = new AFABCKH();
                break; case "AFABCTS":
                    result = new AFABCTS();
                break; case "AFABCTANG":
                    result = new AFABCTANG();
                break; case "AFABCTANGBP":
                    result = new AFABCTANGBP();
                break; case "AFABCTANGNVBP":
                    result = new AFABCTANGNVBP();
                break; case "AFABCGIAM":
                ...
                break; case "XLSCA1":
                    ...
                    //NHAN SU
                break; case "XLSPRCONG2":
                    result = new XLSPRCONG2();
                break; case "XLSHRPERSONAL":
                    result = new XLSHRPERSONAL();
                break; case "XLSHRGENERAL2":
                ...
                break; case "AAPPR_SOA_IN2":
                    result = new AAPPR_SOA_IN2();
                break; case "AAPPR_SOA_IN3":
                    result = new AAPPR_SOA_IN3();
                break; case "AAPPR_POA":
                    result = new AAPPR_POA();
                break; case "AAPPR_IND":
                    result = new AAPPR_IND();
                break; case "V6BACKUP1":
                    result = new V6BACKUP1();
                break; case "V6LEVELDOWN":
                    result = new V6LEVELDOWN();
                break; case "V6LEVELSET":
                ...
                break; case "AGLCTPB":
                    result = new AGLCTPB();
                break; case "AGLTHUE30":
                    result = new AGLTHUE30();
                break; case "AGLTHUE20":
                    result = new AGLTHUE20();
                break; case "AGLABTK2N"://Ket chuyen tk
                ...
                break; case "ACOABVV2N":
                    result = new ACOABVV2N(); // Kết chuyển vv
                break; case "AARHDKH2N":
                ...
                #region ==== Kho - Vị trí ====
                break; case "AINVITRI01":
                    result = new AINVITRI01_filter();
                break; case "AINVITRI02":
                    result = new AINVITRI02_filter();
                break; case "AINVITRI03AF7":
                break; case "AINVITRI03BF7":
                    result = new AINVITRI03AF7_filter();
                #endregion kho-vitri
                #region ==== In liên tục ====

                break; case "AAPPR_SOF_IN1":
                    result = new AAPPR_SOF_IN1();
                break; case "AAPPR_TA1_IN1":
                    result = new AAPPR_TA1_IN1();
                break; case "AAPPR_CA1_IN1":
                    result = new AAPPR_CA1_IN1();
                break; case "AAPPR_BC1_IN1":
                    result = new AAPPR_BC1_IN1();
                break; case "AAPPR_BN1_IN1":
                    result = new AAPPR_BN1_IN1();
                break; case "AAPPR_POA_IN1":
                    result = new AAPPR_POA_IN1();
                break; case "AAPPR_POB_IN1":
                    result = new AAPPR_POB_IN1();
                break; case "AAPPR_IXC_IN1":
                    result = new AAPPR_IXC_IN1();
                break; case "AAPPR_IND_IN1":
                    result = new AAPPR_IND_IN1();
                break; case "AAPPR_IXA_IN1":
                    result = new AAPPR_IXA_IN1();
                break; case "AAPPR_IXB_IN1":
                    result = new AAPPR_IXB_IN1();

                #endregion In liên tục

                break; case "AINVTBAR1":
                    result = new FilterDanhMuc("ALVT");
                break; case "AINVTBAR2":
                    result = new FilterDanhMuc("ALLO");
                break; case "AINVTBAR2F9":
                    result = new AINVTBAR2F9();
                break; case "AINVTBAR3":
                    result = new AINVTBAR3();
                break; case "AINVTBAR5":
                    result = new AINVTBAR5();

                break; case "ACOSXLT_TINHGIA":
                ...
                break; case "AVGLGSSO5A":
                    result = new AVGLGSSO5A();
                break; case "AVGLGSSO5AF5":
                    result = new AVGLGSSO5AF5();
                break; case "AGLGSSO4T":
                    result = new AGLGSSO4T();
                break; case "AGLGSSO4TF5":
                    result = new AGLGSSO4TF5();
                break; case "AGLGSSO4TF10":
                    result = new AGLGSSO4TF10();
                break; case "AVGLGSSO6A":
                    result = new AVGLGSSO6A();
                break; case "AVGLGSSO6AF5":
                    result = new AVGLGSSO6AF5();

                break; case "ASENDMAIL":
