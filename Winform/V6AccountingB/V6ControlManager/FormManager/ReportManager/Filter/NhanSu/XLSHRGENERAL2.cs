...
{
    public partial class XLSHRGENERAL2 : FilterBase
    {
        public XLSHRGENERAL2()
        {
            InitializeComponent();
            MyInit();
        }
        ...
        private void WriteDanhSachCot2()
        {
            try
            {
                var saveFile = "XLSHRGENERAL2.xml";
            ...
            {
                V6ControlFormHelper.ShowErrorException(GetType() + ".WriteXLSHRGENERAL2", ex);
            }
        }
        ...
        private void DoEditXml()
        {
            try
            {
                var file_xml = "XLSHRGENERAL2.xml";
                new XmlEditorForm(txtDanhSachCot2, file_xml, "XLSHRGENERAL2", "TableName,Tach3,First_name,Mid_name,Last_name,MapColumns,Data".Split(',')).ShowDialog(this);
            }
            catch (Exception ex)
            {
