...
{
    public partial class ACOTKTH3BC_N4 : FilterBase
    {
        public ACOTKTH3BC_N4()
        {
            InitializeComponent();
        ...
        public override List<SqlParameter> GetFilterParameters()
        {
            ...
            result.Add(new SqlParameter("@Nhom", "4"));
        ...
        private void btnSuaChiTieu_Click(object sender, EventArgs e)
        {
            ...
            var data = V6BusinessHelper.Select(tableName,"*","NHOM_BC = '4'").Data;
