...
{
    public partial class AARTTV001 : FilterBase
    {
        public AARTTV001()
        {
            InitializeComponent();
        ...
        public override List<SqlParameter> GetFilterParameters()
        {
            ...
            if (chkKieu_nhom.Checked)

                result.Add(new SqlParameter("@Kieu_nhom", "1"));
            else
                result.Add(new SqlParameter("@Kieu_nhom", "0"));
            ...
            {
                cKey = cKey + string.Format(" and stt_rec in (select DISTINCT stt_rec from ARI70 where ma_ct IN ('SOA','SOF') AND ma_vt in (select ma_vt from alvt where {0} ))", key2);
            }
