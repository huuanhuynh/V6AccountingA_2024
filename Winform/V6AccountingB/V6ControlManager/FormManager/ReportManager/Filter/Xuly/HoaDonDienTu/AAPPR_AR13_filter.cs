...
{
    public partial class AAPPR_AR13_filter : FilterBase
    {
        public string MAU
        {
        ...
        private void btnSuaChiTieu_Click(object sender, System.EventArgs e)
        {
            try
            {
                ...
                var data = V6BusinessHelper.Select(tableName, "*", "LOAI = 'AAPPR_AR12' and (MA_TD1='" + String1 + "' or ma_td1='0' or ma_td1='') order by GROUPNAME,GC_TD1").Data;
                if (ctrl_is_down) // Xuất Excel
                {
                    if (data.Columns.Contains("UID")) data.Columns.Remove("UID");
                    string fileName = V6ControlFormHelper.ExportExcel_ChooseFile(this, data, tableName + "_" + String1 + cboSendType.Text, V6Text.Export);
                ...
                else
                {
                    ...
                    defaultData.Add("LOAI", "AAPPR_AR12"); //AAPPR_AR12 kieu chung, ko phai sai so voi AAPPR_AR13
        ...
        private void btnCheckConnection_Click(object sender, System.EventArgs e)
        {
            try
            {
                ...
                AAPPR_AR13 parentForm = FindParent<AAPPR_AR13>() as AAPPR_AR13;
                if (parentForm == null)
                {
                    this.ShowWarningMessage(V6Text.NotFound + " AAPPR_AR13.");
                    return;
                }
