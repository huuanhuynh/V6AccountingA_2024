...
namespace V6ControlManager.FormManager.ReportManager.Filter.Base0
{
    public partial class XADVXNK01_Filter : FilterBase
    {
        ...
        private void XADVXNK01_Filter_Load(object sender, EventArgs e)
        {
            ...
            {
                LoadConfig();
                FilterControl = AddFilterControl44Base("ADVXNK01." + _base0._reportFile, _base0._reportProcedure, _base0._reportFile, panel1, ToolTipControl);
                FilterControl2 = AddFilterControl44Base2("ADVXNK01." + _base0._reportFile + "_ADD", _base0._reportProcedure, _base0._reportFile, panel2, ToolTipControl);
                CreateFormProgram();
        ...
        public static ReportFilter44Base AddFilterControl44Base(string program, string reportProcedure, string reportFile, Panel panel1, ToolTip toolTip)
        {
            ...
            var FilterControl = Filter.GetFilterControl44(program, reportProcedure, reportFile, toolTip);
        ...
        public static ReportFilter44Base AddFilterControl44Base2(string program, string reportProcedure, string reportFile, Panel panel2, ToolTip toolTip)
        {
            panel2.Controls.Clear();

            var FilterControl2 = Filter.GetFilterControl44(program, reportProcedure, reportFile, toolTip);
