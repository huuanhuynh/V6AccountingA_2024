...
{
    public partial class AINSO3TF5 : FilterBase
    {
        public AINSO3TF5()
        {
            InitializeComponent();
            ...
            String1ValueChanged += AINSO3TF5_String1ValueChanged;
        }

        private void AINSO3TF5_String1ValueChanged(string oldvalue, string newvalue)
        {
        ...
        public override List<SqlParameter> GetFilterParameters()
        {
            ...
            result.Add(new SqlParameter("@cMa_vt", ma_vt_filterLine.StringValue.Trim()));
