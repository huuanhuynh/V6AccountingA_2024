...
{
    public partial class XLSPOB_Filter: FilterBase
    {
        public XLSPOB_Filter()
        {
            InitializeComponent();
            F3 = false;
            F5 = false;
        ...
        private void btnSuaChiTieu_Click(object sender, EventArgs e)
        {
            ...
            string keys = "MA_CT";
            var data = V6BusinessHelper.Select(tableName, "*", "MA_CT = 'POB'").Data;
        ...
        {
            V6ControlFormHelper.OpenExcelTemplate("POB_ALL.XLS", V6Setting.IMPORT_EXCEL);
        }
