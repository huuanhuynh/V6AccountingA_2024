...
{
    public partial class XLSIND_Filter : FilterBase
    {
        public XLSIND_Filter()
        {
            InitializeComponent();
            F3 = false;
            F5 = false;
        ...
        {
            V6ControlFormHelper.OpenExcelTemplate("IND_ALL.XLS", V6Setting.IMPORT_EXCEL);
        }
        ...
        private void btnSuaChiTieu_Click(object sender, EventArgs e)
        {
            ...
            string keys = "MA_CT";
            var data = V6BusinessHelper.Select(tableName, "*", "MA_CT = 'IND'").Data;
