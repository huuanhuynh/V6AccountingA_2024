...
{
    public partial class XLSAR1_Filter: FilterBase
    {
        public XLSAR1_Filter()
        {
            InitializeComponent();
            F3 = false;
            F5 = false;
        ...
        private void btnSuaChiTieu_Click(object sender, EventArgs e)
        {
            ...
            string keys = "MA_CT";
            var data = V6BusinessHelper.Select(tableName, "*", "MA_CT = 'AR1'").Data;
        ...
        {
            V6ControlFormHelper.OpenExcelTemplate("AR1_ALL.XLS", V6Setting.IMPORT_EXCEL);
        }
