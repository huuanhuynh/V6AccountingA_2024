...
{
    public partial class XLSAP1_Filter: FilterBase
    {
        public XLSAP1_Filter()
        {
            InitializeComponent();
            F3 = false;
            F5 = false;
        ...
        private void btnSuaChiTieu_Click(object sender, EventArgs e)
        {
            ...
            string keys = "MA_CT";
            var data = V6BusinessHelper.Select(tableName, "*", "MA_CT = 'AP1'").Data;
        ...
        {
            V6ControlFormHelper.OpenExcelTemplate("AP1_ALL.XLS", V6Setting.IMPORT_EXCEL);
        }
