...
{
    public partial class ACOTKTH3BC_N3 : FilterBase
    {
        public ACOTKTH3BC_N3()
        {
            InitializeComponent();
        ...
        public override List<SqlParameter> GetFilterParameters()
        {
            ...
            result.Add(new SqlParameter("@Nhom", "3"));
        ...
        private void btnSuaChiTieu_Click(object sender, EventArgs e)
        {
            ...
            var data = V6BusinessHelper.Select(tableName, "*", "NHOM_BC = '3'").Data;
