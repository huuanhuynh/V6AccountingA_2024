...
{
    public partial class AINTH1X_LO : FilterBase
    {
        public AINTH1X_LO()
        {
            InitializeComponent();
        ...
        public override List<SqlParameter> GetFilterParameters()
        {
            ...
            {
                "MA_KHO","MA_DVCS","MA_BP", "MA_KH", "MA_VV", "MA_NX", "MA_VT","MA_NVIEN","MA_GD","MA_LO"
            }, and);
        ...
        protected override void GetFilterData()
        {
            FilterData = new SortedDictionary<string, object>();
            FilterData["MA_KHO"] = makho.StringValue;
        }
