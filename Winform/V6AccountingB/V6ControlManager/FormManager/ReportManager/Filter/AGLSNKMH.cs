...
{
    public partial class AGLSNKMH : FilterBase
    {
        public AGLSNKMH()
        {
            InitializeComponent();
        ...
        public override List<SqlParameter> GetFilterParameters()
        {
            ...
            if (TxtTk_no.Text != "")
            {
                ...
                cKey2 = cKey2 + string.Format(" AND ({0})", orString2);
                ...
                if (TxtTk_Co.Text != "")
                {
                    ...
                    foreach (string s in ss2)
                    {
                        orString2 += string.Format(" OR TK Like '{0}%'", s.Trim());
                    }
                    orString2 = orString2.Substring(4);
                    cKey2 = cKey2 + string.Format(" AND ({0})", orString2);
                }
            ...
            result.Add(new SqlParameter("@condition2", cKey2));
            return result;
