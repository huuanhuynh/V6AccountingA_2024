    ...
    public partial class ReportR44ViewBase : V6FormControl
    {
        ...
        private void Print(string printerName)
        {
            ...
            if (printerOnline)
            {
                try
                {
                    V6ControlFormHelper.SetCrystalReportPrinterOptions(NOPRINTER, V6ControlFormHelper.PrinterSettings, _rpDoc0);
                    V6ControlFormHelper.PrintRptToPrinter(NOPRINTER, _rpDoc0, printerName, _printCopy, 0, 0);
        ...
        public AnchorStyles dataGridView1_Anchor = AnchorStyles.Left | AnchorStyles.Right | AnchorStyles.Top;
        public AnchorStyles crystalReportViewer1_Anchor = AnchorStyles.Left | AnchorStyles.Right | AnchorStyles.Top | AnchorStyles.Bottom;
        ...
        private void crystalReportViewer1_DoubleClick(object sender, EventArgs e)
        {
            if (crystalReportViewer1.Top > dataGridView1.Bottom)
            {
                ...
                crystalReportViewer1.Anchor = AnchorStyles.Left | AnchorStyles.Right | AnchorStyles.Top | AnchorStyles.Bottom;
            }
            else
            {
