...
{
    public partial class ReportR47ViewBase : V6FormControl
    {
        ...
        private void XuLyHienThiFormSuaChungTuF3()
        {
            ...
            {
                this.ShowErrorMessage(GetType() + ".ReportR47ViewBase XuLyHienThiFormSuaChungTu:\n" + ex.Message);
            }
        }
        ...
        private void ReportR47ViewBase_VisibleChanged(object sender, EventArgs e)
        {
            if (Visible)
            {
