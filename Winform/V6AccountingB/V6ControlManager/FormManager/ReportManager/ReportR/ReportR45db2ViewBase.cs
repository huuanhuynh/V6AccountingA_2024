...
namespace V6ControlManager.FormManager.ReportManager.ReportR
{
    public partial class ReportR45db2ViewBase : V6FormControl
    {
        ...
        #endregion 
        //public ReportR45db2ViewBase()
        //{
        //    InitializeComponent();
        //}

        public ReportR45db2ViewBase(string itemId, string program, string reportProcedure,
        ...
        void LoadData()
        {
            ...
            try
            {
                ...
                if (EXTRA_INFOR.ContainsKey("DATABASE") && !string.IsNullOrEmpty(EXTRA_INFOR["DATABASE"]))
                {
                    ...
                    _ds = SqlHelper.ExecuteDataset(conString2, CommandType.StoredProcedure, proc, _pList.ToArray());
                }
                else
                {
        ...
        private void XuLyHienThiFormSuaChungTuF3()
        {
            ...
            {
                this.ShowErrorMessage(GetType() + ".ReportR45db2ViewBase XuLyHienThiFormSuaChungTu:\n" + ex.Message);
            }
        }
        ...
        private void XuLyXemChiTietF5()
        {
            try
            {
                ...
                var view = new ReportR45db2ViewBase(m_itemId, _program + "F5", _program + "F5",
        ...
        private void ReportR45db2ViewBase_VisibleChanged(object sender, EventArgs e)
        {
            if (Visible)
            {
