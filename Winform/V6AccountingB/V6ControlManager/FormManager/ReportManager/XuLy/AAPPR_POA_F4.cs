...
{
    public partial class AAPPR_POA_F4 : V6FormControl
    {
        ...
        public AAPPR_POA_F4(string stt_rec, DataRow am)
        {
            _sttRec = stt_rec;
            _am = am;
            InitializeComponent();
        ...
        public void btnNhan_Click(object sender, EventArgs e)
        {
            ...
            try
            {
               ...
               // am["GHI_CHU02"] = txtGhiChu02.Text;
                ...
                if (am["MA_CT"].ToString()=="POA")
                {
                    result = V6BusinessHelper.UpdateSimple(V6TableName.Am71, am, keys);
                }
                else
                {
                     if (am["MA_CT"].ToString()=="POB")
                        {
                           result = V6BusinessHelper.UpdateSimple(V6TableName.Am72, am, keys);
                        }
                } 
                if (result == 1)
                {
