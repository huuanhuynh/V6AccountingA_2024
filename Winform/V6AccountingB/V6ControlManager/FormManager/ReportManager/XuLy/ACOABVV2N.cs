...
namespace V6ControlManager.FormManager.ReportManager.XuLy
{
    ...
    {
        public ACOABVV2N(string itemId, string program, string reportProcedure, string reportFile, string text)
        ...
        {
            V6ControlFormHelper.SetStatusText2("Kết chuyển số dư của các vụ việc sang năm sau.");
        }
