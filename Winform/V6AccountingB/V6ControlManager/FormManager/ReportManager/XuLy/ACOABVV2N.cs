...
{
    public class ACOABVV2N : XuLyBase0
    {
        public ACOABVV2N(string itemId, string program, string reportProcedure, string reportFile, string reportCaption, string reportCaption2)
        ...
        protected override void Nhan()
        {
            try
            {
                ...
                var sql = "select count(1) from ABVV where Nam = " + FilterControl.Number3;
