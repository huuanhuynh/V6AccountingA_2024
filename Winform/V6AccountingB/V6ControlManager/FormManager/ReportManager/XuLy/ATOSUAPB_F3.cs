...
{
    public partial class ATOSUAPB_F3 : V6FormControl
    {
        ...
        public ATOSUAPB_F3(string stt_rec, SortedDictionary<string, object> data)
        {
            _sttRec = stt_rec;
            _data = data;
            InitializeComponent();
                ...
                SqlParameter[] plist =
                    {
                        ...
                        new SqlParameter("@so_the_cc", txtSo_the_cc.Text),
                        new SqlParameter("@ma_nv", txtma_nv.Text),
                        new SqlParameter("@gt_pb_ky", txtgt_PB_ky.Value),
