...
{
    public class APDMO_APControl : XuLyBase
    {
        public APDMO_APControl(string itemId, string program, string reportProcedure, string reportFile, string reportCaption, string reportCaption2)
        ...
        protected override void XuLyF8()
        {
            try
            {
                if (dataGridView1.CurrentRow != null)
                {
                    ...
                    if (V6Login.UserRight.AllowDelete("", "S0K"))
        ...
        protected override void XuLyF9()
        {
            try
            {
                ...
                XuLyBase view = new APDMO_APF9Control(ItemID, _program + "F9", _reportProcedure + "F9", _reportFile + "F9", _reportCaption, _reportCaption2);
                //Set filter data.
        ...
        protected override void XuLyHienThiFormSuaChungTuF3()
        {
            ...
            {
                if (dataGridView1.CurrentRow == null) return;
                if (!V6Login.UserRight.AllowEdit("", "S0K"))
                {
                    V6ControlFormHelper.NoRightWarning();
                    return;
                }
                ...
                if (!string.IsNullOrEmpty(selected_khoa))
                {
                    ...
                    var hoaDonForm = new APDMO_F3F4(V6Mode.Edit, selected_khoa, currentRowData);
        ...
        protected override void XuLyBoSungThongTinChungTuF4()
        {
            try
            {
                if (!V6Login.UserRight.AllowAdd("", "S0K"))
                {
                    V6ControlFormHelper.NoRightWarning();
                    return;
                }
                ...
                var new_like_stt_rec = V6BusinessHelper.GetNewLikeSttRec("S0K", "STT_REC", "M");
                ...
                var hoaDonForm = new APDMO_F3F4(V6Mode.Add, new_like_stt_rec, currentRowData);
