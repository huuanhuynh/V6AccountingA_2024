...
{
    public partial class AFADCCTBP_F4 : V6FormControl
    {
        ...
        public AFADCCTBP_F4(string stt_rec, DataRow am)
        {
            _stt_rec = stt_rec;
        ...
        public void btnNhan_Click(object sender, EventArgs e)
        {
            ...
            SqlTransaction transaction = SqlConnect.CreateSqlTransaction("AFADCCTBP_F4");
            try
            {
                var am = GetData();
                ...
                var result = V6BusinessHelper.Insert(transaction,"ADCTTSBP", am);
                if (result)
                {
                   ...
                   V6BusinessHelper.Update(transaction, "ADCTTSBP", am1, keys);
                   transaction.Commit();
