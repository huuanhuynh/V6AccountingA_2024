...
{
    public class AAPPR_SOC_IN1 : XuLyBase
    {
        public AAPPR_SOC_IN1(string itemId, string program, string reportProcedure, string reportFile, string reportCaption, string reportCaption2)
        ...
        public override void SetStatus2Text()
        {
            ...
            {
                text = string.Format("F4: {0}, F9: {1}, F10: {2}", V6Text.Text("BOSUNGTHONGTIN"), V6Text.Text("PRINTHDBH"), V6Text.Text("TAOSOHDTD"));
            }
        ...
        protected override void XuLyF10()
        {
            try
            {
                ...
                var hoaDonForm = new AAPPR_SOC_F10();
        ...
        protected override void ViewDetails(DataGridViewRow row)
        {
            ...
            {
                this.ShowErrorMessage(GetType() + ".AAPPR_SOC ViewDetails: " + ex.Message);
            }
        }
                    ...
                    if (dataGridView1.Columns.Contains("Stt_rec") && dataGridView1.Columns.Contains("Ma_ct"))
                    {
                        ...
                        if (!string.IsNullOrEmpty(selectedSttRec) && !string.IsNullOrEmpty(selectedMaCt))
                        {
                            ...
                            if (amName != "")
                            {
                                ...
                                var hoaDonForm = new AAPPR_SOC_F4(selectedSttRec, am.Rows[0]);
