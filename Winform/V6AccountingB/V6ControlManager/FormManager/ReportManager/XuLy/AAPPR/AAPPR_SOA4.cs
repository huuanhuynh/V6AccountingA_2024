...
namespace V6ControlManager.FormManager.ReportManager.XuLy
{
    ...
    public class AAPPR_SOA4 : XuLyBase
    {
        ...
        public override void SetStatus2Text()
        {
            ...
            {
                text = string.Format("F4: {0}, F9: {1}", V6Text.Text("BOSUNGTHONGTIN"), V6Text.Text("BOSUNGTTNCT"));
            }
        ...
        protected override void XuLyF9()
        {
            try
            {
                //AAPPR_SOA4_F9 form = new AAPPR_SOA4_F9();
                ...
                try
                {
                    if (row.IsSelect())
                    {
                        ...
                        if (result == 1)
                        {
                            ...
                            V6BusinessHelper.ExecuteProcedure("AAPPR_SOA4_UPDATE", plist);
                        }
                        //else
                        //{
                    ...
                    if (dataGridView1.Columns.Contains("Stt_rec") && dataGridView1.Columns.Contains("Ma_ct"))
                    {
                        ...
                        if (!string.IsNullOrEmpty(selectedSttRec) && !string.IsNullOrEmpty(selectedMaCt))
                        {
                            ...
                            if (amName != "")
                            {
                                ...
                                //var hoaDonForm = new AAPPR_SOA4_F4(selectedSttRec, am.Rows[0], extra_infor);
