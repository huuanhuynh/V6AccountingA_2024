...
{
    public class ACPDDCK : XuLyBase
    {
        public ACPDDCK(string itemId, string program, string reportProcedure, string reportFile, string reportCaption, string reportCaption2)
        ...
        {
            V6ControlFormHelper.SetStatusText2("F4: ,F8: ");
        }
