...
{
    public partial class ARCMO_F9F3 : V6Form
    {
        ...
        public ARCMO_F9F3(IDictionary<string, object> data1, IDictionary<string, object> data2)
        {
            InitializeComponent();
            _data1 = data1;
            _data2 = data2;
        ...
        private void ARCMO_F9F3_Load(object sender, EventArgs e)
        {
            Ready();
        }
        ...
        private void XyLyThayDoiTienTT(object sender)
        {
            try
            {
                if (!IsReady) return;
        ...
        private void ARCMO_F9F3_FormClosing(object sender, FormClosingEventArgs e)
        {
