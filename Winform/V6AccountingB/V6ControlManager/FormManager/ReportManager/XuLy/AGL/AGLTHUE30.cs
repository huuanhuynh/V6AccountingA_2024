...
{
    public class AGLTHUE30 : XuLyBase
    {
        public AGLTHUE30(string itemId, string program, string reportProcedure, string reportFile, string reportCaption, string reportCaption2)
        ...
        public override void SetStatus2Text()
        {
            ...
            {
                text = "F3: Sửa,F4:Thêm hóa đơn mua vào, F8: Xóa";
            }
                   ...
                   
                    {
                            ...
                            && dataGridView1.Columns.Contains("UID") && dataGridView1.Columns.Contains("SO_CT"))
                        {
                               ...
                               && selectedMaCt == "APV")
                            {
                                ...
                                var am = V6BusinessHelper.Select("ARV30", "*",
                                    "UID=@uid",
                                    "", "", plist.ToArray()).Data;
                                ...
                                var hoaDonForm = new AGLTHUE30_F4(selectedSttRec, am.Rows[0]);
        ...
        protected override void XuLyBoSungThongTinChungTuF4()
        {
            ...
            var hoaDonForm = new AGLTHUE30_F4();
