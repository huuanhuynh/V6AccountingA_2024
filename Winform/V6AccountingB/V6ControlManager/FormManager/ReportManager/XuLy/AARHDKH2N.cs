...
namespace V6ControlManager.FormManager.ReportManager.XuLy
{
    ...
    {
        public AARHDKH2N(string itemId, string program, string reportProcedure, string reportFile, string reportCaption, string reportCaption2)
        ...
        public override void SetStatus2Text()
        {
            ...
            {
                text = V6Text.Text("KETCSDHDKHSNS");
            }
        ...
        protected override void Nhan()
        {
            try
            {
                ...
                var sql = "select count(1) from ABHDKH where Nam = " + FilterControl.Number3;
