...
{
    public class ARSD0_AP0 : XuLyBase
    {
        public ARSD0_AP0(string itemId, string program, string reportProcedure, string reportFile, string reportCaption, string reportCaption2)
        ...
        protected override void XuLyF8()
        {
            try
            {
                ...
                if (!V6Login.UserRight.AllowDelete("", "AP0"))
                {
                ...
                var t = V6BusinessHelper.CheckEditVoucher(sttrec, "ARS30", "S", "AP0");
                if (t == 1)
                {
                ...
                if (this.ShowConfirmMessage(V6Text.DeleteConfirm) == DialogResult.Yes)
                {
                    ...
                    keys.Add("MA_CT", "AP0");
                    var result = V6BusinessHelper.Delete("ARS30", keys);
                    if (result > 0)
                    {
        ...
        protected override void XuLyHienThiFormSuaChungTuF3()
        {
            try
            {
                ...
                {
                    if (!V6Login.UserRight.AllowEdit("", "AP0"))
                    {
                        V6ControlFormHelper.NoRightWarning();
                        return;
                    }
                   ...
                   
                    {
                            ...
                            && dataGridView1.Columns.Contains("UID") && dataGridView1.Columns.Contains("SO_CT"))
                        {
                            ...
                            if (!string.IsNullOrEmpty(selectedSttRec) && !string.IsNullOrEmpty(selectedMaCt))
                            {
                                ...
                                var hoaDonForm = new ARSD0_AP0_F4(selectedSttRec, am.Rows[0]);
        ...
        protected override void XuLyBoSungThongTinChungTuF4()
        {
            ...
            var hoaDonForm = new ARSD0_AP0_F4();
