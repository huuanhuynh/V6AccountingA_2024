...
{
    public class AVGLGSSO5A : XuLyBase
    {
        public AVGLGSSO5A(string itemId, string program, string reportProcedure, string reportFile, string reportCaption,
        ...
        public override void SetStatus2Text()
        {
            ...
            {
                text = string.Format("F5: {0}, F6: {1}, F7: {2}, F9: {3}, F10: {4}",
