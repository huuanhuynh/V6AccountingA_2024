...
{
    public class AFATANGNG : XuLyBase
    {
        public AFATANGNG(string itemId, string program, string reportProcedure, string reportFile, string reportCaption, string reportCaption2)
                            ...
                            && dataGridView1.Columns.Contains("UID"))
                        {
                            ...
                            if (!string.IsNullOrEmpty(selectedSttRec) && !string.IsNullOrEmpty(selectedMaCt))
                            {
                                ...
                                var plist = new List<SqlParameter>
                                    ...
                                    var hoaDonForm = new AFATANGNG_F3(selectedSttRec, am.Rows[0]);
                    ...
                    if (dataGridView1.Columns.Contains("Stt_rec") && dataGridView1.Columns.Contains("Ma_ct"))
                    {
                        ...
                        if (!string.IsNullOrEmpty(selectedSttRec) && !string.IsNullOrEmpty(selectedMaCt))
                        {
                            ...
                            if (amName != "")
                            {
                                ...
                                var fText = V6Text.Text("THEMTANGNGG") + sothets;
                                var f = new V6Form
                                {
                                    Text = fText,
                                    AutoSize = true,
                                ...
                                var hoaDonForm = new AFATANGNG_F4(selectedSttRec, am.Rows[0]);
