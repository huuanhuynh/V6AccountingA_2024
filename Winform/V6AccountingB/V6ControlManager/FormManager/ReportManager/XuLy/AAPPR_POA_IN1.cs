...
{
    public class AAPPR_POA_IN1 : XuLyBase
    {
        public AAPPR_POA_IN1(string itemId, string program, string reportProcedure, string reportFile, string reportCaption, string reportCaption2)
