...
{
    public partial class HPRCONGCT_XL1_F5 : V6Form
    {
        ...
        public HPRCONGCT_XL1_F5()
        {
            InitializeComponent();
        }

        public HPRCONGCT_XL1_F5(SqlParameter[] plist)
        {
        ...
        private void FormatGridView()
        {
            try
            {
                var format = V6ControlsHelper.GetAldmConfigByTableName(_table_name);
                V6ControlFormHelper.FormatGridViewAndHeader(dataGridView1, format.GRDS_V1, format.GRDF_V1,
                    V6Setting.IsVietnamese ? format.GRDHV_V1 : format.GRDHE_V1);
            }
            catch (Exception ex)
            {
        ...
        private string _table_name = "PRCONG2";
        public string Ma_ns;
        ...
        private void DoEdit()
        {
            try
            {
                ...
                var form = new HPRCONGCT_XL1_F3F4(V6Mode.Edit, currentRowData);
        ...
        private void DoAdd()
        {
            try
            {
                ...
                currentRowData["MA_NS"] = Ma_ns;
                currentRowData["NGAY"] = Ngay;

                var form = new HPRCONGCT_XL1_F3F4(V6Mode.Add, currentRowData);
