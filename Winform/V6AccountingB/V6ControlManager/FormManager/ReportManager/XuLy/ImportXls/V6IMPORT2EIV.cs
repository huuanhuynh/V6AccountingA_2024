...
{
    public partial class V6IMPORT2EIV : XuLyBase
    {
        ...
        public V6IMPORT2EIV(string itemId, string program, string reportProcedure, string reportFile, string reportCaption, string reportCaption2)
        ...
        {
            ALIM2XLS_DATA = V6BusinessHelper.Select("ALIM2XLS", "*", "KT_LONG='1'", "", "stt").Data;
