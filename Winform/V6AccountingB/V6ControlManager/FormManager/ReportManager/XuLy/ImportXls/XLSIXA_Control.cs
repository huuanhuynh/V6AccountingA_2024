...
{
    public class XLSIXA_Control : XuLyBase
    {
        ...
        public XLSIXA_Control(string itemId, string program, string reportProcedure, string reportFile, string reportCaption, string reportCaption2)
        ...
        private void F9Thread()
        {
            try
            {
                ...
                if (FilterControl.Check2)
                {
                    ...
                    V6BusinessHelper.ExecuteProcedureNoneQuery("VPA_IXA_DELETE_ALL", plist);
                }
        ...
        void tF9_Tick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                SetStatusText("F9 finish " + f9Message);
                ShowMainMessage("F9 finish! " + f9Message);
