...
{
    public class EIVPOA_Control : XuLyBase
    {
        ...
        protected override void LoadData0()
        {
            try
            {
                ...
                filterControl = (EIVPOA_Filter)FilterControl;

                var tbl = filterControl.DownloadDataDetail_Purchase(dataGridView1, out _message);
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "EIVPOA_Control";
            this.Load += new System.EventHandler(this.EIVPOA_Control_Load);
            this.ResumeLayout(false);
            this.PerformLayout();

        }

        private void EIVPOA_Control_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        void tF9_Tick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Logger.WriteToLog(V6Login.ClientName + " " + GetType() + "EIV_POA F9 " + f9ErrorAll);
                }
                f9Message = "";
                f9ErrorAll = "";
            }
