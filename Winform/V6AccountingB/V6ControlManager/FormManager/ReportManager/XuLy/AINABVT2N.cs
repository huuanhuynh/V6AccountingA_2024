...
{
    public class AINABVT2N : XuLyBase0
    {
        public AINABVT2N(string itemId, string program, string reportProcedure, string reportFile, string reportCaption, string reportCaption2)
        ...
        protected override void Nhan()
        {
            try
            {
                ...
                var sql = "select count(1) from ABVT where Nam = " + FilterControl.Number2;
