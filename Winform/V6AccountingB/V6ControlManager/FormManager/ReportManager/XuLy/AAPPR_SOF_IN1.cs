...
{
    public class AAPPR_SOF_IN1 : XuLyBase
    {
        public AAPPR_SOF_IN1(string itemId, string program, string reportProcedure, string reportFile, string reportCaption, string reportCaption2)
        ...
        V6Invoice76 invoice = new V6Invoice76();
        protected override void ViewDetails(DataGridViewRow row)
        {
            ...
            {
                this.ShowErrorMessage(GetType() + ".AAPPR_SOF ViewDetails: " + ex.Message);
            }
        }
