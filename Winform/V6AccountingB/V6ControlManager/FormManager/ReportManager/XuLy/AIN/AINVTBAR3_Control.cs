...
namespace V6ControlManager.FormManager.ReportManager.XuLy
{
    public partial class AINVTBAR3_Control : XuLyBase0
    {
        ...
        public AINVTBAR3_Control(string itemId, string program, string reportProcedure, string reportFile, string reportCaption, string reportCaption2)
        ...
        public override void SetStatus2Text()
        {
            ...
            {
                text = string.Format("F9 {0}.", V6Text.Text("Accept"));
            }
