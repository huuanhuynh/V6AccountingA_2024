...
{
    public class AAPPR_BN1_IN1 : XuLyBase
    {
        public AAPPR_BN1_IN1(string itemId, string program, string reportProcedure, string reportFile, string reportCaption, string reportCaption2)
        ...
        V6Invoice56 invoice = new V6Invoice56();
        protected override void ViewDetails(DataGridViewRow row)
        {
            ...
            {
                this.ShowErrorMessage(GetType() + ".AAPPR_BN1 ViewDetails: " + ex.Message);
            }
        }
