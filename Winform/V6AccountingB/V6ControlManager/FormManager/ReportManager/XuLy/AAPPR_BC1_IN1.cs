...
{
    public class AAPPR_BC1_IN1 : XuLyBase
    {
        public AAPPR_BC1_IN1(string itemId, string program, string reportProcedure, string reportFile, string reportCaption, string reportCaption2)
        ...
        {
            V6ControlFormHelper.SetStatusText2("F9: " + V6Text.Text("Print"));
        }
        ...
        V6Invoice46 invoice = new V6Invoice46();
        protected override void ViewDetails(DataGridViewRow row)
        {
            ...
            {
                this.ShowErrorMessage(GetType() + ".AAPPR_BC1 ViewDetails: " + ex.Message);
            }
        }
