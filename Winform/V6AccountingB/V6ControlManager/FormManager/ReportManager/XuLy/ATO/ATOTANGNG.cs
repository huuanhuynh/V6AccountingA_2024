...
{
    public class ATOTANGNG : XuLyBase
    {
        public ATOTANGNG(string itemId, string program, string reportProcedure, string reportFile, string reportCaption, string reportCaption2)
        ...
        public override void SetStatus2Text()
        {
            ...
            {
                text = string.Format("F3: {0}, F4: {1}, F8: {2}", V6Text.Text("SUA"), V6Text.Text("THEMTANGGTTSCD"), V6Text.Text("XOATANGTSCD"));
            }
                            ...
                            && dataGridView1.Columns.Contains("UID"))
                        {
                            ...
                            if (!string.IsNullOrEmpty(selectedSttRec) && !string.IsNullOrEmpty(selectedMaCt))
                            {
                                ...
                                var plist = new List<SqlParameter>
                                    ...
                                    var am = V6BusinessHelper.Select("ADALCC", "*",
                                        "UID=@uid",
                                        "", "", plist.ToArray()).Data;
                                    ...
                                    var hoaDonForm = new ATOTANGNG_F3(selectedSttRec, am.Rows[0]);
                    ...
                    if (dataGridView1.Columns.Contains("Stt_rec") && dataGridView1.Columns.Contains("Ma_ct"))
                    {
                        ...
                        if (!string.IsNullOrEmpty(selectedSttRec) && !string.IsNullOrEmpty(selectedMaCt))
                        {
                            ...
                            if (amName != "")
                            {
                                ...
                                var hoaDonForm = new ATOTANGNG_F4(selectedSttRec, am.Rows[0]);
