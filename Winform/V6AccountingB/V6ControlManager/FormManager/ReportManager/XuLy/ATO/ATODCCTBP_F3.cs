...
{
    public partial class ATODCCTBP_F3 : V6FormControl
    {
        ...
        public ATODCCTBP_F3(string stt_rec, DataRow am)
        {
            _stt_rec = stt_rec;
        ...
        public void btnNhan_Click(object sender, EventArgs e)
        {
            ...
            SqlTransaction transaction = SqlConnect.CreateSqlTransaction("ATODCCTBP_F3");
            ...
            try
            {
               ...
               var am = GetData();
                ...
                var result = V6BusinessHelper.Update(transaction, "ADCTCCBP", am, keys);
                if (result==1)
                {
                    ...
                    V6BusinessHelper.Update(transaction, "ADCTCCBP", am1, keys1);
                    transaction.Commit();
