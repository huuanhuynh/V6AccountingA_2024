...
namespace V6ControlManager.FormManager.ReportManager.XuLy
{
    ...
    /// </summary>
    public class AAPPR_IXB3 : XuLyBase
    {
        public AAPPR_IXB3(string itemId, string program, string reportProcedure, string reportFile, string reportCaption, string reportCaption2)
        ...
        private void AAPPR_IXB3_Load(object sender, EventArgs e)
        {
        ...
        //    try
        //    {
        //        AAPPR_IXB3_ViewPDF view = new AAPPR_IXB3_ViewPDF();
            ...
            while(i<dataGridView1.Rows.Count)
            {
                ...
                try
                {
                    if (row.IsSelect())
                    {
                        ...
                        SqlParameter[] plist0 =
                        {
                            new SqlParameter("@Loai", "AAPPR_IXB2"),
        ...
        protected override void ViewDetails(DataGridViewRow row)
        {
            ...
            {
                this.ShowErrorMessage(GetType() + ".AAPPR_IXB3 ViewDetails: " + ex.Message);
            }
        }
