...
namespace V6ControlManager.FormManager.ReportManager.XuLy
{
    public partial class AINVTBAR5_Control : XuLyBase0
    {
        ...
        {
            V6ControlFormHelper.SetStatusText2(string.Format("F9 {0}, F10 {1}.", V6Text.Text("Accept"), V6Text.Text("TaoPX")));
        }
        ...
        private void FormatGridView(V6ColorDataGridView gridView)
        {
            try
            {
                ...
                V6ControlFormHelper.FormatGridView(gridView, FIELDV, OPERV, VALUEV, BOLD_YN == "1", COLOR_YN == "1", ObjectAndString.StringToColor(COLORV));
