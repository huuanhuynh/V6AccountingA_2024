...
namespace V6ControlManager.FormManager.ReportManager.XuLy
{
    ...
    public class ARCMO_ARF9Control : XuLyBase
    {
        private void InitializeComponent()
        {
            ...
            // radPbTheoHanTT
            // 
            this.radPbTheoHanTT.AccessibleDescription = "XULYC00003";
        ...
        public ARCMO_ARF9Control(string itemId, string program, string reportProcedure, string reportFile, string reportCaption, string reportCaption2)
        ...
        void dataGridView1_SelectionChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                sql += " From ARS20 Where stt_rec=@stt_rec1 and tk = @tki ";
        ...
        public override void SetStatus2Text()
        {
            ...
            {
                text = "F3: Phân bổ trực tiếp, F8: Xóa phân bổ.";
            }
        ...
        protected override void XuLyHienThiFormSuaChungTuF3()
        {
            ...
            {
                this.ShowErrorException(GetType() + ".XuLyHienThiFormSuaChungTuF3", ex);
            }
        }
        ...
        private DialogResult PhanBo1(DataGridViewRow row1, DataGridViewRow row2, int isAuto)
        {
            try
            {
                ...
                { 
                    ARCMO_F9F3 form = new ARCMO_F9F3(data1, data2);
            ...
            try
            {
                ...
                else if (dataGridView2.Focused)
                {
                    ...
                    if (this.ShowConfirmMessage(V6Text.DeleteConfirm) == DialogResult.Yes)
                    {
                        ...
                        V6BusinessHelper.ExecuteProcedure("AArttpbF8", plist);
                        V6ControlFormHelper.ShowMainMessage(V6Text.Finish);
                    }
                }
