...
{
    public partial class ARSD0_AP0_F4 : SoDuAddEditControlVirtual
    {
        ...
        public ARSD0_AP0_F4(string stt_rec, DataRow am)
        {
            _stt_rec = stt_rec;
            _am = am;
        ...
        private void TxtT_CL_NT_TextChanged(object sender, EventArgs e)
        {

        }

        private void ARSD0_AP0_F4_Load(object sender, EventArgs e)
        {
