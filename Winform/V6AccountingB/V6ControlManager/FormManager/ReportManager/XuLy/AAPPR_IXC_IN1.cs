...
{
    public class AAPPR_IXC_IN1 : XuLyBase
    {
        public AAPPR_IXC_IN1(string itemId, string program, string reportProcedure, string reportFile, string reportCaption, string reportCaption2)
        ...
        V6Invoice86 invoice = new V6Invoice86();
        protected override void ViewDetails(DataGridViewRow row)
        {
            ...
            {
                this.ShowErrorMessage(GetType() + ".AAPPR_IXC ViewDetails: " + ex.Message);
            }
        }
