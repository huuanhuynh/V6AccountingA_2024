...
{
    public class AAPPR_IXA_IN1 : XuLyBase
    {
        public AAPPR_IXA_IN1(string itemId, string program, string reportProcedure, string reportFile, string reportCaption, string reportCaption2)
        ...
        protected override void ViewDetails(DataGridViewRow row)
        {
            ...
            {
                this.ShowErrorMessage(GetType() + ".AAPPR_IXA ViewDetails: " + ex.Message);
            }
        }
