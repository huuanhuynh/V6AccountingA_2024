...
{
    public class AFADCBP : XuLyBase
    {
        public AFADCBP(string itemId, string program, string reportProcedure, string reportFile, string reportCaption, string reportCaption2)
        ...
        public override void FormatGridViewExtern()
        {
            try
            {
                V6ControlFormHelper.FormatGridView(dataGridView1, "TS0", "=", 1, true, true, Color.MediumAquamarine);
            }
            catch (Exception ex)
            {
                            ...
                            && dataGridView1.Columns.Contains("UID"))
                        {
                            ...
                            if (!string.IsNullOrEmpty(selectedSttRec) && !string.IsNullOrEmpty(selectedMaCt))
                            {
                                ...
                                var plist = new List<SqlParameter>
                                    ...
                                    var am = V6BusinessHelper.Select("ADBPTS", "*",
                                        "UID=@uid",
                                        "", "", plist.ToArray()).Data;
                                    ...
                                    var hoaDonForm = new AFADCBP_F3(selectedSttRec, am.Rows[0]);
                    ...
                    if (dataGridView1.Columns.Contains("Stt_rec") && dataGridView1.Columns.Contains("Ma_ct"))
                    {
                        ...
                        if (!string.IsNullOrEmpty(selectedSttRec) && !string.IsNullOrEmpty(selectedMaCt))
                        {
                            ...
                            if (amName != "")
                            {
                                ...
                                var hoaDonForm = new AFADCBP_F4(selectedSttRec, am.Rows[0]);
