...
{
    public class V6DXFormatNumberGiaNT : ICustomFunctionOperatorBrowsable
    {
        ...
        public object Evaluate(params object[] operands) {
            ...
            string res = ObjectAndString.NumberToString(number, V6Options.M_IP_R_GIANT, V6Options.M_NUM_POINT, V6Options.M_NUM_SEPARATOR, show0);
            return res;
        }
        public string Name {
            get {
                return "FormatNumberGiaNT";
            }
        }
