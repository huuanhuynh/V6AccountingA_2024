...
{
    public class V6DXFormatNumberGia : ICustomFunctionOperatorBrowsable
    {
        ...
        public object Evaluate(params object[] operands) {
            ...
            string res = ObjectAndString.NumberToString(number, V6Options.M_IP_R_GIA, V6Options.M_NUM_POINT, V6Options.M_NUM_SEPARATOR, show0);
            return res;
        }
        public string Name {
            get {
                return "FormatNumberGia";
            }
        }
