...
{
    public partial class MA_NS_filter: FilterBase
    {
        public MA_NS_filter()
        {
            InitializeComponent();
        ...
        private void MyInit()
        {
            try
            {
                SetParentRowEvent += MA_NS_filter_SetParentRowEvent;
        ...
        void MA_NS_filter_SetParentRowEvent(IDictionary<string, object> data)
        {
            if (data != null)
            {
