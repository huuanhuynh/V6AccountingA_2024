...
{
    public partial class CorplanControl1 : V6FormControl
    {
        public CorplanControl1()
        {
            InitializeComponent();
            MyInit();
        }

        public CorplanControl1(string itemId)
        {
            m_itemId = itemId;
            InitializeComponent();
            MyInit();
        ...
        private string _tableName = "Corplan1";
        private int _index;
        ...
        private void GenControls()
        {
            try
            {
                ...
                //if (SFile != "")
                {
                    var data = V6BusinessHelper.Select(_tableName, "*", "", "", "D,ID").Data;
                    _index = 0;
        ...
        private void DoAdd()
        {
            try
            {
                ...
                data.Add("ID", id);
                FormAddEdit f = new FormAddEdit(V6TableName.CorpLan1, V6Mode.Add, null, data);
                f.InitFormControl();
