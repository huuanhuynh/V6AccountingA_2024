namespace V6Structs
{
    ...
    public static class FormDynamicEvent
    {
        ...
        /// Form_Load
        /// </summary>
        public const string INIT2 = "INIT2";
        /// <summary>
        /// Xử lý khác trong nút chức năng menu.
        /// </summary>
        public const string INKHAC = "INKHAC";


        public const string AFTERADDFILTERCONTROL = "AFTERADDFILTERCONTROL";
        public static string AFTERADDDETAIL3SUCCESS = "AFTERADDDETAIL3SUCCESS";
        public const string AFTERADDDETAILSUCCESS = "AFTERADDDETAILSUCCESS";
        public const string AFTEREDITDETAIL3SUCCESS = "AFTEREDITDETAIL3SUCCESS";
        ...
        public static string VALIDATEDETAIL2DATA = "VALIDATEDETAIL2DATA";
