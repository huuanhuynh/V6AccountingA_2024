...
{
    public class DateTimeColor:ColorTextBox
    {  
        //============================================================================
        /// <summary>
        /// Hàm khởi tạo
        /// </summary>
        public DateTimeColor()
        {
            InitializeComponent();
            MyInit();
        }
        ...
        private void InitializeComponent()
        {
            ...
            // ColorDateTime
            // 
            this.Enter += new System.EventHandler(this.ColorDateTime_Enter);
            ...
            this.Leave += new System.EventHandler(this.ColorDateTime_Leave);
        ...
        public DateTime? Value
        {
            get
            {
                try
                {
                    var t = StringValue;
                    t = t.Replace("_", "");
                    var yearString = t.Substring(t.LastIndexOf('/') + 1);
        ...
        private void ColorDateTime_Enter(object sender, EventArgs e)
        {
            Write();
            SelectionStart = 0;
        }

        private void ColorDateTime_Leave(object sender, EventArgs e)
        {
            CheckValue();
        }
