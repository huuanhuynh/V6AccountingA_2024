...
namespace H_Controls.Controls
{
    public partial class MenuControl : UserControl
    {
        ...
        protected Color gradientButtonDark = Color.LightGreen;// Color.FromArgb(178, 193, 140);
        ...
        protected Color gradientButtonLight = Color.Lime;// Color.FromArgb(234, 240, 207);
    ...
    public class MenuButton // : IComponent
    {
        ...
        [Description("Đường dẫn trong api để thêm."), Category("Appearance")]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)]
        ...
        [Description("Đường dẫn trong api để sửa."), Category("Appearance")]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)]
