...
namespace V6Soft.Accounting.Banking.Farmers
{
    ...
    /// </summary>
    public interface IAccountTypeDataFarmer : IDataFarmerBase<AccModels.AccountType>
    {
        /// <summary>
        ///     Gets list of customers satisfying given conditions.
        ///     <para />Returns null if there is no results.
        /// </summary>
        PagedSearchResult<AccModels.AccountType> GetAccountTypes(SearchCriteria criteria);
    }
}
