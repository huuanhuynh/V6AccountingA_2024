(function (module) {
    module.controller("NhomKhachHangController", NhomKhachHangController);
    NhomKhachHangController.$inject = ["$scope", "KendoGridOptionsFactory", "$state"];

    function NhomKhachHangController($scope, KendoGridOptionsFactory, $state) {
        var model = this;
        ...
        model.mainGridOptions = new KendoGridOptionsFactory({
            dataSource: {
                ...
                transport: {
                    read: {
                        url: "http://localhost/accapi/nhomkhachhangs/list",
                        type: "POST",
