(function (module) {
    module.controller("QuocGiaController", QuocGiaController);
    QuocGiaController.$inject = ["$scope", "KendoGridOptionsFactory", "$state"];

    function QuocGiaController($scope, KendoGridOptionsFactory, $state) {
        var model = this;
        model.title = "QuocGia MANAGEMENT";
        ...
        model.mainGridOptions = new KendoGridOptionsFactory({
            dataSource: {
                ...
                transport: {
                    read: {
                        url: "http://localhost/accapi/quocgias/list",
                        type: "POST",
            ...
            columns: [
                { field: "maQuocGia", title: "Mã quốc gia", width: "120px" },
                { field: "tenQuocGia", title: "Tên quốc gia", width: "150px" },
                { field: "tenQuocGia2", title: "tên quốc gia 2", width: "120px" },
