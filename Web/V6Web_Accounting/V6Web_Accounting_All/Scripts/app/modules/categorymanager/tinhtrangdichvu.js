(function (module) {
    module.controller("TinhTrangDichVuController", TinhTrangDichVuController);
    TinhTrangDichVuController.$inject = ["$scope", "KendoGridOptionsFactory", "$state"];

    function TinhTrangDichVuController($scope, KendoGridOptionsFactory, $state) {
        var model = this;
        model.title = "TinhTrangDichVu MANAGEMENT";
        ...
        model.mainGridOptions = new KendoGridOptionsFactory({
            dataSource: {
                ...
                transport: {
                    read: {
                        url: "http://localhost/accapi/tinhtrangdichvus/list",
                        type: "POST",
            ...
            columns: [
            { field: "thongTinVatTu", title: "Thông tin vật tư", width: "120px" },
            { field: "ten_tt", title: "Tên tình trạng", width: "150px" },
            { field: "ten_tt2", title: "Tên tình trạng 2", width: "120px" },
