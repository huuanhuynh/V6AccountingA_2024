(function (module) {
    module.controller("PhanLoaiCongCuController", PhanLoaiCongCuController);
    PhanLoaiCongCuController.$inject = ["$scope", "KendoGridOptionsFactory", "$state"];

    function PhanLoaiCongCuController($scope, KendoGridOptionsFactory, $state) {
        var model = this;
        model.title = "PhanLoaiConCu MANAGEMENT";
        ...
        model.mainGridOptions = new KendoGridOptionsFactory({
            dataSource: {
                ...
                transport: {
                    read: {
                        url: "http://localhost/accapi/phanloaicongcus/list",
                        type: "POST",
            ...
            columns: [
                ...
                { field: "ten_Loai", title: "Tên loại", width: "200px" },
                { field: "ten_Loai2", title: "Tên loại 2", width: "120px" },
                { field: "ngayKhoiTao", title: "Ngày tạo mới", width: "120px" },
                { field: "gioKhoiTao", title: "Giờ tạo mới", width: "120px" },
                { field: "nguoiNhap", title: "Người tạo mới", width: "120px" },
                { field: "ngaySua", title: "Ngàu sửa", width: "120px" },
