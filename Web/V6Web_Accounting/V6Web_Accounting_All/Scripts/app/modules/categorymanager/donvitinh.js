(function (module) {
    module.controller("DonViTinhController", DonViTinhController);
    DonViTinhController.$inject = ["$scope", "KendoGridOptionsFactory", "$state"];

    function DonViTinhController($scope, KendoGridOptionsFactory, $state) {
        var model = this;
        model.title = "DonViTinh MANAGEMENT";
        ...
        model.mainGridOptions = new KendoGridOptionsFactory({
            dataSource: {
                ...
                transport: {
                    read: {
                        url: "http://localhost/accapi/donvitinhs/list",
                        type: "POST",
            ...
            columns: [
                { field: "ma_DonViTinh", title: "Mã Đơn Vị Tính", width: "120px" },
                { field: "ten_DonViTinh", title: "Tên đơn vị tính", width: "150px" },
                { field: "ten_DonViTinh2", title: "Tên đơn vị tính 2", width: "120px" },
                ...
                { field: "gioKhoiTao", title: "Thời gian tạo ", width: "120px" },
            ]
        });
