(function (module) {
    module.controller("PhanLoaiTaiKhoanController", PhanLoaiTaiKhoanController);
    PhanLoaiTaiKhoanController.$inject = ["$scope", "KendoGridOptionsFactory", "$state"];

    function PhanLoaiTaiKhoanController($scope, KendoGridOptionsFactory, $state) {
        var model = this;
        model.title = "PhanLoaiTaiKhoan MANAGEMENT";
        ...
        model.mainGridOptions = new KendoGridOptionsFactory({
            dataSource: {
                ...
                transport: {
                    read: {
                        url: "http://localhost/accapi/phanloaitaikhoans/list",
                        type: "POST",
