(function (module) {
    module.controller("TinhThanhController", TinhThanhController);
    TinhThanhController.$inject = ["$scope", "KendoGridOptionsFactory", "$state"];

    function TinhThanhController($scope, KendoGridOptionsFactory, $state) {
        var model = this;
        model.title = "TinhThanh MANAGEMENT";
        ...
        model.mainGridOptions = new KendoGridOptionsFactory({
            dataSource: {
                ...
                transport: {
                    read: {
                        url: "http://localhost/accapi/tinhthanhs/list",
                        type: "POST",
            ...
            columns: [
                { field: "maTinh", title: "Mã tỉnh", width: "120px" },
                { field: "tenTinh", title: "Tên Tỉnh", width: "150px" },
                ...
                { field: "ngayNhap", title: "Ngày tạo", width: "150px" },
            ]
        });
