(function (module) {
    module.controller("WarehouseController", WarehouseController);
    WarehouseController.$inject = ["$scope", "KendoGridOptionsFactory", "$state"];

    function WarehouseController($scope, KendoGridOptionsFactory, $state) {
        var model = this;
        model.title = "WAREHOUSE MANAGEMENT";
        ...
        model.mainGridOptions = new KendoGridOptionsFactory({
            dataSource: {
                ...
                transport: {
                    read: {
                        url: "http://localhost/accapis/list",
                        type: "POST",
            ...
            columns: [
                { field: "maKho", title: "Mã kho", width: "80px" },
                { field: "tenKho", title: "Tên kho" },
                { field: "ngayNhap", title: "Ngày nhập", template: "#= kendo.toString(kendo.parseDate(ngayNhap, 'yyyy-MM-dd'), 'dd/MM/yyyy') #" },
            ]
        });
