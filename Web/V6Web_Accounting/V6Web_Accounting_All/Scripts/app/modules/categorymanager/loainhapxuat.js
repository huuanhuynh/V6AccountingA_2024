(function (module) {
    module.controller("LoaiNhapXuatController", LoaiNhapXuatController);
    LoaiNhapXuatController.$inject = ["$scope", "KendoGridOptionsFactory", "$state"];

    function LoaiNhapXuatController($scope, KendoGridOptionsFactory, $state) {
        var model = this;
        model.title = "LoaiNhapXuat MANAGEMENT";
        ...
        model.mainGridOptions = new KendoGridOptionsFactory({
            dataSource: {
                ...
                transport: {
                    read: {
                        url: "http://localhost/accapi/loainhapxuats/list",
                        type: "POST",
            ...
            columns: [
                { field: "maLoaiNhapXuat", title: "Mã loại nhập xuất", width: "120px" },
                { field: "loai", title: "Loại", width: "150px" },
                { field: "ten_Loai", title: "Tên loại", width: "120px" },
                ...
                { field: "ngayNhap", title: "Ngày nhập", width: "120px" },
                { field: "gioKhoiTao", title: "Giờ tạo", width: "120px" },
