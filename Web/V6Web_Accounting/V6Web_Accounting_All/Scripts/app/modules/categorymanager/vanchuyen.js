(function (module) {
    module.controller("VanChuyenController", VanChuyenController);
    VanChuyenController.$inject = ["$scope", "KendoGridOptionsFactory", "$state"];

    function VanChuyenController($scope, KendoGridOptionsFactory, $state) {
        var model = this;
        model.title = "VanChuyen MANAGEMENT";
        ...
        model.mainGridOptions = new KendoGridOptionsFactory({
            dataSource: {
                ...
                transport: {
                    read: {
                        url: "http://localhost/accapi/vanchuyens/list",
                        type: "POST",
            ...
            columns: [
                { field: "maVanChuyen", title: "Mã vận chuyển", width: "120px" },
                { field: "tenVanChuyen", title: "Tên vận chuyển 2", width: "150px" },
                { field: "tenVanChuyen2", title: "Tên vận chuyển 2", width: "120px" },
