(function (module) {
    module.controller("LoaiDichVuController", LoaiDichVuController);
    LoaiDichVuController.$inject = ["$scope", "KendoGridOptionsFactory", "$state"];

    function LoaiDichVuController($scope, KendoGridOptionsFactory, $state) {
        var model = this;
        model.title = "LoaiDichVu MANAGEMENT";
        ...
        model.mainGridOptions = new KendoGridOptionsFactory({
            dataSource: {
                ...
                transport: {
                    read: {
                        url: "http://localhost/accapi/loaidichvus/list",
                        type: "POST",
