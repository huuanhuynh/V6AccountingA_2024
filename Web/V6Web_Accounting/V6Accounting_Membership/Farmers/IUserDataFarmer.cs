...
namespace V6Soft.Accounting.Membership.Farmers
{
    /// <summary>
    ///     Provides API for customer data farmer.
    /// </summary>
    public interface IUserDataFarmer : IDataFarmerBase<User>
    {
        /// <summary>
        ///     Gets list of customers satisfying given conditions.
        ///     <para />Returns null if there is no results.
        /// </summary>
        PagedSearchResult<User> GetUsers(SearchCriteria criteria);
